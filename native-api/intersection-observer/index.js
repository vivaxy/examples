...
function toggleDisplay() {
  toBeObservedElement.style.display = toBeObservedElement.style.display === 'none' ? '' : 'none';
}

function toggleTransform() {
  toBeObservedElement.style.transform = toBeObservedElement.style.transform === 'translateX(-100px)' ? '' : 'translateX(-100px)';
}
