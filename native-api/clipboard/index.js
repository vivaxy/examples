...
document.querySelector('#readText').addEventListener('click', readClipboardText);
document.querySelector('#write').addEventListener('click', writeClipboard);
document.querySelector('#writeText').addEventListener('click', writeClipboardText);
...
function onEvent(eventName) {
  return (e) => {
    log('event: ' + eventName + '; type: ' + e.clipboardData.type + '; data: ' + e.clipboardData.getData('text/plain'));
  };
}
