/******/ (function (modules) {
  ...
  /******/ /******/ __webpack_require__.p = 'release'; // Load entry module and return exports
  ...
  /******/ [
      ...
      function createUnionTypeChecker(arrayOfTypeCheckers) {
        ...
        function validate(
          ...
          for (var i = 0; i < arrayOfTypeCheckers.length; i++) {
            ...
            if (
              checker(props, propName, componentName, location, propFullName) ==
              null
            ) {
              return null;
            }
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var _utilsCombineReducers2 = _interopRequireDefault(
      ...
      var _utilsApplyMiddleware2 = _interopRequireDefault(
      ...
      /* WEBPACK VAR INJECTION */ (function (process) {
        ...
        function combineReducers(reducers) {
          ...
          return function combination(state, action) {
            ...
            var finalState = _mapValues2['default'](
              finalReducers,
    ...
    /***/ function (module, exports, __webpack_require__) {
      /* WEBPACK VAR INJECTION */ (function (process) {
        ...
        function connect(mapStateToProps, mapDispatchToProps, mergeProps) {
          ...
          var finalMapDispatchToProps = isPlainObject(mapDispatchToProps)
            ? wrapActionCreators(mapDispatchToProps)
            : mapDispatchToProps || defaultMapDispatchToProps;
          var finalMergeProps = mergeProps || defaultMergeProps;
          var doStatePropsDependOnOwnProps = finalMapStateToProps.length !== 1;
          var doDispatchPropsDependOnOwnProps =
            finalMapDispatchToProps.length !== 1;
          var _options$pure = options.pure;
          var pure = _options$pure === undefined ? true : _options$pure;
          var _options$withRef = options.withRef;
          var withRef =
            _options$withRef === undefined ? false : _options$withRef;
          ...
          function computeStateProps(store, props) {
            ...
            var stateProps = doStatePropsDependOnOwnProps
          ...
          function computeDispatchProps(store, props) {
            ...
            var dispatchProps = doDispatchPropsDependOnOwnProps
          ...
          return function wrapWithConnect(WrappedComponent) {
            var Connect = (function (_Component) {
              ...
              Connect.prototype.updateStatePropsIfNeeded =
                function updateStatePropsIfNeeded() {
                  var nextStateProps = computeStateProps(
                    this.store,
                    this.props,
                  );
                  if (
              ...
              Connect.prototype.updateDispatchPropsIfNeeded =
                function updateDispatchPropsIfNeeded() {
                  var nextDispatchProps = computeDispatchProps(
                    this.store,
                    this.props,
                  );
                  if (
              ...
              Connect.prototype.updateMergedProps =
              ...
              Connect.prototype.componentWillReceiveProps =
                function componentWillReceiveProps(nextProps) {
              ...
              Connect.prototype.getWrappedInstance =
      ...
      function todos() {
        ...
        switch (action.type) {
          ...
          case _actions.COMPLETE_TODO:
            return [].concat(
              _toConsumableArray(state.slice(0, action.index)),
              [
    ...
    /***/ function (module, exports) {
      ...
      var SET_VISIBILITY_FILTER = (exports.SET_VISIBILITY_FILTER =
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var App = (function (_Component) {
        ...
        function App() {
          ...
          return _possibleConstructorReturn(
            this,
            Object.getPrototypeOf(App).apply(this, arguments),
          );
        }
              ...
              return _react2.default.createElement(
                ...
                _react2.default.createElement(_Footer2.default, {
                  ...
                  onFilterChange: function onFilterChange(nextFilter) {
                    return dispatch(
                      (0, _actions.setVisibilityFilter)(nextFilter),
                    );
                  },
                }),
              );
      ...
      App.propTypes = {
        visibleTodos: _react.PropTypes.arrayOf(
          _react.PropTypes.shape({
            text: _react.PropTypes.string.isRequired,
            completed: _react.PropTypes.bool.isRequired,
          }),
        ),
        visibilityFilter: _react.PropTypes.oneOf([
          'SHOW_ALL',
          'SHOW_COMPLETED',
          'SHOW_ACTIVE',
        ]).isRequired,
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var Footer = (function (_Component) {
        ...
        function Footer() {
          ...
          return _possibleConstructorReturn(
            this,
            Object.getPrototypeOf(Footer).apply(this, arguments),
          );
        }
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var AddTodo = (function (_Component) {
        ...
        function AddTodo() {
          ...
          return _possibleConstructorReturn(
            this,
            Object.getPrototypeOf(AddTodo).apply(this, arguments),
          );
        }
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var TodoList = (function (_Component) {
        ...
        function TodoList() {
          ...
          return _possibleConstructorReturn(
            this,
            Object.getPrototypeOf(TodoList).apply(this, arguments),
          );
        }
      ...
      TodoList.propTypes = {
        ...
        todos: _react.PropTypes.arrayOf(
          _react.PropTypes.shape({
            text: _react.PropTypes.string.isRequired,
            completed: _react.PropTypes.bool.isRequired,
          }).isRequired,
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var Todo = (function (_Component) {
        ...
        function Todo() {
          ...
          return _possibleConstructorReturn(
            this,
            Object.getPrototypeOf(Todo).apply(this, arguments),
          );
        }
