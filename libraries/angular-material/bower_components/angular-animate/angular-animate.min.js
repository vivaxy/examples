          ...
          function(d, s, n, g, l, D, z, Z, I) {
            ...
            function r(a, S, p) {
              ...
              (l = g.structural) ||
                (l =
                  ('animate' === g.event &&
                    0 < Object.keys(g.options.to || {}).length) ||
                  c(g.options));
              if (!l) return k(), C(a), m;
              M && f(E);
              var r = (e.counter || 0) + 1;
                ...
                u(C(a), function(a) {
                  function c() {
                    ...
                    var d,
                      h = a.close;
                    if (
                      b(a.anchors ? a.from.element || a.to.element : a.element)
                    ) {
                      var k = f(a);
                      k && (d = k.start);
                    }
        ...
        this.$get = [
          ...
          function(a, e, s, n, g, l, D) {
            ...
            return function(a, c) {
              ...
              e.addClass(a, Y);
              c.transitionStyle &&
                ((v = [O, c.transitionStyle]), da(k, v), m.push(v));
              0 <= c.duration &&
                ((v = 0 < k.style[O].length),
                (v = Aa(c.duration, v)),
                da(k, v),
                m.push(v));
              c.keyframeStyle &&
                ((v = [V, c.keyframeStyle]), da(k, v), m.push(v));
              var U = T
                ? 0 <= c.staggerIndex
                  ? c.staggerIndex
                  : b.count($)
              ...
              return {
                ...
                start: function() {
                  if (!K)
                    return (
                      (t = { end: d, cancel: g, resume: null, pause: null }),
                      (p = new s(t)),
                      I(M),
                      p
                    );
            ...
            return function(a, b, d, e) {
              ...
              function B(a, b, d, e, f) {
                ...
                if (0 === m.length) {
                  var g, l;
                  'beforeSetClass' === f
                    ? ((g = w(a, 'removeClass', d, e, 'beforeRemoveClass')),
                      (l = w(a, 'addClass', d, e, 'beforeAddClass')))
                    : 'setClass' === f &&
                      ((g = w(a, 'removeClass', d, e, 'removeClass')),
