        ...
        function(e, n, c, l) {
          function m(t) {
            p(e) ||
              ...
              (h = { width: $.prop('offsetWidth') }),
              n.removeClass('transition'));
          }
          function u(e) {
            if (h) {
              e.stopPropagation(), e.srcEvent && e.srcEvent.preventDefault();
              var t = e.pointer.distanceX / h.width,
                n = l.$viewValue ? 1 + t : t;
              (n = Math.max(0, Math.min(1, n))),
                $.css(r.CSS.TRANSFORM, 'translate3d(' + 100 * n + '%,0,0)'),
                (h.translate = n);
            }
          }
          function g(e) {
            if (h) {
              e.stopPropagation(),
                ...
                $.css(r.CSS.TRANSFORM, '');
              var t = l.$viewValue ? h.translate < 0.5 : h.translate > 0.5;
              t && v(!l.$viewValue), (h = null);
            }
          }
          function v(t) {
            e.$apply(function() {
          ...
          l = l || a.fakeNgModel();
          var p = d(c.ngDisabled),
            $ = t.element(n[0].querySelector('.md-thumb-container')),
            f = t.element(n[0].querySelector('.md-container'));
          o(function() {
            n.removeClass('md-dragging');
          }),
            i(e, n, c, l),
