...
function MdGesture($$MdGestureHandler, $$rAF, $timeout) {
  ...
  var hasJQuery =
    typeof window.jQuery !== 'undefined' && angular.element === window.jQuery;
      ...
      .handler('swipe', {
        ...
        onEnd: function(ev, pointer) {
          if (
            ...
            var eventType =
              pointer.directionX == 'left' ? '$md.swipeleft' : '$md.swiperight';
    ...
    function createRipple(left, top) {
      ...
      function getRippleSize(left, top) {
        ...
        if (options.isMenuItem) {
          ...
          size =
            Math.sqrt(Math.pow(width, 2) + Math.pow(height, 2)) * multiplier;
...
function ThemingProvider($mdColorPalette) {
  ...
  function Theme(name) {
    ...
    THEME_COLOR_TYPES.forEach(function(colorType) {
      var defaultHues = (self.isDark ? DARK_DEFAULT_HUES : LIGHT_DEFAULT_HUES)[
        colorType
      ];
