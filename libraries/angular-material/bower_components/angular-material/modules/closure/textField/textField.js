...
(function() {
   ...
   * Form
   */
  ng.material.components.textField = angular
    .module('material.components.textField', ['material.core'])
  ...
  function mdTextFloatDirective($mdTheming, $mdUtil, $parse, $log) {
    return {
      ...
      compile: function(element, attr) {
        $log.warn(
          '<md-text-float> is deprecated. Please use `<md-input-container>` and `<input>`.' +
  ...
  function mdInputGroupDirective($log) {
    return {
      ...
      controller: [
        ...
        function($element) {
          $log.warn(
            '<md-input-group> is deprecated. Please use `<md-input-container>` and `<input>`.' +
              'More information at http://material.angularjs.org/#/api/material.components.input/directive/mdInputContainer',
          );
  ...
  function mdInputDirective($mdUtil, $log) {
    return {
      ...
      link: function(scope, element, attr, ctrls) {
        ...
        $log.warn(
          '<md-input> is deprecated. Please use `<md-input-container>` and `<input>`.' +
            'More information at http://material.angularjs.org/#/api/material.components.input/directive/mdInputContainer',
        );
        ...
        element.attr(
          'type',
          attr.type || element.parent().attr('type') || 'text',
        );
