  ...
  p.module('ngAria', ['ng'])
    ...
    .directive('ngModel', [
      ...
      function(a) {
        ...
        function h(a, c) {
          return (
            !c.attr('role') && c.attr('type') === a && 'INPUT' !== c[0].nodeName
          );
        }
        function f(a, c) {
          var d = a.type,
            e = a.role;
          return 'checkbox' === (d || e) || 'menuitemcheckbox' === e
            ? 'checkbox'
            : 'radio' === (d || e) || 'menuitemradio' === e
            ? 'radio'
            : 'range' === d || 'progressbar' === e || 'slider' === e
            ? 'range'
            : 'textbox' === (d || e) || 'TEXTAREA' === c[0].nodeName
            ? 'multiline'
            : '';
        }
        return {
            ...
            return {
              ...
              post: function(e, b, m, g) {
                ...
                switch (d) {
                  ...
                  case 'checkbox':
                    h(d, b) && b.attr('role', d);
                    c('aria-checked', 'ariaChecked', b) &&
                      e.$watch(f, 'radio' === d ? l() : k);
                    break;
                  case 'range':
                    ...
                    a.config('ariaValue') &&
                      (m.min &&
                        ...
                        b.attr('aria-valuemin', m.min),
                      m.max &&
                        !b.attr('aria-valuemax') &&
                        b.attr('aria-valuemax', m.max),
                      b.attr('aria-valuenow') ||
                        e.$watch(f, function(a) {
                ...
                g.$validators.required &&
                  c('aria-required', 'ariaRequired', b) &&
                  e.$watch(
                    function() {
          ...
          compile: function(h, f) {
            ...
            return function(c, d, e) {
              ...
              a.config('tabindex') &&
                !d.attr('tabindex') &&
                d.attr('tabindex', 0);
              if (a.config('bindKeypress') && !e.ngKeypress && !b(d, f))
