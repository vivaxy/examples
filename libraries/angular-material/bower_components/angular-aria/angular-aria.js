      ...
      function($aria) {
        ...
        function getShape(attr, elem) {
          ...
          return (type || role) === 'checkbox' || role === 'menuitemcheckbox'
            ...
            ? 'range'
            : (type || role) === 'textbox' || elem[0].nodeName === 'TEXTAREA'
            ? 'multiline'
            : '';
        }
            ...
            return {
              ...
              post: function(scope, elem, attr, ngModel) {
                ...
                switch (shape) {
                  ...
                  case 'multiline':
                    if (
                      shouldAttachAttr('aria-multiline', 'ariaMultiline', elem)
                    ) {
                ...
                if (
                  ...
                  shouldAttachAttr('aria-required', 'ariaRequired', elem)
                ) {
                  scope.$watch(
                    function ngAriaRequiredWatch() {
