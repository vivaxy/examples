...
(function(N, W, u) {
  ...
  function n(b, a, c) {
    ...
    if (b)
      ...
      else for (d in b) kb.call(b, d) && a.call(c, b[d], d, b);
    return b;
  }
  function oc(b, a, c) {
  ...
  function ua(b, a, c, d) {
    ...
    if (a) {
      ...
      if (K(b))
        ...
        if (nc(b)) for (g in b) e(g, b[g], a, c, d);
      ...
      K(b)
        ...
        : C(b) && ((g = Object.create(rc(b))), (a = ua(b, g, c, d)));
    return a;
  }
  function fa(b, a) {
    if (K(b)) {
  ...
  function ka(b, a) {
    ...
    if (c == typeof a && 'object' == c)
      if (K(b)) {
        ...
        if (Wa(b) || Wa(a) || Ta(b) || Ta(a) || K(a) || da(a) || Va(a))
          return !1;
        c = ga();
        for (d in b)
          if ('$' !== d.charAt(0) && !G(b[d])) {
  ...
  function sb(b, a) {
    ...
    d &&
      (a
        ? delete d.data[a]
        : (d.handle && (d.events.$destroy && d.handle({}, '$destroy'), Oc(b)),
          delete ub[c],
          (b.ng339 = u)));
  }
  function tb(b, a) {
    ...
    a &&
      !c &&
      ((b.ng339 = c = ++Df), (c = ub[c] = { events: {}, data: {}, handle: u }));
    return c;
  }
  function Wb(b, a, c) {
    if (Lc(b)) {
          ...
          ? (h || (I = a),
            c
              ...
              ? ((c = k),
                ...
                (c.hash = a))
              : (k.href = a))
          : (m[c ? 'replaceState' : 'pushState'](e, '', a), g(), (p = t));
        return l;
      }
                  ...
                  try {
                    ...
                    C(l.scope) &&
                      (!0 === l.bindToController
                        ? ((m.bindToController = c(l.scope, s, !0)),
                          (m.isolateScope = {}))
                        : (m.isolateScope = c(l.scope, s, !1)));
                    C(l.bindToController) &&
                      (m.bindToController = c(l.bindToController, s, !0));
      ...
      function(a, b, c, d, t, p, x, q, I, B, O) {
        ...
        function P(a, b, c, d, e, f) {
            ...
            for (s = h.length; m < s; )
              if (((l = A[h[m++]]), (c = h[m++]), (f = h[m++]), c)) {
                if (c.scope) {
                  if (
                    ((k = a.$new()),
                    S.$$addScopeInfo(z(l), k),
                    (B = c.$$destroyBindings))
                  )
                    (c.$$destroyBindings = null), k.$on('$destroyed', B);
                } else k = a;
                B = c.transcludeOnThisElement
                  ? ba(a, c.transclude, e, c.elementTranscludeOnThisElement)
          ...
          for (var h = [], l, k, m, s, p, B = 0; B < a.length; B++) {
            ...
            (f = k.length ? J(k, a[B], l, b, c, null, [], [], f) : null) &&
              f.scope &&
              S.$$addScopeClass(l.$$element);
            l =
              (f && f.terminal) || !(m = a[B].childNodes) || !m.length
                ? null
                : P(
                    m,
                    f
        ...
        function ha(a, b, c, d, e) {
          ...
          switch (a.nodeType) {
            case pa:
              v(b, xa(ta(a)), 'E', d, e);
              for (
                var k, m, s, p = a.attributes, B = 0, A = p && p.length;
                B < A;
                B++
              ) {
                var H = !1,
        ...
        function J(a, b, d, e, f, g, h, k, m) {
          ...
          function M(a, c, e, f, g, l) {
            ...
            if (n) {
              ...
              x &&
                n[x.name] &&
                ((p = x.$$bindings.bindToController),
                (H = n[x.name]) &&
                  H.identifier &&
                  p &&
                  ((I = H), (l.$$destroyBindings = Y(c, f, H.instance, p, x))));
              for (s in n) {
                H = n[s];
                var wa = H();
                wa !== H.instance &&
            ...
            for (l = h.length; s < l; s++)
              (p = h[s]),
                $(
                  ...
                  ja,
                  f,
                  p.require && B(p.directiveName, p.require, ja, n),
                  ha,
                );
            var X = c;
          ...
          for (
            var P = -Number.MAX_VALUE,
              O,
              ba = m.controllerDirectives,
              t = m.newIsolateScopeDirective,
              D = m.templateDirective,
              n = m.nonTlbTranscludeDirective,
              x = !1,
              I = !1,
              q = m.hasElementTranscludeDirective,
              X = (d.$$element = z(b)),
              J,
              w,
              v,
            ...
            if ((v = J.scope))
              J.templateUrl ||
                (C(v)
                  ? (N('new/isolated scope', t || O, J, X), (t = J))
                  : N('new/isolated scope', t, J, X)),
                (O = O || J);
            w = J.name;
            !J.templateUrl &&
              J.controller &&
              ((v = J.controller),
              (ba = ba || ga()),
              N("'" + w + "' controller", ba[w], J, X),
              (ba[w] = J));
            if ((v = J.transclude))
              (x = !0),
                J.$$tlb || (N('transclusion', n, J, X), (n = J)),
                'element' == v
                  ? ((q = !0),
                    (P = J.priority),
                    (v = X),
                    (X = d.$$element = z(
                      W.createComment(' ' + w + ': ' + d[w] + ' '),
                    )),
                    (b = X[0]),
                    U(f, ra.call(v, 0), b),
                    (Ja = S(v, e, P, g && g.name, {
            ...
            if (J.templateUrl)
              ...
              try {
                (za = J.compile(X, d, Ja)),
                  G(za) ? s(null, za, Ab, Q) : za && s(za.pre, za.post, Ab, Q);
              } catch (V) {
                c(V, va(X));
              }
        ...
        function Kf(a, b, c, e, f, g, h, l) {
          ...
          d(I.getTrustedResourceUrl(H)).then(function(d) {
            ...
            if (B.replace) {
              ...
              M = d[0];
              if (1 != d.length || M.nodeType !== pa)
                throw ea('tplrt', B.name, H);
              d = { $attr: {} };
              U(e, b, M);
              var x = ha(M, [], d);
              C(B.scope) && y(x);
          ...
          return function(a, b, c, d, e) {
            ...
            b.$$destroyed ||
              (k
                ? k.push(b, c, d, a)
                : (m.transcludeOnThisElement && (a = ba(b, m.transclude, e)),
                  m(s, b, c, d, a, m)));
          };
        }
        function Ja(a, b) {
            ...
            switch (e.mode) {
              ...
              case '=':
                ...
                k = e.collection
                  ...
                  : a.$watch(t(c[l], k), null, s.literal);
                h = h || [];
                h.push(k);
                break;
              case '&':
        ...
        aa.prototype = {
          ...
          $set: function(a, b, d, e) {
            ...
            e
              ? (this.$attr[a] = e)
              : (e = this.$attr[a]) || (this.$attr[a] = e = Ac(a, '-'));
            g = ta(this.$$element);
      ...
      function(d, e, f, g, h, l) {
        function k(a) {
          function c(a) {
            var b = Q({}, a);
            b.data = a.data
              ? ed(a.data, a.headers, a.status, e.transformResponse)
              : a.data;
            a = a.status;
        ...
        function m(c, f) {
          function l(b, c, d, e) {
            ...
            O &&
              (200 <= b && 300 > b ? O.put(P, [b, c, cd(d), e]) : O.remove(P));
          ...
          (!c.cache && !b.cache) ||
            ...
            (O = C(c.cache) ? c.cache : C(b.cache) ? b.cache : s);
          O &&
            ((D = O.get(P)),
            y(D)
              ? D && G(D.then)
                ? D.then(A, A)
                : K(D)
                ? m(D[1], D[0], fa(D[2]), D[3])
                : m(D, 200, {}, 'OK')
              : O.put(P, B));
          v(D) &&
            ((D = fd(c.url) ? e()[c.xsrfCookieName || b.xsrfCookieName] : u) &&
              (S[c.xsrfHeaderName || b.xsrfHeaderName] = D),
            d(
              c.method,
              P,
              f,
  ...
  function Rf(b, a, c, d, e) {
    ...
    return function(e, h, l, k, m, r, s, A) {
      ...
      if ('jsonp' == E(e)) {
        ...
        var p = f(
          h.replace('JSON_CALLBACK', 'angular.callbacks.' + t),
          t,
          function(a, b) {
            M(k, a, d[t].data, '', b);
            d[t] = w;
    ...
    this.$get = [
      ...
      function(c, d, e) {
        ...
        function h(f, h, m, r) {
          ...
          r = !!r;
          for (
            var p, n, q = 0, I = [], B = [], O = f.length, D = [], S = [];
            q < O;
      ...
      function(b, a, c, d) {
        function e(e, h, l, k) {
          ...
          p.$$intervalId = s(function() {
            ...
            0 < l &&
              H >= l &&
              (t.resolve(H), A(p.$$intervalId), delete f[p.$$intervalId]);
            M || b.$apply();
          }, h);
          f[p.$$intervalId] = t;
          return p;
  ...
  function ef() {
    ...
    this.html5Mode = function(b) {
      return Xa(b)
        ? ((a.enabled = b), this)
        : C(b)
        ? (Xa(b.enabled) && (a.enabled = b.enabled),
          Xa(b.requireBase) && (a.requireBase = b.requireBase),
          Xa(b.rewriteLinks) && (a.rewriteLinks = b.rewriteLinks),
          this)
        : a;
    };
    this.$get = [
  ...
  function od(b) {
    if (1 === b.body.length && nd(b.body[0].expression))
      return {
          ...
          switch (typeof d) {
            case 'string':
              ...
              n ||
                ...
                (H = H ? r : m),
                (n = new gc(H)),
                (n = new hc(n, c, H).parse(d)),
                n.constant
                  ? (n.$$watchDelegate = l)
                  : t
                  ? (n.$$watchDelegate = n.literal ? h : g)
                  : n.inputs && (n.$$watchDelegate = f),
                (q[p] = n));
              return k(n, e);
            case 'function':
              return k(d, e);
          ...
          $digest: function() {
            ...
            do {
              ...
              a: do {
                ...
                if (
                  !(k =
                    (A.$$watchersCount && A.$$childHead) ||
                    (A !== this && A.$$nextSibling))
                )
  ...
  function nf() {
    this.$get = [
      ...
      function(b, a) {
        var c = {},
          d = Y(
            (/android (\d+)/.exec(E((b.navigator || {}).userAgent)) || [])[1],
          ),
        ...
        if (l) {
          ...
          !d ||
            (k && m) ||
            ((k = L(l.webkitTransition)), (m = L(l.webkitAnimation)));
        }
        return {
  ...
  function xd(b) {
    ...
    return function(b, d, e) {
      ...
      return null == b
        ? b
        : Bd(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, e).replace(
            /\u00A4/g,
            d,
          );
    };
  ...
  function zd(b) {
    ...
    return function(b, d) {
      return null == b
        ? b
        : Bd(b, a.PATTERNS[0], a.GROUP_SEP, a.DECIMAL_SEP, d);
    };
  }
  ...
  function Gd(b) {
    ...
    d.$setValidity = function(b, e, f) {
      ...
      d.$pending
        ? (a(Ld, !0), (d.$valid = d.$invalid = u), c('', null))
        : (a(Ld, !1),
          (d.$valid = Kd(d.$error)),
          (d.$invalid = !d.$valid),
          c('', d.$valid));
  ...
  n(
    {
      ...
      scope: function(b) {
        return (
          z.data(b, '$scope') ||
          yb(b.parentNode || b, ['$isolateScope', '$scope'])
        );
      },
        ...
        if (d !== ab && 2 !== d && 8 !== d)
          if (((d = E(a)), zb[d]))
            if (y(c))
              ...
              return b[a] || (b.attributes.getNamedItem(a) || w).specified
                ? d
                : u;
  ...
  bb.$$annotate = function(a, c, d) {
    ...
    if ('function' === typeof a) {
      if (!(e = a.$inject)) {
        ...
        if (a.length) {
          if (c)
            throw ((L(d) && d) || (d = a.name || Hf(a)), Ga('strictdi', d));
      ...
      K(a)
        ? ((c = a.length - 1), Pa(a[c], 'fn'), (e = a.slice(0, c)))
        : Pa(a, 'fn', !0);
    return e;
  };
  var Md = F('$animate'),
      ...
      this.$get = [
        ...
        function(d, e) {
          function f(d, f, l) {
            ...
            f &&
              n(f.split(' '), function(a) {
                a && (k[a] = !0);
              });
            l &&
              n(l.split(' '), function(a) {
                a && (k[a] = !1);
              });
            1 < c.length ||
  ...
  q.prototype = {
    ...
    primary: function() {
      ...
      this.expect('(')
        ...
        ? (a = ua(this.constants[this.consume().text]))
      ...
      switch (a.type) {
        ...
        case q.MemberExpression:
          return (
            ...
            a.computed ||
              (Ba(a.property.name, g.expression), (f = a.property.name)),
  ...
  var Nd = function(a) {
    ...
    Sd = {
      ...
      'datetime-local': ib(
        'datetimelocal',
        Pd,
        Kb(Pd, 'yyyy MM dd HH mm ss sss'.split(' ')),
            ...
            return function(a, f, g, k, m) {
              ...
              a.$watchCollection(r, function(g) {
                ...
                if (Da(g)) (K = g), (r = p || x);
                  ...
                  for (N in ((r = p || C), (K = []), g))
                    g.hasOwnProperty(N) && '$' !== N.charAt(0) && K.push(N);
                I = K.length;
                N = Array(I);
                for (k = 0; k < I; k++)
                  if (
                ...
                for (k = 0; k < I; k++)
                  if (
                    ((G = g === K ? k : K[k]), (L = g[G]), (E = N[k]), E.scope)
                  ) {
                    A = t;
                    do A = A.nextSibling;
                    while (A && A.$$NG_REMOVED);
