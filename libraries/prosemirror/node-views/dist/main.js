(() => {
  ...
  (X.isInline.get = function () {
    ...
    (Y.prototype.validContent = function (t) {
    ...
    (Y.compile = function (t, e) {
      var n = Object.create(null);
      t.forEach(function (t, r) {
        return (n[t] = new Y(t, e, r));
      });
  ...
  (et.prototype.node = function (t, e, n, r) {
    if ('string' == typeof t) t = this.nodeType(t);
      ...
      if (!(t instanceof Y)) throw new RangeError('Invalid node type: ' + t);
      if (t.schema != this)
        throw new RangeError(
  ...
  function Yt(t, e, n) {
    ...
    return (
      e > 1 &&
        (r = r.replaceChild(
          0,
          Yt(r.firstChild, e - 1, 1 == r.childCount ? n - 1 : 0),
        )),
      e > 0 &&
  ...
  (Kt.depth.get = function () {
    ...
    (Wt.prototype.mustMoveInline = function () {
      ...
      if (
        !e.type.isTextblock ||
        !Xt(this.$to, this.$to.depth, e.type, e.match, !1) ||
  ...
  (Gr.create = function (t, e) {
    return e.length ? eo(e, t, 0, Ur) : Yr;
  }),
  ...
  var Yr = new Gr();
  (Gr.empty = Yr), (Gr.removeOverlap = ro);
  var Xr = function (t) {
    this.members = t;
  };
  function Qr(t, e) {
  ...
  function eo(t, e, n, r) {
    ...
    return s.length || o.length ? new Gr(s, o) : Yr;
  }
  function no(t, e) {
  ...
  (Xr.prototype.forChild = function (t, e) {
    ...
    for (var n = [], r = 0; r < this.members.length; r++) {
      ...
      o != Yr && (o instanceof Xr ? (n = n.concat(o.members)) : n.push(o));
    }
    return Xr.from(n);
  }),
    (Xr.prototype.eq = function (t) {
      if (!(t instanceof Xr) || t.members.length != this.members.length)
        return !1;
  ...
  class uo {
    constructor(t) {
      ...
      e.innerHTML = 'This is a custom node view';
      const n = document.createElement('img');
      (n.src = t.attrs.src),
        this.dom.appendChild(e),
        this.dom.appendChild(n),
        this.dom.addEventListener('click', (t) => {
          console.log('You clicked me!'), t.preventDefault();
        });
    }
    stopEvent() {
      return !0;
