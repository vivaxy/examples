(() => {
  ...
  function St(t) {
    var e = Error.call(this, t);
    return (e.__proto__ = St.prototype), e;
  }
  ...
  var xt = function (t) {
    ...
    Ot = { before: { configurable: !0 }, docChanged: { configurable: !0 } };
  function Mt() {
    throw new Error('Override me');
  }
  (Ot.before.get = function () {
    return this.docs.length ? this.docs[0] : this.doc;
  }),
    (xt.prototype.step = function (t) {
      var e = this.maybeStep(t);
      if (e.failed) throw new St(e.failed);
      return this;
    }),
    (xt.prototype.maybeStep = function (t) {
      var e = t.apply(this.doc);
      return e.failed || this.addStep(t, e.doc), e;
    }),
    (Ot.docChanged.get = function () {
      return this.steps.length > 0;
    }),
    (xt.prototype.addStep = function (t, e) {
  ...
  (Nt.prototype.apply = function (t) {
    ...
    (Nt.jsonID = function (t, e) {
      if (t in Ct) throw new RangeError('Duplicate use of step JSON ID ' + t);
      return (Ct[t] = e), (e.prototype.jsonID = t), e;
    });
  var Dt = function (t, e) {
    (this.doc = t), (this.failed = e);
  };
  (Dt.ok = function (t) {
    return new Dt(t, null);
  }),
    (Dt.fail = function (t) {
      return new Dt(null, t);
    }),
    (Dt.fromReplace = function (t, e, n, r) {
      try {
        return Dt.ok(t.replace(e, n, r));
      } catch (t) {
        if (t instanceof p) return Dt.fail(t.message);
        throw t;
      }
    });
  var Tt = (function (t) {
    ...
    return (
      ...
      (e.prototype.apply = function (t) {
        return this.structure && At(t, this.from, this.to)
          ? Dt.fail('Structure replace would overwrite content')
          : Dt.fromReplace(t, this.from, this.to, this.slice);
      }),
  ...
  var Et = (function (t) {
    ...
    return (
      ...
      (e.prototype.apply = function (t) {
        ...
        if (e.openStart || e.openEnd) return Dt.fail('Gap is not a flat range');
        var n = this.slice.insertAt(this.insert, e.content);
        return n
          ? Dt.fromReplace(t, this.from, this.to, n)
          : Dt.fail('Content does not fit in gap');
      }),
      (e.prototype.getMap = function () {
        return new bt([
          this.from,
  ...
  function Rt(t, e, n) {
    for (var r = [], i = 0; i < t.childCount; i++) {
      var s = t.child(i);
      s.content.size && (s = s.copy(Rt(s.content, e, s))),
  ...
  Nt.jsonID('replaceAround', Et),
    (xt.prototype.lift = function (t, e) {
      for (
        var n = t.$from,
          r = t.$to,
          i = t.depth,
      ...
      for (var m = o.empty, v = 0, g = i, y = !1; g > e; g--)
        y || r.after(g + 1) < r.end(g)
          ...
          : h++;
      return this.step(
        new Et(c, h, s, a, new l(p.append(m), f, v), p.size - f, !0),
      );
    }),
    (xt.prototype.wrap = function (t, e) {
      for (var n = o.empty, r = e.length - 1; r >= 0; r--)
        n = o.from(e[r].type.create(e[r].attrs, n));
      var i = t.start,
        s = t.end;
      return this.step(new Et(i, s, i, s, new l(n, 0, 0), e.length, !0));
    }),
    (xt.prototype.setBlockType = function (t, e, n, r) {
      var i = this;
    ...
    (xt.prototype.setNodeMarkup = function (t, e, n, r) {
    ...
    (xt.prototype.split = function (t, e, n) {
      void 0 === e && (e = 1);
      for (
      ...
      return this.step(new Tt(t, t, new l(i.append(s), e, e), !0));
    }),
    (xt.prototype.join = function (t, e) {
      void 0 === e && (e = 1);
      var n = new Tt(t - e, t + e, l.empty, !0);
      return this.step(n);
    });
  var zt = (function (t) {
    function e(e, n, r) {
    ...
    return (
      ...
      (e.prototype.apply = function (t) {
        ...
        return Dt.fromReplace(t, this.from, this.to, i);
      }),
    ...
    return (
      ...
      (e.prototype.apply = function (t) {
        var e = this,
          n = t.slice(this.from, this.to),
          r = new l(
            Rt(n.content, function (t) {
              return t.mark(e.mark.removeFromSet(t.marks));
            }),
            n.openStart,
            n.openEnd,
          );
        return Dt.fromReplace(t, this.from, this.to, r);
      }),
      (e.prototype.invert = function () {
  ...
  Nt.jsonID('removeMark', Pt),
    (xt.prototype.addMark = function (t, e, n) {
      var r = this,
        o = [],
        i = [],
        s = null,
              ...
              for (
                ...
                p[d].isInSet(u) ||
                  (s && s.to == l && s.mark.eq(p[d])
                    ? (s.to = f)
                    : o.push((s = new Pt(l, f, p[d]))));
              a && a.to == l ? (a.to = f) : i.push((a = new zt(l, f, n)));
            }
          }
        }),
    ...
    (xt.prototype.removeMark = function (t, e, n) {
      var r = this;
      void 0 === n && (n = null);
      var o = [],
        i = 0;
      return (
        ...
        o.forEach(function (t) {
          return r.step(new Pt(t.from, t.to, t.style));
        }),
        this
      );
    }),
    (xt.prototype.clearIncompatible = function (t, e, n) {
        ...
        if (p) {
          ...
          for (var f = 0; f < c.marks.length; f++)
            e.allowsMarkType(c.marks[f].type) ||
              this.step(new Pt(s, h, c.marks[f]));
        } else i.push(new Tt(s, h, l.empty));
        s = h;
      }
      if (!n.validEnd) {
    ...
    (xt.prototype.replace = function (t, e, n) {
      ...
      var r = (function (t, e, n, r) {
        ...
        var o = t.resolve(e),
          i = t.resolve(n);
        return It(o, i, r) ? new Tt(e, n, r) : new Bt(o, i, r).fit();
      })(this.doc, t, e, n);
      return r && this.step(r), this;
    }),
    (xt.prototype.replaceWith = function (t, e, n) {
      return this.replace(t, e, new l(o.from(n), 0, 0));
    }),
    (xt.prototype.delete = function (t, e) {
  ...
  var Bt = function (t, e, n) {
    ...
    Ft = { depth: { configurable: !0 } };
  function Vt(t, e, n) {
    return 0 == e
      ? t.cutByIndex(n)
      : t.replaceChild(
          0,
          t.firstChild.copy(Vt(t.firstChild.content, e - 1, n)),
        );
  }
  function _t(t, e, n) {
    return 0 == e
      ...
      : t.replaceChild(
          t.childCount - 1,
          t.lastChild.copy(_t(t.lastChild.content, e - 1, n)),
        );
  }
  function $t(t, e) {
  ...
  function jt(t, e, n) {
    ...
    return (
      e > 1 &&
        (r = r.replaceChild(
          0,
          jt(r.firstChild, e - 1, 1 == r.childCount ? n - 1 : 0),
        )),
      e > 0 &&
  ...
  function Jt(t, e, n, r, i) {
    if (e < n) {
      var s = t.firstChild;
      t = t.replaceChild(0, s.copy(Jt(s.content, e + 1, n, r, s)));
    }
    if (e > r) {
  ...
  (Ft.depth.get = function () {
    return this.frontier.length - 1;
  }),
    (Bt.prototype.fit = function () {
      ...
      return e > -1
        ...
        ? new Tt(r.pos, o.pos, c)
        : void 0;
    }),
    (Bt.prototype.findFittable = function () {
      for (var t = 1; t <= 2; t++)
        for (var e = this.unplaced.openStart; e >= 0; e--)
          for (
            var n = void 0,
              r = (e
                ? (n = $t(this.unplaced.content, e - 1).firstChild).content
    ...
    (Bt.prototype.openMore = function () {
      var t = this.unplaced,
        e = t.content,
        n = t.openStart,
        r = t.openEnd,
    ...
    (Bt.prototype.dropNode = function () {
      var t = this.unplaced,
        e = t.content,
        n = t.openStart,
        r = t.openEnd,
      ...
      if (o.childCount <= 1 && n > 0) {
        ...
        this.unplaced = new l(Vt(e, n - 1, 1), n - 1, i ? n - 1 : r);
      } else this.unplaced = new l(Vt(e, n, 1), n, r);
    }),
    (Bt.prototype.placeNodes = function (t) {
      for (
        var e = t.sliceDepth,
          n = t.frontierDepth,
          r = t.parent,
      ...
      k || (y = -1),
        (this.placed = _t(this.placed, n, o.from(u))),
      ...
      this.unplaced = k
        ? 0 == e
          ? l.empty
          : new l(Vt(c.content, e - 1, 1), e - 1, y < 0 ? c.openEnd : e - 1)
        : new l(Vt(c.content, e, f), c.openStart, c.openEnd);
    }),
    (Bt.prototype.mustMoveInline = function () {
      ...
      if (
        !e.type.isTextblock ||
        !Lt(this.$to, this.$to.depth, e.type, e.match, !1) ||
    ...
    (Bt.prototype.findCloseLevel = function (t) {
    ...
    (Bt.prototype.close = function (t) {
      var e = this.findCloseLevel(t);
      if (!e) return null;
      for (; this.depth > e.depth; ) this.closeFrontierNode();
      e.fit.childCount && (this.placed = _t(this.placed, e.depth, e.fit)),
        (t = e.move);
    ...
    (Bt.prototype.openFrontierNode = function (t, e, n) {
      var r = this.frontier[this.depth];
      (r.match = r.match.matchType(t)),
        (this.placed = _t(this.placed, this.depth, o.from(t.create(e, n)))),
        this.frontier.push({ type: t, match: t.contentMatch });
    }),
    (Bt.prototype.closeFrontierNode = function () {
      var t = this.frontier.pop().match.fillBefore(o.empty, !0);
      t.childCount && (this.placed = _t(this.placed, this.frontier.length, t));
    }),
    Object.defineProperties(Bt.prototype, Ft),
    (xt.prototype.replaceRange = function (t, e, n) {
      if (!n.size) return this.deleteRange(t, e);
      var r = this.doc.resolve(t),
        o = this.doc.resolve(e);
      if (It(r, o, n)) return this.step(new Tt(t, e, n));
      var i = qt(r, this.doc.resolve(e));
          ...
          for (var b = 0; b < i.length; b++) {
            ...
            if (x.canReplaceWith(O, O, w.type, w.marks))
              return this.replace(
                r.before(k),
                S ? o.after(k) : e,
                new l(Jt(n.content, 0, n.openStart, y), y, n.openEnd),
              );
          }
      }
      for (
    ...
    (xt.prototype.replaceRangeWith = function (t, e, n) {
    ...
    (xt.prototype.deleteRange = function (t, e) {
      for (
  ...
  var Wt = Object.create(null),
    Kt = function (t, e, n) {
      (this.ranges = n || [new Ut(t.min(e), t.max(e))]),
        (this.$anchor = t),
        (this.$head = e);
    },
    Ht = {
  ...
  (Ht.anchor.get = function () {
    return this.$anchor.pos;
  }),
    (Ht.head.get = function () {
      return this.$head.pos;
    }),
    (Ht.from.get = function () {
    ...
    (Kt.prototype.replace = function (t, e) {
      ...
      for (var i = t.steps.length, s = this.ranges, a = 0; a < s.length; a++) {
        ...
        t.replaceRange(f.map(h.pos), f.map(p.pos), a ? l.empty : e),
          0 == a && ne(t, i, (n ? n.isInline : r && r.isTextblock) ? -1 : 1);
      }
    }),
    (Kt.prototype.replaceWith = function (t, e) {
      for (var n = t.steps.length, r = this.ranges, o = 0; o < r.length; o++) {
        ...
        o
          ? t.deleteRange(h, p)
          : (t.replaceRangeWith(h, p, e), ne(t, n, e.isInline ? -1 : 1));
      }
    }),
    (Kt.findFrom = function (t, e, n) {
      var r = t.parent.inlineContent
        ? new Gt(t)
        : ee(t.node(0), t.parent, t.pos, t.index(), e, n);
      if (r) return r;
      for (var o = t.depth - 1; o >= 0; o--) {
        var i =
          e < 0
            ? ee(t.node(0), t.node(o), t.before(o + 1), t.index(o), e, n)
            : ee(t.node(0), t.node(o), t.after(o + 1), t.index(o) + 1, e, n);
        if (i) return i;
      }
    }),
    (Kt.near = function (t, e) {
      return (
        void 0 === e && (e = 1),
        this.findFrom(t, e) || this.findFrom(t, -e) || new Zt(t.node(0))
      );
    }),
    (Kt.atStart = function (t) {
      return ee(t, t, 0, 0, 1) || new Zt(t);
    }),
    (Kt.atEnd = function (t) {
      return ee(t, t, t.content.size, t.childCount, -1) || new Zt(t);
    }),
    (Kt.fromJSON = function (t, e) {
      if (!e || !e.type)
    ...
    (Kt.jsonID = function (t, e) {
      if (t in Wt)
        throw new RangeError('Duplicate use of selection JSON ID ' + t);
      return (Wt[t] = e), (e.prototype.jsonID = t), e;
    }),
    (Kt.prototype.getBookmark = function () {
      return Gt.between(this.$anchor, this.$head).getBookmark();
    }),
  ...
  (Xt.prototype.map = function (t) {
    return new Xt(t.map(this.anchor), t.map(this.head));
  }),
    (Xt.prototype.resolve = function (t) {
      return Gt.between(t.resolve(this.anchor), t.resolve(this.head));
    });
  var Yt = (function (t) {
    function e(e) {
      var n = e.nodeAfter,
  ...
  (Yt.prototype.visible = !1), Kt.jsonID('node', Yt);
  var Qt = function (t) {
    this.anchor = t;
  };
  (Qt.prototype.map = function (t) {
    var e = t.mapResult(this.anchor),
      n = e.deleted,
      r = e.pos;
    return n ? new Xt(r, r) : new Qt(r);
  }),
    (Qt.prototype.resolve = function (t) {
      var e = t.resolve(this.anchor),
        n = e.nodeAfter;
      return n && Yt.isSelectable(n) ? new Yt(e) : Kt.near(e);
    });
  var Zt = (function (t) {
    function e(e) {
  ...
  function ee(t, e, n, r, o, i) {
    if (e.inlineContent) return Gt.create(t, n);
    for (
      var s = r - (o > 0 ? 0 : 1);
      ...
      var a = e.child(s);
      if (a.isAtom) {
        if (!i && Yt.isSelectable(a))
          return Yt.create(t, n - (o < 0 ? a.nodeSize : 0));
      } else {
        var c = ee(t, a, n + o, o < 0 ? a.childCount : 0, o, i);
        if (c) return c;
      }
      n += a.nodeSize * o;
    }
  ...
  function ne(t, e, n) {
    ...
    if (!(r < e)) {
      var o,
        i = t.steps[r];
      (i instanceof Tt || i instanceof Et) &&
        (t.mapping.maps[r].forEach(function (t, e, n, r) {
          null == o && (o = r);
        }),
        t.setSelection(Kt.near(t.doc.resolve(o), n)));
    }
  }
  var re = (function (t) {
    function e(e) {
      ...
      (e.prototype.insertText = function (t, e, n) {
        ...
        return (
          ...
          this.selection.empty ||
            this.setSelection(Kt.near(this.selection.$to)),
          this
        );
      }),
  ...
  var ie = function (t, e, n) {
      (this.name = t),
        (this.init = oe(e.init, n)),
        (this.apply = oe(e.apply, n));
    },
    se = [
      new ie('doc', {
        init: function (t) {
      ...
      new ie('selection', {
        init: function (t, e) {
          return t.selection || Kt.atStart(e.doc);
        },
        apply: function (t) {
          return t.selection;
        },
        ...
        e &&
          e.forEach(function (t) {
            ...
            n.plugins.push(t),
              ...
              t.spec.state && n.fields.push(new ie(t.key, t.spec.state, t));
          });
    },
    ce = function (t) {
      this.config = t;
  ...
  (he.schema.get = function () {
    return this.config.schema;
  }),
    (he.plugins.get = function () {
      return this.config.plugins;
    }),
    (ce.prototype.apply = function (t) {
      return this.applyTransaction(t).state;
    }),
    (ce.prototype.filterTransaction = function (t, e) {
      void 0 === e && (e = -1);
    ...
    (ce.prototype.applyTransaction = function (t) {
    ...
    (ce.prototype.applyInner = function (t) {
      if (!t.before.eq(this.doc))
        throw new RangeError('Applying a mismatched transaction');
      for (
        var e = new ce(this.config), n = this.config.fields, r = 0;
        r < n.length;
        r++
      ) {
        var o = n[r];
      ...
      for (var i = 0; i < pe.length; i++) pe[i](this, t, e);
      return e;
    }),
    (he.tr.get = function () {
      return new re(this);
    ...
    (ce.create = function (t) {
      for (
        var e = new ae(t.doc ? t.doc.type.schema : t.schema, t.plugins),
          n = new ce(e),
          r = 0;
        r < e.fields.length;
        r++
    ...
    (ce.prototype.reconfigure = function (t) {
      for (
        var e = new ae(this.schema, t.plugins),
          n = e.fields,
          r = new ce(e),
          o = 0;
        o < n.length;
    ...
    (ce.addApplyListener = function (t) {
      pe.push(t);
    }),
    (ce.removeApplyListener = function (t) {
      var e = pe.indexOf(t);
      e > -1 && pe.splice(e, 1);
    }),
  ...
  var fe = function (t) {
    (this.props = {}),
      t.props && le(t.props, this, this.props),
      (this.spec = t),
      (this.key = t.key ? t.key.key : de('plugin'));
  };
  fe.prototype.getState = function (t) {
    return t[this.key];
  };
  var ue = Object.create(null);
  function de(t) {
    return t in ue ? t + '$' + ++ue[t] : ((ue[t] = 0), t + '$');
  }
  var me = function (t) {
  ...
  if ('undefined' != typeof navigator && 'undefined' != typeof document) {
    var ge = /Edge\/(\d+)/.exec(navigator.userAgent),
      ye = /MSIE \d/.test(navigator.userAgent),
      we = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
    ve.mac = /Mac/.test(navigator.platform);
    var be = (ve.ie = !!(ye || we || ge));
    (ve.ie_version = ye
      ...
      ? +ge[1]
      : null),
      (ve.gecko = !be && /gecko\/(\d+)/i.test(navigator.userAgent)),
      (ve.gecko_version =
        ve.gecko && +(/Firefox\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1]);
    var ke = !be && /Chrome\/(\d+)/.exec(navigator.userAgent);
    (ve.chrome = !!ke),
      (ve.chrome_version = ke && +ke[1]),
      (ve.safari = !be && /Apple Computer/.test(navigator.vendor)),
      (ve.ios =
        ve.safari &&
        (/Mobile\/\w+/.test(navigator.userAgent) ||
          navigator.maxTouchPoints > 2)),
      (ve.android = /Android \d/.test(navigator.userAgent)),
      (ve.webkit = 'webkitFontSmoothing' in document.documentElement.style),
      (ve.webkit_version =
        ve.webkit &&
  ...
  var Se = function (t) {
    ...
    Oe = null,
    Me = function (t, e, n) {
      var r = Oe || (Oe = document.createRange());
      return (
    ...
    Ce = function (t, e, n, r) {
      return n && (De(t, e, n, r, -1) || De(t, e, n, r, 1));
    },
  ...
  var Ae = function (t) {
    var e = t.isCollapsed;
    return (
      e && ve.chrome && t.rangeCount && !t.getRangeAt(0).collapsed && (e = !1),
      e
    );
  };
  function Re(t, e) {
      ...
      if (1 == s.nodeType) {
        ...
        if (
          (e.top < c.top + Pe(r, 'top')
            ? (p = -(c.top - e.top + Pe(o, 'top')))
            : e.bottom > c.bottom - Pe(r, 'bottom') &&
              (p = e.bottom - c.bottom + Pe(o, 'bottom')),
          e.left < c.left + Pe(r, 'left')
            ? (h = -(c.left - e.left + Pe(o, 'left')))
            : e.right > c.right - Pe(r, 'right') &&
              (h = e.right - c.right + Pe(o, 'right')),
          h || p)
        )
  ...
  function Je(t, e) {
    ...
    if (!p || !t.dom.contains(1 != p.nodeType ? p.parentNode : p)) {
      ...
      if (!je(e, l)) return null;
      if (!(p = Le(t.dom, e, l))) return null;
    }
    if (
      (ve.safari && p.draggable && (o = i = null),
      (p = (function (t, e) {
        var n = t.parentNode;
        return n &&
  ...
  function Ke(t, e, n) {
    var r = t.docView.domFromPos(e, n < 0 ? -1 : 1),
      o = r.node,
      i = r.offset,
      s = ve.webkit || ve.gecko;
    if (3 == o.nodeType) {
      if (
        !s ||
        (!We.test(o.nodeValue) && (n < 0 ? i : i != o.nodeValue.length))
      ) {
        var a = i,
          c = i,
          h = n < 0 ? 1 : -1;
      ...
      if (
        ...
        var l = qe(Me(o, i - 1, i - 1), -1);
        if (l.top == p.top) {
          var f = qe(Me(o, i, i + 1), -1);
          if (f.top != p.top) return He(f, f.left < l.left);
        }
      }
      return p;
    }
    if (!t.state.doc.resolve(e).parent.inlineContent) {
      if (i && (n < 0 || i == Te(o))) {
        ...
        if (1 == u.nodeType) return Ue(u.getBoundingClientRect(), !1);
      }
      if (i < Te(o)) {
        var d = o.childNodes[i];
        if (1 == d.nodeType) return Ue(d.getBoundingClientRect(), !0);
      }
      return Ue(o.getBoundingClientRect(), n >= 0);
    }
    if (i && (n < 0 || i == Te(o))) {
      var m = o.childNodes[i - 1],
        v =
          3 == m.nodeType
            ...
            ? null
            : m;
      if (v) return He(qe(v, 1), !1);
    }
    if (i < Te(o)) {
      var g = o.childNodes[i],
        y = 3 == g.nodeType ? Me(g, 0, s ? 0 : 1) : 1 == g.nodeType ? g : null;
      if (y) return He(qe(y, -1), !0);
    }
    return He(qe(3 == o.nodeType ? Me(o) : o, -n), n >= 0);
  }
  function He(t, e) {
  ...
  (tn.prototype.matchesWidget = function () {
    return !1;
  }),
    (tn.prototype.matchesMark = function () {
      return !1;
    }),
    (tn.prototype.matchesNode = function () {
      return !1;
    }),
    (tn.prototype.matchesHack = function () {
      return !1;
    }),
    (en.beforePosition.get = function () {
      return !1;
    }),
    (tn.prototype.parseRule = function () {
      return null;
    }),
    (tn.prototype.stopEvent = function () {
      return !1;
    }),
    ...
    (tn.prototype.localPosFromDOM = function (t, e, n) {
      ...
      var a;
      if (t == this.dom && this.contentDOM) a = e > Se(this.contentDOM);
      else if (
        this.contentDOM &&
      ...
      for (var n = 0, r = 0, o = !0; ; r++, o = !1) {
        ...
        if (
          ...
          return {
            ...
            offset: i ? Se(i.dom) : this.contentDOM.childNodes.length,
          };
    ...
    (tn.prototype.setSelection = function (t, e, n, r) {
      ...
      if ((ve.gecko || ve.safari) && t == e) {
        ...
        if (3 == d.nodeType)
          (u = m && '\n' == d.nodeValue[m - 1]) &&
            ...
            (p = l = { node: d.parentNode, offset: Se(d) + 1 });
        else {
      ...
      if (
        r ||
        (u && ve.safari) ||
        !Ce(p.node, p.offset, f.anchorNode, f.anchorOffset) ||
        !Ce(l.node, l.offset, f.focusNode, f.focusOffset)
      ) {
        var y = !1;
        if ((f.extend || t == e) && !u) {
          f.collapse(p.node, p.offset);
          try {
            t != e && f.extend(l.node, l.offset), (y = !0);
          } catch (t) {
  ...
  var nn = [],
    rn = (function (t) {
      function e(e, n, r, o) {
        ...
        t.call(this, e, nn, s, null), (this.widget = n), (i = this);
      }
      t && (e.__proto__ = t),
        (e.prototype = Object.create(t && t.prototype)),
        (e.prototype.constructor = e);
    ...
    on = (function (t) {
      function e(e, n, r, o) {
        t.call(this, e, nn, n, null), (this.textDOM = r), (this.text = o);
      }
      t && (e.__proto__ = t),
        (e.prototype = Object.create(t && t.prototype)),
        (e.prototype.constructor = e);
      ...
      return (
        ...
        (e.prototype.slice = function (t, n, r) {
          var o = e.create(this.parent, this.mark, !0, r),
            i = this.children,
            s = this.size;
          n < s && (i = xn(i, n, s, r)), t > 0 && (i = xn(i, 0, t, r));
      ...
      return (
        (e.create = function (t, n, r, o, i, s) {
          ...
          return (
            (l = yn(l, r, n)),
            p
              ? (c = new ln(t, n, r, o, l, f, u, p, i, s + 1))
              : n.isText
              ? new hn(t, n, r, o, l, u, i)
        ...
        (e.prototype.protectLocalComposition = function (t, e) {
          ...
          if (!this.getDesc(n)) {
            ...
            var s = new on(this, i, n, o);
            t.compositionNodes.push(s),
              (this.children = xn(this.children, r, r + o.length, t, s));
          }
        }),
  ...
  function cn(t, e, n, r, o) {
    return yn(r, e, t), new an(null, t, e, n, r, r, r, o, 0);
  }
  var hn = (function (t) {
      function e(e, n, r, o, i, s, a) {
  ...
  var dn = [new un()];
  function mn(t, e, n) {
    if (0 == t.length) return dn;
    for (var r = n ? dn[0] : new un(), o = [r], i = 0; i < t.length; i++) {
      var s = t[i].type.attrs;
      if (s)
        for (var a in (s.nodeName && o.push((r = new un(s.nodeName))), s)) {
          var c = s[a];
          null != c &&
            (n &&
              1 == o.length &&
  ...
  function gn(t, e, n) {
    ...
    if (e.class != n.class) {
      for (
        var i = e.class ? e.class.split(' ').filter(Boolean) : nn,
          s = n.class ? n.class.split(' ').filter(Boolean) : nn,
          a = 0;
        a < i.length;
        a++
      )
  ...
  function yn(t, e, n) {
    return vn(t, t, dn, mn(e, n, 1 != t.nodeType));
  }
  function wn(t, e) {
    if (t.length != e.length) return !1;
  ...
  function On(t, e) {
    ...
    if (Ae(n)) {
      ...
      if (
        o &&
        o.node.isAtom &&
        Yt.isSelectable(o.node) &&
        o.parent &&
        (!o.node.isInline ||
          !(function (t, e, n) {
            for (var r = 0 == e, o = e == Te(t); r || o; ) {
              if (t == n) return !0;
              var i = Se(t);
      ...
      if ((t.domObserver.disconnectSelection(), t.cursorWrapper))
        !(function (t) {
          var e = t.root.getSelection(),
            ...
            o = 'IMG' == r.nodeName;
          o ? n.setEnd(r.parentNode, Se(r) + 1) : n.setEnd(r, 0),
            n.collapse(!1),
            e.removeAllRanges(),
            e.addRange(n),
            !o &&
        ...
        !Nn ||
          n instanceof Gt ||
          (n.$from.parent.inlineContent || (r = Dn(t, n.from)),
          n.empty || n.$from.parent.inlineContent || (o = Dn(t, n.to))),
                  ...
                  e.addEventListener(
                    ...
                    (t.hideSelectionGuard = function () {
                      (n.anchorNode == r && n.anchorOffset == o) ||
                        ...
                        setTimeout(function () {
                          (Mn(t) && !t.state.selection.visible) ||
                            t.dom.classList.remove('ProseMirror-hideselection');
                        }, 20));
                    }),
                  );
  ...
  (kn.prototype.destroyBetween = function (t, e) {
    if (t != e) {
      for (var n = t; n < e; n++) this.top.children[n].destroy();
      this.top.children.splice(t, e - t), (this.changed = !0);
    }
  }),
    (kn.prototype.destroyRest = function () {
      this.destroyBetween(this.index, this.top.children.length);
    }),
    (kn.prototype.syncToMarks = function (t, e, n) {
      for (
      ...
      for (; o < t.length; ) {
        ...
        if (s > -1)
          ...
          var c = sn.create(this.top, t[o], e, n);
    ...
    (kn.prototype.findNodeMatch = function (t, e, n, r) {
    ...
    (kn.prototype.updateNextNode = function (t, e, n, r, o) {
    ...
    (kn.prototype.addNode = function (t, e, n, r, o) {
      this.top.children.splice(
        this.index++,
        0,
        an.create(this.top, t, e, n, r, o),
      ),
        (this.changed = !0);
    }),
    (kn.prototype.placeWidget = function (t, e, n) {
      var r =
      ...
      if (
        ...
        var o = new rn(this.top, t, e, n);
        this.top.children.splice(this.index++, 0, o), (this.changed = !0);
      } else this.index++;
    }),
    (kn.prototype.addTextblockHacks = function () {
      for (var t = this.top.children[this.index - 1]; t instanceof sn; )
        t = t.children[t.children.length - 1];
      if (!t || !(t instanceof hn) || /\n$/.test(t.node.text))
        if (
          this.index < this.top.children.length &&
          ...
          this.top.children.splice(
            this.index++,
            0,
            new pn(this.top, nn, e, null),
          ),
            (this.changed = !0);
        }
    });
  var Nn = ve.safari || (ve.chrome && ve.chrome_version < 63);
  function Dn(t, e) {
    ...
    if (ve.safari && i && 'false' == i.contentEditable) return Tn(i);
    if (
      !(
  ...
  function Tn(t) {
    return (
      ...
      ve.safari && t.draggable && ((t.draggable = !1), (t.wasDraggable = !0)),
      t
    );
  }
  function En(t) {
  ...
  function An(t, e) {
    if (e instanceof Yt) {
      ...
      n != t.lastSelectedViewDesc &&
        (Rn(t), n && n.selectNode(), (t.lastSelectedViewDesc = n));
    } else Rn(t);
  }
  function Rn(t) {
  ...
  function Fn(t, e, n) {
    ...
    if (!(r instanceof Gt)) {
      if (r instanceof Yt && r.node.isInline)
        return Bn(t, new Gt(e > 0 ? r.$to : r.$from));
      var o = In(t.state, e);
      return !!o && Bn(t, o);
    }
    ...
    if (t.endOfTextblock(e > 0 ? 'right' : 'left')) {
      var i = In(t.state, e);
      return !!(i && i instanceof Yt) && Bn(t, i);
    }
    if (!(ve.mac && n.indexOf('m') > -1)) {
      var s,
        a = r.$head,
      ...
      return (
        ...
        (Yt.isSelectable(c)
          ? Bn(t, new Yt(e < 0 ? t.state.doc.resolve(a.pos - c.nodeSize) : a))
          : !!ve.webkit &&
            Bn(t, new Gt(t.state.doc.resolve(e < 0 ? h : h + c.nodeSize))))
      );
    }
  }
  function Vn(t) {
    ...
    if (n) {
      ...
      for (
        ...
        if (r > 0) {
          ...
          if (Ln(n)) break;
          for (var c = n.previousSibling; c && _n(c); )
            (o = n.parentNode), (i = Se(c)), (c = c.previousSibling);
          if (c) r = Vn((n = c));
          else {
  ...
  function jn(t) {
    ...
    if (n) {
      for (var o, i, s = Vn(n); ; )
        if (r < s) {
          if (1 != n.nodeType) break;
          if (!_n(n.childNodes[r])) break;
          (o = n), (i = ++r);
        } else {
          if (Ln(n)) break;
          for (var a = n.nextSibling; a && _n(a); )
            (o = a.parentNode), (i = Se(a) + 1), (a = a.nextSibling);
          if (a) (r = 0), (s = Vn((n = a)));
          else {
            if ((n = n.parentNode) == t.dom) break;
            r = s = 0;
  ...
  function qn(t, e, n) {
    var r = t.state.selection;
    if ((r instanceof Gt && !r.empty) || n.indexOf('s') > -1) return !1;
    if (ve.mac && n.indexOf('m') > -1) return !1;
    var o = r.$from,
      i = r.$to;
    if (!o.parent.inlineContent || t.endOfTextblock(e < 0 ? 'up' : 'down')) {
      var s = In(t.state, e);
      if (s && s instanceof Yt) return Bn(t, s);
    }
    if (!o.parent.inlineContent) {
      var a = e < 0 ? o : i,
        c = r instanceof Zt ? Kt.near(a, e) : Kt.findFrom(a, e);
      return !!c && Bn(t, c);
    }
    return !1;
  }
  function Wn(t, e) {
    if (!(t.state.selection instanceof Gt)) return !0;
    var n = t.state.selection,
      r = n.$head,
      o = n.$anchor,
      i = n.empty;
  ...
  function Hn(t) {
    ...
    if ('BR' == t.nodeName && t.parentNode) {
      if (ve.safari && /^(ul|ol)$/i.test(t.parentNode.nodeName)) {
        var n = document.createElement('div');
        return n.appendChild(document.createElement('li')), { skip: n };
      }
      if (
        t.parentNode.lastChild == t ||
        (ve.safari && /^(tr|table)$/i.test(t.parentNode.nodeName))
      )
        return { ignore: !0 };
  ...
  function Un(t, e, n) {
    return Math.max(n.anchor, n.head) > e.content.size
      ? null
      : zn(t, e.resolve(n.anchor), e.resolve(n.head));
  }
  function Gn(t, e, n) {
    for (
  ...
  function Xn(t, e) {
    ...
    for (
      ...
      l && 1 == l.nodeType && (p = nr[l.nodeName.toLowerCase()]);
    ...
    if (h) {
      ...
      t.someProp('transformPastedHTML', function (t) {
        ...
        (s = (function (t) {
          ...
          var n,
            r = or().createElement('div'),
            o = /<([a-z][^>\s]+)/i.exec(t);
          if (
            ((n = o && nr[o[1].toLowerCase()]) &&
              (t =
                n
                  .map(function (t) {
                    return '<' + t + '>';
        ...
        ? (function (t, e) {
            ...
            (function (t, e, n) {
              return (
                ...
                n < t.openEnd &&
                  (t = new l(
                    er(t.content, 1, n, t.openEnd, 0, 0),
                    t.openStart,
                    n,
                  )),
                t
                        ...
                        if (s) {
                          ...
                          if (
                            (e =
                              s.length &&
                              i.length &&
                              Zn(n, i, t, s[s.length - 1], 0))
                          )
                            s[s.length - 1] = e;
                          else {
                            s.length &&
                              (s[s.length - 1] = tr(s[s.length - 1], i.length));
                            var o = Qn(t, n);
                            s.push(o),
  ...
  function Zn(t, e, n, r, i) {
    if (i < t.length && i < e.length && t[i] == e[i]) {
      var s = Zn(t, e, n, r.lastChild, i + 1);
      ...
      if (
        ...
        return r.copy(r.content.append(o.from(Qn(n, t, i + 1))));
    }
  }
  function tr(t, e) {
    if (0 == e) return t;
    var n = t.content.replaceChild(t.childCount - 1, tr(t.lastChild, e - 1)),
  ...
  var nr = {
    ...
    rr = null;
  function or() {
    return rr || (rr = document.implementation.createHTMLDocument('title'));
  }
  var ir = {
      childList: !0,
      characterData: !0,
  ...
  (cr.prototype.flushSoon = function () {
    var t = this;
    this.flushingSoon < 0 &&
    ...
    (cr.prototype.forceFlush = function () {
      this.flushingSoon > -1 &&
    ...
    (cr.prototype.start = function () {
      this.observer && this.observer.observe(this.view.dom, ir),
        sr &&
    ...
    (cr.prototype.connectSelection = function () {
      this.view.dom.ownerDocument.addEventListener(
        'selectionchange',
        this.onSelectionChange,
      );
    }),
    (cr.prototype.disconnectSelection = function () {
      this.view.dom.ownerDocument.removeEventListener(
        'selectionchange',
        this.onSelectionChange,
      );
    }),
    (cr.prototype.suppressSelectionUpdates = function () {
      var t = this;
    ...
    (cr.prototype.onSelectionChange = function () {
      if (
        (!(e = this.view).editable || e.root.activeElement == e.dom) &&
        Pn(e)
      ) {
        if (this.suppressingSelectionUpdates) return Cn(this.view);
        if (ve.ie && ve.ie_version <= 11 && !this.view.state.selection.empty) {
          var t = this.view.root.getSelection();
          if (
            t.focusNode &&
            Ce(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset)
          )
    ...
    (cr.prototype.setCurSelection = function () {
      this.currentSelection.set(this.view.root.getSelection());
    }),
    (cr.prototype.ignoreSelectionChange = function (t) {
      ...
      if (this.view.docView && !(this.flushingSoon > -1)) {
        ...
        (r > -1 || n) &&
          ...
          this.view.docView.dirty
            ...
            : this.currentSelection.eq(e) || Cn(this.view),
          this.currentSelection.set(e));
      }
      var f;
    }),
    (cr.prototype.registerMutation = function (t, e) {
      ...
      if ('childList' == t.type) {
        ...
        var o = t.previousSibling,
          i = t.nextSibling;
        if (ve.ie && ve.ie_version <= 11 && t.addedNodes.length)
        ...
        var p = o && o.parentNode == t.target ? Se(o) + 1 : 0,
          l = n.localPosFromDOM(t.target, p, -1),
          f =
            i && i.parentNode == t.target ? Se(i) : t.target.childNodes.length;
  ...
  function yr(t, e, n, r) {
    return (
      vr(t, 'handleDoubleClickOn', e, n, r) ||
  ...
  function wr(t, e, n, r) {
    return (
      vr(t, 'handleTripleClickOn', e, n, r) ||
      ...
      (function (t, e) {
        ...
        if (-1 == e)
          return (
            !!n.inlineContent &&
            (gr(t, Gt.create(n, 0, n.content.size), 'pointer'), !0)
          );
        for (var r = n.resolve(e), o = r.depth + 1; o > 0; o--) {
          var i = o > r.depth ? r.nodeAfter : r.node(o),
            s = r.before(o);
          if (i.inlineContent)
            gr(t, Gt.create(n, s + 1, s + 1 + i.content.size), 'pointer');
          else {
            if (!Yt.isSelectable(i)) continue;
            gr(t, Yt.create(n, s), 'pointer');
          }
          return !0;
        }
      })(t, n)
  ...
  (lr.keydown = function (t, e) {
    if (((t.shiftKey = 16 == e.keyCode || e.shiftKey), !xr(t, e)))
      if (
        (t.domObserver.forceFlush(),
        (t.lastKeyCode = e.keyCode),
        (t.lastKeyCodeTime = Date.now()),
        !ve.ios || 13 != e.keyCode || e.ctrlKey || e.altKey || e.metaKey)
      )
        ...
        (function (t, e) {
          ...
          return 8 == n || (ve.mac && 72 == n && 'c' == r)
            ? Wn(t, -1) || $n(t)
            : 46 == n || (ve.mac && 68 == n && 'c' == r)
            ? Wn(t, 1) || jn(t)
            : 13 == n ||
              27 == n ||
              (37 == n
          ...
          (t.lastIOSEnterFallbackTimeout = setTimeout(function () {
            t.lastIOSEnter == n &&
              (t.someProp('handleKeyDown', function (e) {
                return e(t, Re(13, 'Enter'));
              }),
              (t.lastIOSEnter = 0));
          }, 200));
      }
  }),
    (lr.keyup = function (t, e) {
      16 == e.keyCode && (t.shiftKey = !1);
    }),
    (lr.keypress = function (t, e) {
      if (
        !(
          xr(t, e) ||
          !e.charCode ||
        ...
        if (
          ...
          var n = t.state.selection;
          if (!(n instanceof Gt && n.$from.sameParent(n.$to))) {
  ...
  var kr = ve.mac ? 'metaKey' : 'ctrlKey';
  pr.mousedown = function (t, e) {
    ...
    i &&
      ('singleClick' == o
        ? (t.mouseDown && t.mouseDown.done(),
          (t.mouseDown = new Sr(t, i, e, n)))
        : ('doubleClick' == o ? yr : wr)(t, i.pos, i.inside, e)
        ? e.preventDefault()
        : fr(t, 'pointer'));
  };
  var Sr = function (t, e, n, r) {
    ...
    (this.target = h ? h.dom : null),
      ((o.type.spec.draggable && !1 !== o.type.spec.selectable) ||
        (t.state.selection instanceof Yt && i == t.state.selection.from)) &&
        (this.mightDrag = {
          node: o,
          pos: i,
  ...
  function xr(t, e) {
    return (
      !!t.composing ||
      (!!(ve.safari && Math.abs(e.timeStamp - t.compositionEndedAt) < 500) &&
        ((t.compositionEndedAt = -2e8), !0))
    );
  }
  (Sr.prototype.done = function () {
    ...
    (Sr.prototype.up = function (t) {
      if (
        ...
        this.view.state.doc != this.startDoc &&
          ...
          this.allowDefault || !e
            ? fr(this.view, 'pointer')
            : (function (t, e, n, r, o) {
                return (
                  vr(t, 'handleClickOn', e, n, r) ||
                  ...
                  (o
                    ? (function (t, e) {
                        ...
                        return (
                          null != r &&
                          (gr(t, Yt.create(t.state.doc, r), 'pointer'), !0)
                        );
                      })(t, n)
                    : (function (t, e) {
                        if (-1 == e) return !1;
                        var n = t.state.doc.resolve(e),
                          r = n.nodeAfter;
                        return (
                          !!(r && r.isAtom && Yt.isSelectable(r)) &&
                          (gr(t, new Yt(n), 'pointer'), !0)
                        );
                      })(t, n))
                );
            ...
            ? t.preventDefault()
            : this.flushed ||
              (ve.safari && this.mightDrag && !this.mightDrag.node.isAtom) ||
              (ve.chrome &&
                !(this.view.state.selection instanceof Gt) &&
                Math.min(
            ...
            ? (gr(
                this.view,
                Kt.near(this.view.state.doc.resolve(e.pos)),
                'pointer',
              ),
              t.preventDefault())
            : fr(this.view, 'pointer');
    ...
    (pr.touchdown = function (t) {
      br(t), fr(t, 'pointer');
    }),
    (pr.contextmenu = function (t) {
      return br(t);
    });
  var Or = ve.android ? 5e3 : -1;
  function Mr(t, e) {
  ...
  function Nr(t, e) {
    if ((t.domObserver.forceFlush(), Cr(t), e || t.docView.dirty)) {
      var n = On(t);
      return (
  ...
  (lr.compositionstart = lr.compositionupdate = function (t) {
    if (!t.composing) {
      t.domObserver.flush();
      var e = t.state,
        n = e.selection.$from;
    ...
    (lr.compositionend = function (t, e) {
      t.composing &&
        ((t.composing = !1), (t.compositionEndedAt = e.timeStamp), Mr(t, 20));
    });
  var Dr = (ve.ie && ve.ie_version < 15) || (ve.ios && ve.webkit_version < 604);
  function Tr(t, e, n, r) {
    var o = Yn(t, e, n, t.shiftKey, t.state.selection.$from);
    if (
  ...
  (pr.copy = lr.cut = function (t, e) {
    var n = t.state.selection,
      r = 'cut' == e.type;
    if (!n.empty) {
      var o = Dr ? null : e.clipboardData,
        i = Xn(t, n.content()),
        s = i.dom,
        a = i.text;
      o
    ...
    (lr.paste = function (t, e) {
      var n = Dr ? null : e.clipboardData;
      n && Tr(t, n.getData('text/plain'), n.getData('text/html'), e)
        ? e.preventDefault()
        : (function (t, e) {
            if (t.dom.parentNode) {
              var n =
              ...
              n || (r.contentEditable = 'true'),
                ...
                setTimeout(function () {
                  t.focus(),
                    ...
                    n
                      ? Tr(t, r.value, null, e)
                      : Tr(t, r.textContent, r.innerHTML, e);
                }, 50);
            }
          })(t, e);
    });
  var Er = function (t, e) {
    ...
    Ar = ve.mac ? 'altKey' : 'ctrlKey';
  for (var Rr in ((pr.dragstart = function (t, e) {
    var n = t.mouseDown;
    if ((n && n.done(), e.dataTransfer)) {
      var r = t.state.selection,
        o = r.empty ? null : t.posAtCoords(mr(e));
      if (o && o.pos >= r.from && o.pos <= (r instanceof Yt ? r.to - 1 : r.to));
      else if (n && n.mightDrag)
        t.dispatch(
          t.state.tr.setSelection(Yt.create(t.state.doc, n.mightDrag.pos)),
        );
        ...
        t.dispatch(
          t.state.tr.setSelection(Yt.create(t.state.doc, i.posBefore)),
        );
      }
      ...
      e.dataTransfer.clearData(),
        e.dataTransfer.setData(Dr ? 'Text' : 'text/html', c.innerHTML),
        (e.dataTransfer.effectAllowed = 'copyMove'),
        Dr || e.dataTransfer.setData('text/plain', h),
        (t.dragging = new Er(s, !e[Ar]));
    }
  }),
  (pr.dragend = function (t) {
    var e = t.dragging;
    window.setTimeout(function () {
      t.dragging == e && (t.dragging = null);
    }, 50);
  }),
  (lr.dragover = lr.dragenter = function (t, e) {
    return e.preventDefault();
  }),
  (lr.drop = function (t, e) {
    var n = t.dragging;
      ...
      if (r) {
        ...
        if (o) {
          ...
          i
            ...
            : (i = Yn(
                t,
                e.dataTransfer.getData(Dr ? 'Text' : 'text/plain'),
                Dr ? null : e.dataTransfer.getData('text/html'),
                !1,
                o,
              ));
          var s = n && !e[Ar];
          if (
            ...
            if (
              ...
              if (
                p &&
                Yt.isSelectable(i.content.firstChild) &&
                u.nodeAfter &&
                u.nodeAfter.sameMarkup(i.content.firstChild)
              )
                c.setSelection(new Yt(u));
              else {
                ...
                c.mapping.maps[c.mapping.maps.length - 1].forEach(function (
                  ...
                  c.setSelection(zn(t, u, c.doc.resolve(d)));
              }
  ...
  (pr.beforeinput = function (t, e) {
    if (ve.chrome && ve.android && 'deleteContentBackward' == e.inputType) {
  ...
  var Pr = function (t, e) {
    (this.spec = e || $r), (this.side = this.spec.side || 0), (this.toDOM = t);
  };
  (Pr.prototype.map = function (t, e, n, r) {
    var o = t.mapResult(e.from + r, this.side < 0 ? -1 : 1),
      i = o.pos;
    return o.deleted ? null : new Fr(i - n, i - n, this);
  }),
    (Pr.prototype.valid = function () {
      return !0;
    }),
      ...
      return (
        ...
        (t instanceof Pr &&
          ((this.spec.key && this.spec.key == t.spec.key) ||
            (this.toDOM == t.toDOM && zr(this.spec, t.spec))))
      );
    });
  var Ir = function (t, e) {
    (this.spec = e || $r), (this.attrs = t);
  };
  (Ir.prototype.map = function (t, e, n, r) {
    var o = t.map(e.from + r, this.spec.inclusiveStart ? -1 : 1) - n,
      i = t.map(e.to + r, this.spec.inclusiveEnd ? 1 : -1) - n;
    return o >= i ? null : new Fr(o, i, this);
  }),
    (Ir.prototype.valid = function (t, e) {
      return e.from < e.to;
    }),
    (Ir.prototype.eq = function (t) {
      return (
        this == t ||
        (t instanceof Ir && zr(this.attrs, t.attrs) && zr(this.spec, t.spec))
      );
    }),
    (Ir.is = function (t) {
      return t.type instanceof Ir;
    });
  var Br = function (t, e) {
    (this.spec = e || $r), (this.attrs = t);
  };
  (Br.prototype.map = function (t, e, n, r) {
    var o = t.mapResult(e.from + r, 1);
    if (o.deleted) return null;
    var i = t.mapResult(e.to + r, -1);
    return i.deleted || i.pos <= o.pos
      ? null
      : new Fr(o.pos - n, i.pos - n, this);
  }),
    (Br.prototype.valid = function (t, e) {
    ...
    (Br.prototype.eq = function (t) {
      return (
        this == t ||
        (t instanceof Br && zr(this.attrs, t.attrs) && zr(this.spec, t.spec))
      );
    });
  var Fr = function (t, e, n) {
      (this.from = t), (this.to = e), (this.type = n);
    },
    Vr = { spec: { configurable: !0 }, inline: { configurable: !0 } };
  (Fr.prototype.copy = function (t, e) {
    return new Fr(t, e, this.type);
  }),
    (Fr.prototype.eq = function (t, e) {
      return (
        void 0 === e && (e = 0),
        this.type.eq(t.type) && this.from + e == t.from && this.to + e == t.to
      );
    }),
    (Fr.prototype.map = function (t, e, n) {
      return this.type.map(t, this, e, n);
    }),
    (Fr.widget = function (t, e, n) {
      return new Fr(t, t, new Pr(e, n));
    }),
    (Fr.inline = function (t, e, n, r) {
      return new Fr(t, e, new Ir(n, r));
    }),
    (Fr.node = function (t, e, n, r) {
      return new Fr(t, e, new Br(n, r));
    }),
    (Vr.spec.get = function () {
      return this.type.spec;
    }),
    (Vr.inline.get = function () {
  ...
  var _r = [],
    $r = {},
    jr = function (t, e) {
      (this.local = t && t.length ? t : _r),
        (this.children = e && e.length ? e : _r);
    };
  (jr.create = function (t, e) {
    return e.length ? Hr(e, t, 0, $r) : Lr;
  }),
    (jr.prototype.find = function (t, e, n) {
      var r = [];
      return this.findInner(null == t ? 0 : t, null == e ? 1e9 : e, r, 0, n), r;
    }),
    (jr.prototype.findInner = function (t, e, n, r, o) {
    ...
    (jr.prototype.map = function (t, e, n) {
      return this == Lr || 0 == t.maps.length
        ? this
        : this.mapInner(t, e, 0, 0, n || $r);
    }),
    (jr.prototype.mapInner = function (t, e, n, r, o) {
      ...
      return this.children.length
        ? (function (t, e, n, r, o, i, s) {
            ...
            return new jr(e && e.sort(Ur), a);
          })(this.children, i, t, e, n, r, o)
        : i
        ? new jr(i.sort(Ur))
        : Lr;
    }),
    (jr.prototype.add = function (t, e) {
      return e.length
        ? this == Lr
          ? jr.create(t, e)
          : this.addInner(t, e, 0)
    ...
    (jr.prototype.addInner = function (t, e, n) {
      var r,
        o = this,
        i = 0;
      t.forEach(function (t, s) {
        ...
        if ((a = Wr(e, t, c))) {
          ...
          r[i] == s
            ...
            : r.splice(i, 0, s, s + t.nodeSize, Hr(a, t, c + 1, $r)),
            (i += 3);
        }
      });
      for (var s = qr(i ? Kr(e) : e, -n), a = 0; a < s.length; a++)
        s[a].type.valid(t, s[a]) || s.splice(a--, 1);
      return new jr(
        s.length ? this.local.concat(s).sort(Ur) : this.local,
        r || this.children,
      );
    }),
    (jr.prototype.remove = function (t) {
      return 0 == t.length || this == Lr ? this : this.removeInner(t, 0);
    }),
    (jr.prototype.removeInner = function (t, e) {
    ...
    (jr.prototype.forChild = function (t, e) {
      if (this == Lr) return this;
      if (e.isLeaf) return jr.empty;
      ...
      for (
        ...
        var c = this.local[a];
        if (c.from < s && c.to > i && c.type instanceof Ir) {
      ...
      if (r) {
        var l = new jr(r.sort(Ur));
        return n ? new Jr([l, n]) : l;
      }
      return n || Lr;
    }),
    ...
    (jr.prototype.locals = function (t) {
      return Gr(this.localsInner(t));
    }),
    (jr.prototype.localsInner = function (t) {
      if (this == Lr) return _r;
      if (t.inlineContent || !this.local.some(Ir.is)) return this.local;
      for (var e = [], n = 0; n < this.local.length; n++)
        this.local[n].type instanceof Ir || e.push(this.local[n]);
      return e;
    });
  var Lr = new jr();
  (jr.empty = Lr), (jr.removeOverlap = Gr);
  var Jr = function (t) {
    this.members = t;
  };
  function qr(t, e) {
    ...
    for (var n = [], r = 0; r < t.length; r++) {
      var o = t[r];
      n.push(new Fr(o.from + e, o.to + e, o.type));
    }
    return n;
  }
  function Wr(t, e, n) {
  ...
  function Hr(t, e, n, r) {
    ...
    e.forEach(function (e, s) {
      ...
      if (a) {
        i = !0;
        var c = Hr(a, e, n + s + 1, r);
        c != Lr && o.push(s, s + e.nodeSize, c);
      }
    });
    for (var s = qr(i ? Kr(t) : t, -n).sort(Ur), a = 0; a < s.length; a++)
      s[a].type.valid(e, s[a]) ||
        (r.onRemove && r.onRemove(s[a].spec), s.splice(a--, 1));
    return s.length || o.length ? new jr(s, o) : Lr;
  }
  function Ur(t, e) {
        ...
        for (var o = n + 1; o < e.length; o++) {
          ...
          if (i.from != r.from) {
            i.from < r.to &&
              ...
              Xr(e, o, r.copy(i.from, r.to)));
            break;
          }
          i.to != r.to &&
            (e == t && (e = t.slice()),
            (e[o] = i.copy(i.from, r.to)),
            Xr(e, o + 1, i.copy(r.to, i.to)));
        }
    }
    return e;
  }
  function Xr(t, e, n) {
    for (; e < t.length && Ur(n, t[e]) > 0; ) e++;
    t.splice(e, 0, n);
  }
  function Yr(t) {
    var e = [];
    return (
      ...
      t.cursorWrapper && e.push(jr.create(t.state.doc, [t.cursorWrapper.deco])),
      Jr.from(e)
    );
  }
  (Jr.prototype.forChild = function (t, e) {
    ...
    for (var n = [], r = 0; r < this.members.length; r++) {
      ...
      o != Lr && (o instanceof Jr ? (n = n.concat(o.members)) : n.push(o));
    }
    return Jr.from(n);
  }),
    (Jr.prototype.eq = function (t) {
      if (!(t instanceof Jr) || t.members.length != this.members.length)
        return !1;
  ...
  var Qr = function (t, e) {
      (this._props = e),
        ...
        (this.editable = no(this)),
        (this.markCursor = null),
        (this.cursorWrapper = null),
        eo(this),
        (this.nodeViews = ro(this)),
        (this.docView = cn(this.state.doc, to(this), Yr(this), this.dom, this)),
        ...
        (function (t) {
          (t.shiftKey = !1),
            ...
            (t.domObserver = new cr(t, function (e, n, r, i) {
                ...
                if (e < 0) {
                  ...
                  if (!w) {
                    if (
                      ...
                      if (
                        ((ve.ios && t.lastIOSEnter > Date.now() - 225) ||
                          ve.android) &&
                        i.some(function (t) {
                  ...
                  if (
                    ((ve.ios &&
                      ...
                      (!O &&
                        ...
                        (k = Kt.findFrom(f.doc.resolve(S.pos + 1), 1, !0)) &&
                        k.head == x.pos)) &&
                    t.someProp('handleKeyDown', function (e) {
                      return e(t, Re(13, 'Enter'));
                    })
    ...
    Zr = { props: { configurable: !0 }, root: { configurable: !0 } };
  function to(t) {
    var e = Object.create(null);
    return (
      (e.class = 'ProseMirror'),
      ...
      [Fr.node(0, t.state.doc.content.size, e)]
    );
  }
  function eo(t) {
    if (t.markCursor) {
      ...
      e.setAttribute('mark-placeholder', 'true'),
        (t.cursorWrapper = {
          dom: e,
          deco: Fr.widget(t.state.selection.head, e, {
            raw: !0,
            marks: t.markCursor,
          }),
        });
  ...
  (Zr.props.get = function () {
    ...
    (Qr.prototype.update = function (t) {
      t.handleDOMEvents != this._props.handleDOMEvents && ur(this),
        (this._props = t),
        this.updateStateInner(t.state, !0);
    }),
    (Qr.prototype.setProps = function (t) {
      var e = {};
      for (var n in this._props) e[n] = this._props[n];
      for (var r in ((e.state = this.state), t)) e[r] = t[r];
      this.update(e);
    }),
    (Qr.prototype.updateState = function (t) {
      this.updateStateInner(t, this.state.plugins != t.plugins);
    }),
    (Qr.prototype.updateStateInner = function (t, e) {
      var n = this,
        r = this.state,
        o = !1,
        i = !1;
      if (
        (t.storedMarks && this.composing && (Cr(this), (i = !0)),
        (this.state = t),
        e)
      ) {
        var s = ro(this);
      ...
      var l,
        ...
        k =
          ...
          (function (t) {
            ...
            return { refDOM: e, refTop: n, stack: Fe(t.dom) };
          })(this);
      if (i) {
        ...
        if (p) {
          ...
          (!o && this.docView.update(t.doc, c, a, this)) ||
            ...
            (this.docView = cn(t.doc, c, a, this.dom, this))),
        ...
        !(
          ...
          Ce(w.node, w.offset, b.anchorNode, b.anchorOffset))
        )
          ? Cn(this, S)
          : (An(this, t.selection), this.domObserver.setCurSelection()),
      ...
      if ((this.updatePluginViews(r), 'reset' == h)) this.dom.scrollTop = 0;
        ...
        this.someProp('handleScrollToSelection', function (t) {
          ...
          (t.selection instanceof Yt
            ...
            : Be(this, this.coordsAtPos(t.selection.head, 1), O));
      } else
        k &&
          ((m = (d = k).refDOM),
          (v = d.refTop),
    ...
    (Qr.prototype.destroyPluginViews = function () {
      for (var t; (t = this.pluginViews.pop()); ) t.destroy && t.destroy();
    }),
    (Qr.prototype.updatePluginViews = function (t) {
    ...
    (Qr.prototype.someProp = function (t, e) {
      var n,
    ...
    (Qr.prototype.hasFocus = function () {
      return this.root.activeElement == this.dom;
    }),
    (Qr.prototype.focus = function () {
      this.domObserver.stop(),
        this.editable &&
          (function (t) {
            if (t.setActive) return t.setActive();
            if (_e) return t.focus(_e);
            var e = Fe(t);
            t.focus(
              null == _e
                ? {
    ...
    (Qr.prototype.posAtCoords = function (t) {
      return Je(this, t);
    }),
    (Qr.prototype.coordsAtPos = function (t, e) {
      return void 0 === e && (e = 1), Ke(this, t, e);
    }),
    (Qr.prototype.domAtPos = function (t, e) {
      return void 0 === e && (e = 0), this.docView.domFromPos(t, e);
    }),
    (Qr.prototype.nodeDOM = function (t) {
      var e = this.docView.descAt(t);
      return e ? e.nodeDOM : null;
    }),
    (Qr.prototype.posAtDOM = function (t, e, n) {
      void 0 === n && (n = -1);
      var r = this.docView.posFromDOM(t, e, n);
      if (null == r) throw new RangeError('DOM position not inside the editor');
      return r;
    }),
    (Qr.prototype.endOfTextblock = function (t, e) {
              ...
              'up' == n || 'down' == n
                ? (function (t, e, n) {
                    ...
                    return Ge(t, e, function () {
                      ...
                      for (
                        var i = Ke(t, o.pos, 1), s = e.firstChild;
                        s;
                        s = s.nextSibling
                      ) {
                        var a = void 0;
                        if (1 == s.nodeType) a = s.getClientRects();
                          ...
                          a = Me(s, 0, s.nodeValue.length).getClientRects();
                        }
                ...
                : (function (t, e, n) {
                    ...
                    var o = r.parentOffset,
                      ...
                      a = getSelection();
                    return Xe.test(r.parent.textContent) && a.modify
                      ? Ge(t, e, function () {
    ...
    (Qr.prototype.destroy = function () {
      this.docView &&
        ...
        this.destroyPluginViews(),
        this.mounted
          ? (this.docView.update(this.state.doc, [], Yr(this), this),
            (this.dom.textContent = ''))
          : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom),
        this.docView.destroy(),
        (this.docView = null));
    }),
    (Qr.prototype.dispatchEvent = function (t) {
      return (function (t, e) {
        dr(t, e) ||
          !pr[e.type] ||
          (!t.editable && e.type in lr) ||
  ...
  var oo = ['p', 0],
    ...
    uo = function (t, e, n) {
      (this.step = t), (this.inverted = e), (this.origin = n);
    },
    mo = function (t, e) {
      (this.version = t), (this.unconfirmed = e);
    },
    vo = new me('collab');
  const go = rt.fromSchema(fo).parse(document.querySelector('#content'));
  !(function (t, e) {
    let n = new Qr(e, {
      state: ce.create({
        doc: t.doc,
        plugins: [
          ((r = { version: t.steps.length }),
          void 0 === r && (r = {}),
          (r = {
            version: r.version || 0,
            clientID:
              ...
              apply: function (t, e) {
                return (
                  ...
                  (t.docChanged
                    ? new mo(
                        e.version,
                        e.unconfirmed.concat(
                          (function (t) {
                            for (var e = [], n = 0; n < t.steps.length; n++)
                              e.push(
                                new uo(
                                  t.steps[n],
                                  t.steps[n].invert(t.docs[n]),
                                  t,
                                ),
                              );
                            return e;
      ...
      dispatchTransaction(e) {
        let r = n.state.apply(e);
        n.updateState(r);
        let o =
          ((i = r),
          0 == (s = vo.getState(i)).unconfirmed.length
            ? null
            : {
                version: s.version,
                steps: s.unconfirmed.map(function (t) {
                  return t.step;
                }),
                clientID: vo.get(i).spec.config.clientID,
                get origins() {
                  return (
                    this._origins ||
                    (this._origins = s.unconfirmed.map(function (t) {
                      return t.origin;
                    }))
                  );
                },
        ...
        var i, s;
        o && t.receiveSteps(o.version, o.steps, o.clientID);
      },
    });
    var r;
    t.onNewSteps.push(function () {
      let e = t.stepsSince(((r = n.state), vo.getState(r).version));
      var r;
      n.dispatch(
        (function (t, e, n, r) {
          for (
            var o = vo.getState(t),
              ...
              s = vo.get(t).spec.config.clientID,
              a = 0;
            a < n.length && n[a] == s;

          )
            ++a;
          var c = o.unconfirmed.slice(a);
          if (!(e = a ? e.slice(a) : e).length)
            return t.tr.setMeta(vo, new mo(i, c));
          var h = c.length,
            p = t.tr;
          if (h)
            c = (function (t, e, n) {
              for (var r = t.length - 1; r >= 0; r--) n.step(t[r].inverted);
              for (var o = 0; o < e.length; o++) n.step(e[o]);
              for (var i = [], s = 0, a = t.length; s < t.length; s++) {
                var c = t[s].step.map(n.mapping.slice(a));
                a--,
                  c &&
                    !n.maybeStep(c).failed &&
                    (n.mapping.setMirror(a, n.steps.length - 1),
                    i.push(
                      new uo(
                        c,
                        c.invert(n.docs[n.docs.length - 1]),
                        t[s].origin,
                      ),
                    ));
              }
            ...
            for (var l = 0; l < e.length; l++) p.step(e[l]);
            c = [];
          }
          var f = new mo(i, c);
          return (
            r &&
              ...
              t.selection instanceof Gt &&
              (p.setSelection(
                Gt.between(
                  p.doc.resolve(p.mapping.map(t.selection.anchor, -1)),
                  p.doc.resolve(p.mapping.map(t.selection.head, -1)),
                  -1,
                ),
              ),
              (p.updated &= -2)),
            p.setMeta('rebased', h).setMeta('addToHistory', !1).setMeta(vo, f)
          );
        })(n.state, e.steps, e.clientIDs),
      );
    });
  })(
    new (class {
      ...
      receiveSteps(t, e, n) {
        t === this.steps.length &&
          (e.forEach((t) => {
            (this.doc = t.apply(this.doc).doc),
              this.steps.push(t),
              this.stepClientIDs.push(n);
          }),
          this.onNewSteps.forEach(function (t) {
            t();
          }));
      }
      stepsSince(t) {
        return {
          steps: this.steps.slice(t),
          clientIDs: this.stepClientIDs.slice(t),
        };
      }
    })(go),
