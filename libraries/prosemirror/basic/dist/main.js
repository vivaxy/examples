(() => {
    ...
    for (var i = t.childCount, s = e.childCount; ; ) {
      ...
      if (a != c) {
        ...
        if (a.isText && a.text != c.text) {
          for (
            var p = 0, h = Math.min(a.text.length, c.text.length);
            p < h &&
  ...
  function v(t, e, n, r) {
    ...
    if (n.content.size) {
      if (n.openStart || n.openEnd || t.depth != r || e.depth != r) {
        ...
        return k(s, x(t, c.start, c.end, e, r));
      }
      var l = t.parent,
        p = l.content;
      return k(
  ...
  function S(t, e, n) {
    ...
    return (
      b(null, t, n, r),
      t.depth > n && w(k(y(t, e, n + 1), S(t, e, n + 1)), r),
      b(e, null, n, r),
      new o(r)
    );
  }
  (f.size.get = function () {
    ...
    (h.fromJSON = function (t, e) {
      ...
      return new h(o.fromJSON(t, e.content), n, r);
    }),
  ...
  (M.prototype.resolveDepth = function (t) {
    ...
    (C.textOffset.get = function () {
      return this.pos - this.path[this.path.length - 1];
    }),
    (C.nodeAfter.get = function () {
      var t = this.parent,
    ...
    (M.prototype.posAtIndex = function (t, e) {
    ...
    (M.prototype.marksAcross = function (t) {
    ...
    (M.prototype.sharedDepth = function (t) {
      for (var e = this.depth; e > 0; e--)
        if (this.start(e) <= t && this.end(e) >= t) return e;
      return 0;
    }),
    (M.prototype.blockRange = function (t, e) {
    ...
    (M.prototype.sameParent = function (t) {
    ...
    (M.resolveCached = function (t, e) {
      for (var n = 0; n < O.length; n++) {
        var r = O[n];
        if (r.pos == e && r.doc == t) return r;
      }
      var o = (O[N] = M.resolve(t, e));
      return (N = (N + 1) % T), o;
    }),
  ...
  (R.nodeSize.get = function () {
    ...
    (I.prototype.nodesBetween = function (t, e, n, r) {
    ...
    (I.prototype.slice = function (t, e, n) {
      if (
    ...
    (I.prototype.childAfter = function (t) {
      var e = this.content.findIndex(t),
        n = e.index,
        r = e.offset;
      return { node: this.content.maybeChild(n), index: n, offset: r };
    }),
    (I.prototype.childBefore = function (t) {
    ...
    (I.prototype.resolve = function (t) {
      return M.resolveCached(this, t);
    }),
    (I.prototype.resolveNoCache = function (t) {
      return M.resolve(this, t);
    }),
    (I.prototype.rangeHasMark = function (t, e, n) {
      var r = !1;
      return (
        e > t &&
    ...
    (R.isBlock.get = function () {
      return this.type.isBlock;
    }),
    (R.isTextblock.get = function () {
      return this.type.isTextblock;
    }),
    (R.inlineContent.get = function () {
      return this.type.inlineContent;
    }),
    (R.isInline.get = function () {
      return this.type.isInline;
    }),
    (R.isText.get = function () {
      return this.type.isText;
    }),
    (R.isLeaf.get = function () {
      return this.type.isLeaf;
    }),
    (R.isAtom.get = function () {
    ...
    (I.prototype.contentMatchAt = function (t) {
      var e = this.type.contentMatch.matchFragment(this.content, 0, t);
      if (!e)
        throw new Error('Called contentMatchAt on a node with invalid content');
      return e;
    }),
    (I.prototype.canReplace = function (t, e, n, r, i) {
      void 0 === n && (n = o.empty),
        void 0 === r && (r = 0),
    ...
    return (
      (e.prototype.toString = function () {
        return this.type.spec.toDebugString
          ...
          : P(this.marks, JSON.stringify(this.text));
      }),
  ...
  (B.parse = function (t, e) {
            ...
            o(
              (function t(e, i) {
                ...
                if ('seq' == e.type)
                  ...
                  if ('plus' == e.type) {
                    var l = n();
                    return o(t(e.expr, i), l), o(t(e.expr, l), l), [r(l)];
                  }
                  if ('opt' == e.type) return [r(i)].concat(t(e.expr, i));
                  if ('range' == e.type) {
                    for (var p = i, h = 0; h < e.min; h++) {
                      var f = n();
                      o(t(e.expr, p), f), (p = f);
                    }
    ...
    (V.inlineContent.get = function () {
      var t = this.next[0];
      return !!t && t.isInline;
    }),
    (V.defaultType.get = function () {
    ...
    (B.prototype.fillBefore = function (t, e, n) {
      ...
      return (function i(s, a) {
        ...
        for (var l = 0; l < s.next.length; l += 2) {
          var p = s.next[l],
            h = s.next[l + 1];
          if (!p.isText && !p.hasRequiredAttrs() && -1 == r.indexOf(h)) {
            r.push(h);
            var f = i(h, a.concat(p));
            if (f) return f;
          }
        }
      })(this, []);
  ...
  (q.next.get = function () {
    ...
    ($.prototype.eat = function (t) {
      return this.next == t && (this.pos++ || !0);
    }),
    ($.prototype.err = function (t) {
      throw new SyntaxError(
        t + " (in content expression '" + this.string + "')",
      );
    }),
    Object.defineProperties($.prototype, q);
  ...
  (Y.isInline.get = function () {
    ...
    (X.prototype.create = function (t, e, n) {
      ...
      return new I(this, this.computeAttrs(t), o.from(e), l.setFrom(n));
    }),
    (X.prototype.createChecked = function (t, e, n) {
      if (((e = o.from(e)), !this.validContent(e)))
        throw new RangeError('Invalid content for node ' + this.name);
      return new I(this, this.computeAttrs(t), e, l.setFrom(n));
    }),
    (X.prototype.createAndFill = function (t, e, n) {
      ...
      return i ? new I(this, t, e.append(i), l.setFrom(n)) : null;
    }),
  ...
  var et = function (t) {
    ...
    for (var c in this.marks) {
      var l = this.marks[c],
        p = l.spec.excludes;
      l.excluded = null == p ? [l] : '' == p ? [] : nt(this, p.split(' '));
    }
  ...
  (et.prototype.node = function (t, e, n, r) {
    ...
    (et.prototype.text = function (t, e) {
      ...
      return new z(n, n.defaultAttrs, t, l.setFrom(e));
    }),
  ...
  (pt.top.get = function () {
    ...
    (lt.prototype.addDOM = function (t) {
    ...
    (lt.prototype.addTextNode = function (t) {
      var e = t.nodeValue,
        n = this.top;
      if (
        (n.type
    ...
    (lt.prototype.addElement = function (t, e) {
      var n,
      ...
      if (o ? o.ignore : it.hasOwnProperty(r)) this.findInside(t);
    ...
    (lt.prototype.leafFallback = function (t) {
      'BR' == t.nodeName &&
        this.top.type &&
        this.top.type.inlineContent &&
        this.addTextNode(t.ownerDocument.createTextNode('\n'));
    }),
    (lt.prototype.readStyles = function (t) {
      var e = l.none;
    ...
    (lt.prototype.addElementByRule = function (t, e, n) {
      var r,
        o,
        i,
        s = this;
    ...
    (lt.prototype.addAll = function (t, e, n, r) {
      for (
        var o = n || 0,
    ...
    (lt.prototype.findPlace = function (t) {
    ...
    (lt.prototype.insertNode = function (t) {
    ...
    (lt.prototype.enter = function (t, e, n) {
      var r = this.findPlace(t.create(e));
      return r && this.enterInner(t, e, !0, n), r;
    }),
    (lt.prototype.enterInner = function (t, e, n, r) {
      this.closeExtra();
      var o = this.top;
    ...
    (lt.prototype.closeExtra = function (t) {
    ...
    (lt.prototype.findAtPoint = function (t, e) {
      if (this.find)
    ...
    (lt.prototype.findInside = function (t) {
      if (this.find)
    ...
    (lt.prototype.findAround = function (t, e, n) {
      if (t != e && this.find)
    ...
    (lt.prototype.findInText = function (t) {
      if (this.find)
        for (var e = 0; e < this.find.length; e++)
          this.find[e].node == t &&
            (this.find[e].pos =
    ...
    (lt.prototype.matchesContext = function (t) {
      var e = this;
      if (t.indexOf('|') > -1)
    ...
    (lt.prototype.textblockFromContext = function () {
    ...
    (lt.prototype.addPendingMark = function (t) {
      var e = (function (t, e) {
    ...
    (lt.prototype.removePendingMark = function (t, e) {
      ...
      t.forEach(function (t) {
        if (i || t.marks.length) {
          ...
          for (; s < t.marks.length; ) {
            ...
            l &&
              (i.push(c, o), o.appendChild(l.dom), (o = l.contentDOM || l.dom));
          }
        }
  ...
  (bt.prototype.recover = function (t) {
    var e = 0,
      n = yt(t);
    if (!this.inverted)
      for (var r = 0; r < n; r++)
    ...
    (bt.prototype.mapResult = function (t, e) {
      return void 0 === e && (e = 1), this._map(t, e, !1);
    }),
    (bt.prototype.map = function (t, e) {
      return void 0 === e && (e = 1), this._map(t, e, !0);
    }),
    (bt.prototype._map = function (t, e, n) {
      for (
        ...
        if (t <= p) {
          ...
          return n
            ...
            : new wt(
                h,
                e < 0 ? t != a : t != p,
                t == (e < 0 ? a : p) ? null : s / 3 + (t - a) * gt,
              );
        }
        r += l - c;
      }
      return n ? t + r : new wt(t + r);
    }),
    (bt.prototype.touches = function (t, e) {
      for (
        var n = 0,
          r = yt(e),
          o = this.inverted ? 2 : 1,
    ...
    (bt.prototype.invert = function () {
      return new bt(this.ranges, !this.inverted);
    }),
    (bt.prototype.toString = function () {
      return (this.inverted ? '-' : '') + JSON.stringify(this.ranges);
    }),
    (bt.offset = function (t) {
      return 0 == t ? bt.empty : new bt(t < 0 ? [0, -t, 0] : [0, 0, t]);
    }),
    (bt.empty = new bt([]));
  ...
  function xt(t) {
    var e = Error.call(this, t);
    return (e.__proto__ = xt.prototype), e;
  }
  (kt.prototype.slice = function (t, e) {
    return (
      void 0 === t && (t = 0),
      void 0 === e && (e = this.maps.length),
      new kt(this.maps, this.mirror, t, e)
    );
  }),
  ...
  var St = function (t) {
    ...
    Mt = { before: { configurable: !0 }, docChanged: { configurable: !0 } };
  function Ct() {
    throw new Error('Override me');
  }
  (Mt.before.get = function () {
    return this.docs.length ? this.docs[0] : this.doc;
  }),
    (St.prototype.step = function (t) {
      var e = this.maybeStep(t);
      if (e.failed) throw new xt(e.failed);
      return this;
    }),
    (St.prototype.maybeStep = function (t) {
      var e = t.apply(this.doc);
      return e.failed || this.addStep(t, e.doc), e;
    }),
    (Mt.docChanged.get = function () {
      return this.steps.length > 0;
    }),
    (St.prototype.addStep = function (t, e) {
  ...
  var Ot = Object.create(null),
    Nt = function () {};
  (Nt.prototype.apply = function (t) {
    return Ct();
  }),
    (Nt.prototype.getMap = function () {
      return bt.empty;
    }),
    (Nt.prototype.invert = function (t) {
      return Ct();
    }),
    ...
    (Nt.jsonID = function (t, e) {
      if (t in Ot) throw new RangeError('Duplicate use of step JSON ID ' + t);
      return (Ot[t] = e), (e.prototype.jsonID = t), e;
    });
  var Tt = function (t, e) {
    (this.doc = t), (this.failed = e);
  };
  (Tt.ok = function (t) {
    return new Tt(t, null);
  }),
    (Tt.fail = function (t) {
      return new Tt(null, t);
    }),
    (Tt.fromReplace = function (t, e, n, r) {
      try {
        return Tt.ok(t.replace(e, n, r));
      } catch (t) {
        if (t instanceof p) return Tt.fail(t.message);
        throw t;
      }
    });
  var Dt = (function (t) {
    ...
    return (
      ...
      (e.prototype.apply = function (t) {
        return this.structure && At(t, this.from, this.to)
          ? Tt.fail('Structure replace would overwrite content')
          : Tt.fromReplace(t, this.from, this.to, this.slice);
      }),
  ...
  var Et = (function (t) {
    ...
    return (
      ...
      (e.prototype.apply = function (t) {
        if (
          this.structure &&
          (At(t, this.from, this.gapFrom) || At(t, this.gapTo, this.to))
        )
          return Tt.fail('Structure gap-replace would overwrite content');
        var e = t.slice(this.gapFrom, this.gapTo);
        if (e.openStart || e.openEnd) return Tt.fail('Gap is not a flat range');
        var n = this.slice.insertAt(this.insert, e.content);
        return n
          ? Tt.fromReplace(t, this.from, this.to, n)
          : Tt.fail('Content does not fit in gap');
      }),
      (e.prototype.getMap = function () {
        return new bt([
          this.from,
  ...
  function zt(t, e, n, r) {
    ...
    return i ? o.map(Pt).concat({ type: e, attrs: n }).concat(i.map(Pt)) : null;
  }
  function Pt(t) {
  ...
  function Bt(t, e, n, r) {
    ...
    for (var a = o.depth - 1, c = n - 2; a > i; a--, c--) {
      ...
      var h = l.content.cutByIndex(p, l.childCount),
        f = (r && r[c]) || l;
      if (
        (f != l && (h = h.replaceChild(0, f.type.create(f.attrs))),
        !l.canReplace(p + 1, l.childCount) || !f.type.validContent(h))
      )
        return !1;
    }
    var u = o.indexAfter(i),
      d = r && r[0];
  ...
  function Ft(t, e, n) {
    ...
    for (var s = 1; s <= (0 == n.openStart && n.size ? 2 : 1); s++)
      for (var a = r.depth; a >= 0; a--) {
        ...
        if (
          1 == s
            ? r.node(a).canReplace(l, l, o)
            : r.node(a).contentMatchAt(l).findWrapping(o.firstChild.type)
        )
  ...
  function _t(t, e, n) {
    for (var r = [], i = 0; i < t.childCount; i++) {
      var s = t.child(i);
      s.content.size && (s = s.copy(_t(s.content, e, s))),
  ...
  Nt.jsonID('replaceAround', Et),
    (St.prototype.lift = function (t, e) {
      for (
        var n = t.$from,
          r = t.$to,
          i = t.depth,
      ...
      for (var m = o.empty, v = 0, g = i, y = !1; g > e; g--)
        y || r.after(g + 1) < r.end(g)
          ...
          : l++;
      return this.step(
        new Et(c, l, s, a, new h(p.append(m), f, v), p.size - f, !0),
      );
    }),
    (St.prototype.wrap = function (t, e) {
      for (var n = o.empty, r = e.length - 1; r >= 0; r--)
        n = o.from(e[r].type.create(e[r].attrs, n));
      var i = t.start,
        s = t.end;
      return this.step(new Et(i, s, i, s, new h(n, 0, 0), e.length, !0));
    }),
    (St.prototype.setBlockType = function (t, e, n, r) {
      var i = this;
            ...
            return (
              i.step(
                new Et(
                  ...
                  c + 1,
                  l - 1,
                  new h(o.from(n.create(r, null, t.marks)), 0, 0),
                  1,
                  !0,
                ),
              ),
    ...
    (St.prototype.setNodeMarkup = function (t, e, n, r) {
    ...
    (St.prototype.split = function (t, e, n) {
      void 0 === e && (e = 1);
      for (
      ...
      return this.step(new Dt(t, t, new h(i.append(s), e, e), !0));
    }),
    (St.prototype.join = function (t, e) {
      void 0 === e && (e = 1);
      var n = new Dt(t - e, t + e, h.empty, !0);
      return this.step(n);
    });
  var Lt = (function (t) {
    function e(e, n, r) {
    ...
    return (
      ...
      (e.prototype.apply = function (t) {
        ...
        return Tt.fromReplace(t, this.from, this.to, i);
      }),
    ...
    return (
      ...
      (e.prototype.apply = function (t) {
        var e = this,
          n = t.slice(this.from, this.to),
          r = new h(
            _t(n.content, function (t) {
              return t.mark(e.mark.removeFromSet(t.marks));
            }),
            n.openStart,
            n.openEnd,
          );
        return Tt.fromReplace(t, this.from, this.to, r);
      }),
      (e.prototype.invert = function () {
  ...
  Nt.jsonID('removeMark', jt),
    (St.prototype.addMark = function (t, e, n) {
      var r = this,
        o = [],
        i = [],
        s = null,
        a = null;
      return (
        this.doc.nodesBetween(t, e, function (r, c, l) {
          if (r.isInline) {
            var p = r.marks;
            if (!n.isInSet(p) && l.type.allowsMarkType(n.type)) {
              for (
                ...
                p[d].isInSet(u) ||
                  (s && s.to == h && s.mark.eq(p[d])
                    ? (s.to = f)
                    : o.push((s = new jt(h, f, p[d]))));
              a && a.to == h ? (a.to = f) : i.push((a = new Lt(h, f, n)));
            }
          }
        }),
    ...
    (St.prototype.removeMark = function (t, e, n) {
      var r = this;
      void 0 === n && (n = null);
      var o = [],
        i = 0;
      return (
        this.doc.nodesBetween(t, e, function (r, s) {
          if (r.isInline) {
            ...
            if (a && a.length)
              for (
                var p = Math.min(s + r.nodeSize, e), h = 0;
                h < a.length;
                h++
              ) {
                for (var f = a[h], u = void 0, d = 0; d < o.length; d++) {
                  var m = o[d];
    ...
    (St.prototype.clearIncompatible = function (t, e, n) {
        ...
        if (p) {
          ...
          for (var f = 0; f < c.marks.length; f++)
            e.allowsMarkType(c.marks[f].type) ||
              this.step(new jt(s, l, c.marks[f]));
        } else i.push(new Dt(s, l, h.empty));
        s = l;
      }
      if (!n.validEnd) {
        var u = n.fillBefore(o.empty, !0);
        this.replace(s, s, new h(u, 0, 0));
      }
      for (var d = i.length - 1; d >= 0; d--) this.step(i[d]);
      return this;
    }),
    (St.prototype.replace = function (t, e, n) {
      void 0 === e && (e = t), void 0 === n && (n = h.empty);
      var r = (function (t, e, n, r) {
        ...
        var o = t.resolve(e),
          i = t.resolve(n);
        return Jt(o, i, r) ? new Dt(e, n, r) : new Wt(o, i, r).fit();
      })(this.doc, t, e, n);
      return r && this.step(r), this;
    }),
    (St.prototype.replaceWith = function (t, e, n) {
      return this.replace(t, e, new h(o.from(n), 0, 0));
    }),
    (St.prototype.delete = function (t, e) {
      return this.replace(t, e, h.empty);
    }),
    (St.prototype.insert = function (t, e) {
  ...
  (Kt.depth.get = function () {
    ...
    (Wt.prototype.fit = function () {
      ...
      var c = new h(i, s, a);
      return e > -1
        ? new Et(r.pos, e, this.$to.pos, this.$to.end(), c, n)
        : c.size || r.pos != this.$to.pos
        ? new Dt(r.pos, o.pos, c)
        : void 0;
    }),
      ...
      for (var t = 1; t <= 2; t++)
        for (var e = this.unplaced.openStart; e >= 0; e--)
          for (
            ...
            if (2 == t && r && (l = c.findWrapping(r.type)))
    ...
    (Wt.prototype.dropNode = function () {
      ...
      if (o.childCount <= 1 && n > 0) {
        ...
        this.unplaced = new h(Ht(e, n - 1, 1), n - 1, i ? n - 1 : r);
      } else this.unplaced = new h(Ht(e, n, 1), n, r);
    }),
    (Wt.prototype.placeNodes = function (t) {
      ...
      this.unplaced = k
        ? 0 == e
          ? h.empty
          : new h(Ht(c.content, e - 1, 1), e - 1, y < 0 ? c.openEnd : e - 1)
        : new h(Ht(c.content, e, f), c.openStart, c.openEnd);
    }),
    ...
    (St.prototype.replaceRange = function (t, e, n) {
      if (!n.size) return this.deleteRange(t, e);
      var r = this.doc.resolve(t),
        o = this.doc.resolve(e);
      if (Jt(r, o, n)) return this.step(new Dt(t, e, n));
          ...
          for (var b = 0; b < i.length; b++) {
            ...
            if (S.canReplaceWith(M, M, w.type, w.marks))
              return this.replace(
                r.before(k),
                x ? o.after(k) : e,
                new h(Qt(n.content, 0, n.openStart, y), y, n.openEnd),
              );
          }
      }
      for (
        var C = this.steps.length, O = i.length - 1;
        O >= 0 && (this.replace(t, e, n), !(this.steps.length > C));
        O--
      ) {
        var N = i[O];
        O < 0 || ((t = r.before(N)), (e = o.after(N)));
      }
      return this;
    }),
    (St.prototype.replaceRangeWith = function (t, e, n) {
      ...
      return this.replaceRange(t, e, new h(o.from(n), 0, 0));
    }),
    (St.prototype.deleteRange = function (t, e) {
      for (
  ...
  (ne.anchor.get = function () {
    ...
    (ee.prototype.replace = function (t, e) {
      ...
      for (var i = t.steps.length, s = this.ranges, a = 0; a < s.length; a++) {
        var c = s[a],
          ...
          p = c.$to,
          f = t.mapping.slice(i);
        t.replaceRange(f.map(l.pos), f.map(p.pos), a ? h.empty : e),
          0 == a && he(t, i, (n ? n.isInline : r && r.isTextblock) ? -1 : 1);
      }
    }),
    (ee.prototype.replaceWith = function (t, e) {
      for (var n = t.steps.length, r = this.ranges, o = 0; o < r.length; o++) {
        ...
        o
          ? t.deleteRange(l, p)
          : (t.replaceRangeWith(l, p, e), he(t, n, e.isInline ? -1 : 1));
      }
    }),
  ...
  var se = (function (t) {
    ...
    return (
      ...
      (e.prototype.content = function () {
        return new h(o.from(this.node), 0, 0);
      }),
      (e.prototype.eq = function (t) {
  ...
  var ce = (function (t) {
    ...
    return (
      ...
      (e.prototype.constructor = e),
      (e.prototype.replace = function (e, n) {
        if ((void 0 === n && (n = h.empty), n == h.empty)) {
  ...
  function he(t, e, n) {
    ...
    if (!(r < e)) {
      var o,
        i = t.steps[r];
      (i instanceof Dt || i instanceof Et) &&
  ...
  var fe = (function (t) {
    ...
    return (
      ...
      (e.prototype.ensureMarks = function (t) {
        return (
          l.sameSet(this.storedMarks || this.selection.$from.marks(), t) ||
          ...
          !1 !== e &&
            (t = t.mark(
              this.storedMarks ||
                (n.empty
                  ? n.$from.marks()
                  : n.$from.marksAcross(n.$to) || l.none),
            )),
    ...
    (ge.fromJSON = function (t, e, n) {
      ...
      return (
        r.fields.forEach(function (r) {
          if ('doc' == r.name) o.doc = I.fromJSON(t.schema, e.doc);
  ...
  ke.prototype.getState = function (t) {
    return t[this.key];
  };
  var xe = Object.create(null);
  function Se(t) {
    return t in xe ? t + '$' + ++xe[t] : ((xe[t] = 0), t + '$');
  }
  var Me = function (t) {
  ...
  (Me.prototype.get = function (t) {
    ...
    (Me.prototype.getState = function (t) {
      return t[this.key];
    });
  var Ce = {};
  if ('undefined' != typeof navigator && 'undefined' != typeof document) {
    var Oe = /Edge\/(\d+)/.exec(navigator.userAgent),
      Ne = /MSIE \d/.test(navigator.userAgent),
      Te = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
    Ce.mac = /Mac/.test(navigator.platform);
    var De = (Ce.ie = !!(Ne || Te || Oe));
    (Ce.ie_version = Ne
      ...
      ? +Oe[1]
      : null),
      (Ce.gecko = !De && /gecko\/(\d+)/i.test(navigator.userAgent)),
      (Ce.gecko_version =
        Ce.gecko && +(/Firefox\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1]);
    var Ee = !De && /Chrome\/(\d+)/.exec(navigator.userAgent);
    (Ce.chrome = !!Ee),
      (Ce.chrome_version = Ee && +Ee[1]),
      (Ce.safari = !De && /Apple Computer/.test(navigator.vendor)),
      (Ce.ios =
        Ce.safari &&
        (/Mobile\/\w+/.test(navigator.userAgent) ||
          navigator.maxTouchPoints > 2)),
      (Ce.android = /Android \d/.test(navigator.userAgent)),
      (Ce.webkit = 'webkitFontSmoothing' in document.documentElement.style),
      (Ce.webkit_version =
        Ce.webkit &&
  ...
  var Ae = function (t) {
    ...
    Pe = function (t, e, n, r) {
      return n && (Ve(t, e, n, r, -1) || Ve(t, e, n, r, 1));
    },
  ...
  var Fe = function (t) {
    var e = t.isCollapsed;
    return (
      e && Ce.chrome && t.rangeCount && !t.getRangeAt(0).collapsed && (e = !1),
      e
    );
  };
  function _e(t, e) {
      ...
      if (1 == s.nodeType) {
        ...
        if (
          ...
          e.left < c.left + je(r, 'left')
            ? (l = -(c.left - e.left + je(o, 'left')))
            : e.right > c.right - je(r, 'right') &&
              (l = e.right - c.right + je(o, 'right')),
          l || p)
        )
          if (a) i.defaultView.scrollBy(l, p);
          else {
            var h = s.scrollLeft,
              f = s.scrollTop;
            p && (s.scrollTop += p), l && (s.scrollLeft += l);
            var u = s.scrollLeft - h,
              d = s.scrollTop - f;
            e = {
              left: e.left - u,
              top: e.top - d,
        ...
        if (f.top <= s && f.bottom >= a) {
          ...
          if (u < o) {
            (n = c),
              ...
              1 == c.nodeType &&
                u &&
                (i = l + (e.left >= (f.left + f.right) / 2 ? 1 : 0));
            continue;
          }
        }
        !n &&
  ...
  function Qe(t, e) {
    ...
    if (!p || !t.dom.contains(1 != p.nodeType ? p.parentNode : p)) {
      ...
      if (!Xe(e, h)) return null;
      if (!(p = Ye(t.dom, e, h))) return null;
    }
    if (
      (Ce.safari && p.draggable && (o = i = null),
      (p = (function (t, e) {
        var n = t.parentNode;
        return n &&
    ...
    return { pos: l, inside: d ? d.posAtStart - d.border : -1 };
  }
  function Ze(t, e) {
  ...
  function en(t, e, n) {
    var r = t.docView.domFromPos(e, n < 0 ? -1 : 1),
      o = r.node,
      i = r.offset,
      s = Ce.webkit || Ce.gecko;
    if (3 == o.nodeType) {
      if (
        !s ||
        (!tn.test(o.nodeValue) && (n < 0 ? i : i != o.nodeValue.length))
      ) {
        var a = i,
          c = i,
          l = n < 0 ? 1 : -1;
      ...
      if (
        ...
        var h = Ze(ze(o, i - 1, i - 1), -1);
        if (h.top == p.top) {
          var f = Ze(ze(o, i, i + 1), -1);
          if (f.top != p.top) return nn(f, f.left < h.left);
        }
      }
      return p;
    }
    if (!t.state.doc.resolve(e).parent.inlineContent) {
      if (i && (n < 0 || i == $e(o))) {
        ...
        if (1 == u.nodeType) return rn(u.getBoundingClientRect(), !1);
      }
      if (i < $e(o)) {
        var d = o.childNodes[i];
        if (1 == d.nodeType) return rn(d.getBoundingClientRect(), !0);
      }
      return rn(o.getBoundingClientRect(), n >= 0);
    }
    if (i && (n < 0 || i == $e(o))) {
      var m = o.childNodes[i - 1],
        v =
          3 == m.nodeType
            ...
            ? null
            : m;
      if (v) return nn(Ze(v, 1), !1);
    }
    if (i < $e(o)) {
      var g = o.childNodes[i],
        y = 3 == g.nodeType ? ze(g, 0, s ? 0 : 1) : 1 == g.nodeType ? g : null;
      if (y) return nn(Ze(y, -1), !0);
    }
    return nn(Ze(3 == o.nodeType ? ze(o) : o, -n), n >= 0);
  }
  function nn(t, e) {
  ...
  (pn.prototype.matchesWidget = function () {
    return !1;
  }),
    (pn.prototype.matchesMark = function () {
      return !1;
    }),
    (pn.prototype.matchesNode = function () {
      return !1;
    }),
    (pn.prototype.matchesHack = function () {
      return !1;
    }),
    (hn.beforePosition.get = function () {
      return !1;
    }),
    (pn.prototype.parseRule = function () {
      return null;
    }),
    (pn.prototype.stopEvent = function () {
      return !1;
    }),
    (hn.size.get = function () {
      for (var t = 0, e = 0; e < this.children.length; e++)
        t += this.children[e].size;
      return t;
    }),
    (hn.border.get = function () {
      return 0;
    }),
    ...
    (pn.prototype.posBeforeChild = function (t) {
    ...
    (hn.posBefore.get = function () {
      return this.parent.posBeforeChild(this);
    }),
    (hn.posAtStart.get = function () {
      return this.parent ? this.parent.posBeforeChild(this) + this.border : 0;
    }),
    (hn.posAfter.get = function () {
      return this.posBefore + this.size;
    }),
    (hn.posAtEnd.get = function () {
      return this.posAtStart + this.size - 2 * this.border;
    }),
    (pn.prototype.localPosFromDOM = function (t, e, n) {
      if (
        this.contentDOM &&
      ...
      var a;
      if (t == this.dom && this.contentDOM) a = e > Ae(this.contentDOM);
      else if (
        this.contentDOM &&
    ...
    (pn.prototype.nearestDesc = function (t, e) {
    ...
    (pn.prototype.getDesc = function (t) {
      for (var e = t.pmViewDesc, n = e; n; n = n.parent)
        if (n == this) return e;
    }),
    (pn.prototype.posFromDOM = function (t, e, n) {
    ...
    (pn.prototype.descAt = function (t) {
    ...
    (pn.prototype.domFromPos = function (t, e) {
      ...
      for (var n = 0, r = 0, o = !0; ; r++, o = !1) {
        ...
        if (
          ...
          return {
            ...
            offset: i ? Ae(i.dom) : this.contentDOM.childNodes.length,
          };
    ...
    (pn.prototype.parseRange = function (t, e, n) {
    ...
    (pn.prototype.setSelection = function (t, e, n, r) {
      for (
      ...
      if ((Ce.gecko || Ce.safari) && t == e) {
        ...
        if (3 == d.nodeType)
          (u = m && '\n' == d.nodeValue[m - 1]) &&
            ...
            (p = h = { node: d.parentNode, offset: Ae(d) + 1 });
        else {
      ...
      if (
        ...
        !Pe(h.node, h.offset, f.focusNode, f.focusOffset)
      ) {
        var g = !1;
        if ((f.extend || t == e) && !u) {
          f.collapse(p.node, p.offset);
          try {
            t != e && f.extend(h.node, h.offset), (g = !0);
          } catch (t) {
    ...
    (pn.prototype.ignoreMutation = function (t) {
      return !this.contentDOM && 'selection' != t.type;
    }),
    (hn.contentLost.get = function () {
      return (
        this.contentDOM &&
        this.contentDOM != this.dom &&
        !this.dom.contains(this.contentDOM)
    ...
    (pn.prototype.markDirty = function (t, e) {
    ...
    (pn.prototype.markParentsDirty = function () {
      for (var t = 1, e = this.parent; e; e = e.parent, t++) {
        var n = 1 == t ? 2 : 1;
        e.dirty < n && (e.dirty = n);
      }
    }),
    (hn.domAtom.get = function () {
      return !1;
    }),
    Object.defineProperties(pn.prototype, hn);
  var fn = [],
    un = (function (t) {
      function e(e, n, r, o) {
        var i,
        ...
        t.call(this, e, fn, s, null), (this.widget = n), (i = this);
      }
      t && (e.__proto__ = t),
        (e.prototype = Object.create(t && t.prototype)),
        (e.prototype.constructor = e);
    ...
    dn = (function (t) {
      function e(e, n, r, o) {
        t.call(this, e, fn, n, null), (this.textDOM = r), (this.text = o);
      }
      t && (e.__proto__ = t),
        (e.prototype = Object.create(t && t.prototype)),
        (e.prototype.constructor = e);
      ...
      return (
        ...
        (e.prototype.slice = function (t, n, r) {
          var o = e.create(this.parent, this.mark, !0, r),
            i = this.children,
            s = this.size;
          n < s && (i = In(i, n, s, r)), t > 0 && (i = In(i, 0, t, r));
      ...
      return (
        (e.create = function (t, n, r, o, i, s) {
          ...
          if (n.isText)
            ...
            h ||
              ((h = (a = dt.renderSpec(document, n.type.spec.toDOM(n))).dom),
              (f = a.contentDOM));
          f ||
            n.isText ||
            'BR' == h.nodeName ||
            (h.hasAttribute('contenteditable') || (h.contentEditable = !1),
            n.type.spec.draggable && (h.draggable = !0));
          var u = h;
          return (
            (h = Nn(h, r, n)),
            p
              ? (c = new bn(t, n, r, o, h, f, u, p, i, s + 1))
              : n.isText
              ? new yn(t, n, r, o, h, u, i)
              : new e(t, n, r, o, h, f, u, i, s + 1)
          );
        }),
        (e.prototype.parseRule = function () {
          var t = this;
            ...
            if (0 != o.length)
              for (var s = 0, a = [], c = null, l = 0; ; ) {
                if (s < o.length && o[s].to == i) {
                  ...
                  if (h) {
                    h.sort(An);
                    for (var f = 0; f < h.length; f++) n(h[f], l, !!c);
                  } else n(p, l, !!c);
                }
                var u = void 0,
                  d = void 0;
            ...
            function (e, i, a) {
              e.spec.marks
                ...
                : e.type.side >= 0 &&
                  !a &&
                  s.syncToMarks(
                    i == n.node.childCount ? l.none : n.node.child(i).marks,
                    r,
                    t,
                  ),
                s.placeWidget(e, t, o);
        ...
        (e.prototype.protectLocalComposition = function (t, e) {
          ...
          if (!this.getDesc(n)) {
            ...
            var s = new dn(this, i, n, o);
            t.compositionNodes.push(s),
              (this.children = In(this.children, r, r + o.length, t, s));
          }
        }),
        ...
        (e.prototype.updateOuterDeco = function (t) {
          if (!Tn(t, this.outerDeco)) {
            var e = 1 != this.nodeDOM.nodeType,
              n = this.dom;
            (this.dom = Cn(
              this.dom,
              this.nodeDOM,
              Mn(this.outerDeco, this.node, e),
              Mn(t, this.node, e),
            )),
              this.dom != n &&
  ...
  function gn(t, e, n, r, o) {
    return Nn(r, e, t), new vn(null, t, e, n, r, r, r, o, 0);
  }
  var yn = (function (t) {
      function e(e, n, r, o, i, s, a) {
  ...
  function kn(t, e, n) {
    for (var r = t.firstChild, o = !1, i = 0; i < e.length; i++) {
      ...
      if (s instanceof mn) {
        ...
        kn(s.contentDOM, s.children, n), (r = c ? c.nextSibling : t.firstChild);
      }
    }
    for (; r; ) (r = Dn(r)), (o = !0);
  ...
  function Mn(t, e, n) {
    ...
    for (var r = n ? Sn[0] : new xn(), o = [r], i = 0; i < t.length; i++) {
      var s = t[i].type.attrs;
      if (s)
        for (var a in (s.nodeName && o.push((r = new xn(s.nodeName))), s)) {
          var c = s[a];
          null != c &&
            (n &&
              1 == o.length &&
  ...
  function On(t, e, n) {
    ...
    if (e.class != n.class) {
      for (
        var i = e.class ? e.class.split(' ').filter(Boolean) : fn,
          s = n.class ? n.class.split(' ').filter(Boolean) : fn,
          a = 0;
        a < i.length;
        a++
      )
  ...
  function Nn(t, e, n) {
    return Cn(t, t, Sn, Mn(e, n, 1 != t.nodeType));
  }
  function Tn(t, e) {
    if (t.length != e.length) return !1;
  ...
  function Rn(t, e) {
    ...
    if (Fe(n)) {
      ...
      if (
        ...
        var p = o.posBefore;
        c = new se(s == p ? l : r.resolve(p));
      }
    } else {
      var h = t.docView.posFromDOM(n.anchorNode, n.anchorOffset);
      if (h < 0) return null;
      a = r.resolve(h);
    }
    return (
      c ||
        (c = Ln(
          ...
          a,
          l,
          'pointer' == e || (t.state.selection.head < l.pos && !i) ? 1 : -1,
        )),
      c
    );
  }
      ...
      if ((t.domObserver.disconnectSelection(), t.cursorWrapper))
        !(function (t) {
          var e = t.root.getSelection(),
            ...
            o = 'IMG' == r.nodeName;
          o ? n.setEnd(r.parentNode, Ae(r) + 1) : n.setEnd(r, 0),
            n.collapse(!1),
            e.removeAllRanges(),
            e.addRange(n),
            !o &&
        ...
        !Bn ||
          n instanceof oe ||
          (n.$from.parent.inlineContent || (r = Vn(t, n.from)),
          n.empty || n.$from.parent.inlineContent || (o = Vn(t, n.to))),
  ...
  (En.prototype.destroyBetween = function (t, e) {
    if (t != e) {
      for (var n = t; n < e; n++) this.top.children[n].destroy();
      this.top.children.splice(t, e - t), (this.changed = !0);
    }
  }),
    (En.prototype.destroyRest = function () {
      this.destroyBetween(this.index, this.top.children.length);
    }),
    (En.prototype.syncToMarks = function (t, e, n) {
      for (
      ...
      for (; o < t.length; ) {
        ...
        if (s > -1)
          ...
          var c = mn.create(this.top, t[o], e, n);
    ...
    (En.prototype.findNodeMatch = function (t, e, n, r) {
    ...
    (En.prototype.updateNextNode = function (t, e, n, r, o) {
    ...
    (En.prototype.addNode = function (t, e, n, r, o) {
      this.top.children.splice(
        this.index++,
        0,
        vn.create(this.top, t, e, n, r, o),
      ),
        (this.changed = !0);
    }),
    (En.prototype.placeWidget = function (t, e, n) {
      var r =
      ...
      if (
        ...
        var o = new un(this.top, t, e, n);
        this.top.children.splice(this.index++, 0, o), (this.changed = !0);
      } else this.index++;
    }),
    (En.prototype.addTextblockHacks = function () {
      for (var t = this.top.children[this.index - 1]; t instanceof mn; )
        t = t.children[t.children.length - 1];
      if (!t || !(t instanceof yn) || /\n$/.test(t.node.text))
        if (
          this.index < this.top.children.length &&
          ...
          this.top.children.splice(
            this.index++,
            0,
            new wn(this.top, fn, e, null),
          ),
            (this.changed = !0);
        }
    });
  var Bn = Ce.safari || (Ce.chrome && Ce.chrome_version < 63);
  function Vn(t, e) {
    ...
    if (Ce.safari && i && 'false' == i.contentEditable) return $n(i);
    if (
      !(
  ...
  function $n(t) {
    return (
      ...
      Ce.safari && t.draggable && ((t.draggable = !1), (t.wasDraggable = !0)),
      t
    );
  }
  function qn(t) {
  ...
  function Fn(t, e) {
    if (e instanceof se) {
      ...
      n != t.lastSelectedViewDesc &&
        (_n(t), n && n.selectNode(), (t.lastSelectedViewDesc = n));
    } else _n(t);
  }
  function _n(t) {
  ...
  function Kn(t, e, n) {
    ...
    if (!(r instanceof oe)) {
      if (r instanceof se && r.node.isInline)
        return Wn(t, new oe(e > 0 ? r.$to : r.$from));
      var o = Jn(t.state, e);
      return !!o && Wn(t, o);
    }
    ...
    if (t.endOfTextblock(e > 0 ? 'right' : 'left')) {
      var i = Jn(t.state, e);
      return !!(i && i instanceof se) && Wn(t, i);
    }
    if (!(Ce.mac && n.indexOf('m') > -1)) {
      var s,
        a = r.$head,
      ...
      return (
        ...
        (se.isSelectable(c)
          ? Wn(t, new se(e < 0 ? t.state.doc.resolve(a.pos - c.nodeSize) : a))
          : !!Ce.webkit &&
            Wn(t, new oe(t.state.doc.resolve(e < 0 ? l : l + c.nodeSize))))
      );
    }
  }
  function Hn(t) {
    ...
    if (n) {
      ...
      for (
        ...
        if (r > 0) {
          ...
          if (Yn(n)) break;
          for (var c = n.previousSibling; c && Un(c); )
            (o = n.parentNode), (i = Ae(c)), (c = c.previousSibling);
          if (c) r = Hn((n = c));
          else {
  ...
  function Xn(t) {
    ...
    if (n) {
      for (var o, i, s = Hn(n); ; )
        if (r < s) {
          if (1 != n.nodeType) break;
          if (!Un(n.childNodes[r])) break;
          (o = n), (i = ++r);
        } else {
          if (Yn(n)) break;
          for (var a = n.nextSibling; a && Un(a); )
            (o = a.parentNode), (i = Ae(a) + 1), (a = a.nextSibling);
          if (a) (r = 0), (s = Hn((n = a)));
          else {
            if ((n = n.parentNode) == t.dom) break;
            r = s = 0;
  ...
  function Zn(t, e, n) {
    ...
    if (Ce.mac && n.indexOf('m') > -1) return !1;
    var o = r.$from,
      i = r.$to;
    if (!o.parent.inlineContent || t.endOfTextblock(e < 0 ? 'up' : 'down')) {
      var s = Jn(t.state, e);
      if (s && s instanceof se) return Wn(t, s);
    }
  ...
  function nr(t) {
    ...
    if ('BR' == t.nodeName && t.parentNode) {
      if (Ce.safari && /^(ul|ol)$/i.test(t.parentNode.nodeName)) {
        var n = document.createElement('div');
        return n.appendChild(document.createElement('li')), { skip: n };
      }
      if (
        t.parentNode.lastChild == t ||
        (Ce.safari && /^(tr|table)$/i.test(t.parentNode.nodeName))
      )
        return { ignore: !0 };
  ...
  function rr(t, e, n) {
    return Math.max(n.anchor, n.head) > e.content.size
      ? null
      : Ln(t, e.resolve(n.anchor), e.resolve(n.head));
  }
  function or(t, e, n) {
    for (
  ...
  function ir(t, e) {
    ...
    for (
      var p, h = l.firstChild;
      h && 1 == h.nodeType && (p = hr[h.nodeName.toLowerCase()]);

    ) {
      for (var f = p.length - 1; f >= 0; f--) {
        for (var u = c.createElement(p[f]); l.firstChild; )
    ...
    return (
      h &&
        1 == h.nodeType &&
        h.setAttribute('data-pm-slice', o + ' ' + i + ' ' + JSON.stringify(n)),
      {
        dom: l,
        text:
  ...
  function sr(t, e, n, r, i) {
    ...
    if (l) {
      ...
      t.someProp('transformPastedHTML', function (t) {
        ...
        (s = (function (t) {
          ...
          var n,
            r = ur().createElement('div'),
            o = /(?:<meta [^>]*>)*<([a-z][^>\s]+)/i.exec(t),
            i = 0;
          (n = o && hr[o[1].toLowerCase()]) &&
            ((t =
              n
                .map(function (t) {
                  return '<' + t + '>';
    ...
    if (!a) {
      ...
      a = d.parseSlice(s, { preserveWhitespace: !(!l && !u), context: i });
    }
    return (
      (a = u
        ? (function (t, e) {
            ...
            (function (t, e, n) {
              return (
                e < t.openStart &&
                  (t = new h(
                    pr(t.content, -1, e, t.openStart, 0, t.openEnd),
                    e,
                    t.openEnd,
                  )),
                n < t.openEnd &&
                  (t = new h(
                    pr(t.content, 1, n, t.openEnd, 0, 0),
                    t.openStart,
                    n,
                  )),
                t
                        ...
                        if (s) {
                          ...
                          if (
                            (e =
                              s.length &&
                              i.length &&
                              cr(n, i, t, s[s.length - 1], 0))
                          )
                            s[s.length - 1] = e;
                          else {
                            s.length &&
                              (s[s.length - 1] = lr(s[s.length - 1], i.length));
                            var o = ar(t, n);
                            s.push(o),
  ...
  function cr(t, e, n, r, i) {
    if (i < t.length && i < e.length && t[i] == e[i]) {
      var s = cr(t, e, n, r.lastChild, i + 1);
      ...
      if (
        ...
        return r.copy(r.content.append(o.from(ar(n, t, i + 1))));
    }
  }
  function lr(t, e) {
    if (0 == e) return t;
    var n = t.content.replaceChild(t.childCount - 1, lr(t.lastChild, e - 1)),
  ...
  (gr.prototype.flushSoon = function () {
    var t = this;
    this.flushingSoon < 0 &&
    ...
    (gr.prototype.forceFlush = function () {
      this.flushingSoon > -1 &&
    ...
    (gr.prototype.start = function () {
      this.observer && this.observer.observe(this.view.dom, dr),
        mr &&
    ...
    (gr.prototype.connectSelection = function () {
      this.view.dom.ownerDocument.addEventListener(
        'selectionchange',
        this.onSelectionChange,
      );
    }),
    (gr.prototype.disconnectSelection = function () {
      this.view.dom.ownerDocument.removeEventListener(
        'selectionchange',
        this.onSelectionChange,
      );
    }),
    (gr.prototype.suppressSelectionUpdates = function () {
      var t = this;
    ...
    (gr.prototype.onSelectionChange = function () {
      if (
        (!(t = this.view).editable || t.root.activeElement == t.dom) &&
        jn(t)
      ) {
        var t;
        if (this.suppressingSelectionUpdates) return Pn(this.view);
        if (Ce.ie && Ce.ie_version <= 11 && !this.view.state.selection.empty) {
          var e = this.view.root.getSelection();
          if (
            e.focusNode &&
            Pe(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset)
          )
    ...
    (gr.prototype.setCurSelection = function () {
      this.currentSelection.set(this.view.root.getSelection());
    }),
    (gr.prototype.ignoreSelectionChange = function (t) {
      ...
      if (this.view.docView && !(this.flushingSoon > -1)) {
        ...
        if (Ce.gecko && s.length > 1) {
          ...
          if (2 == l.length) {
            var p = l[0],
              h = l[1];
            p.parentNode && p.parentNode.parentNode == h.parentNode
              ? h.remove()
              : p.remove();
          }
        }
    ...
    (gr.prototype.registerMutation = function (t, e) {
      ...
      if ('childList' == t.type) {
        ...
        var r = t.previousSibling,
          o = t.nextSibling;
        if (Ce.ie && Ce.ie_version <= 11 && t.addedNodes.length)
          for (var i = 0; i < t.addedNodes.length; i++) {
            var s = t.addedNodes[i],
              a = s.previousSibling,
              c = s.nextSibling;
            (!a || Array.prototype.indexOf.call(t.addedNodes, a) < 0) &&
              (r = a),
              (!c || Array.prototype.indexOf.call(t.addedNodes, c) < 0) &&
                (o = c);
          }
        for (
          var l = r && r.parentNode == t.target ? Ae(r) + 1 : 0,
            p = n.localPosFromDOM(t.target, l, -1),
            h =
              o && o.parentNode == t.target
                ? Ae(o)
                : t.target.childNodes.length,
            f = 0;
          f < t.addedNodes.length;
          f++
        )
          e.push(t.addedNodes[f]);
        return { from: p, to: n.localPosFromDOM(t.target, h, 1) };
      }
  ...
  function Nr(t, e, n, r) {
    return (
      Cr(t, 'handleDoubleClickOn', e, n, r) ||
  ...
  function Tr(t, e, n, r) {
    return (
      Cr(t, 'handleTripleClickOn', e, n, r) ||
      ...
      (function (t, e) {
        ...
        if (-1 == e)
          return (
            !!n.inlineContent &&
            (Or(t, oe.create(n, 0, n.content.size), 'pointer'), !0)
          );
        for (var r = n.resolve(e), o = r.depth + 1; o > 0; o--) {
          var i = o > r.depth ? r.nodeAfter : r.node(o),
            s = r.before(o);
          if (i.inlineContent)
            Or(t, oe.create(n, s + 1, s + 1 + i.content.size), 'pointer');
          else {
            if (!se.isSelectable(i)) continue;
            Or(t, se.create(n, s), 'pointer');
          }
          return !0;
        }
      })(t, n)
  ...
  (br.keydown = function (t, e) {
    if (((t.shiftKey = 16 == e.keyCode || e.shiftKey), !Ir(t, e)))
      if (
        (t.domObserver.forceFlush(),
        (t.lastKeyCode = e.keyCode),
        (t.lastKeyCodeTime = Date.now()),
        !Ce.ios || 13 != e.keyCode || e.ctrlKey || e.altKey || e.metaKey)
      )
        ...
        (function (t, e) {
          ...
          return 8 == n || (Ce.mac && 72 == n && 'c' == r)
            ? tr(t, -1) || Gn(t)
            : 46 == n || (Ce.mac && 68 == n && 'c' == r)
            ? tr(t, 1) || Xn(t)
            : 13 == n ||
              27 == n ||
              (37 == n
  ...
  var Er = Ce.mac ? 'metaKey' : 'ctrlKey';
  wr.mousedown = function (t, e) {
    ...
    var i = t.posAtCoords(Mr(e));
    i &&
      ('singleClick' == o
        ? (t.mouseDown = new Ar(t, i, e, n))
        : ('doubleClick' == o ? Nr : Tr)(t, i.pos, i.inside, e)
        ? e.preventDefault()
        : kr(t, 'pointer'));
  };
  ...
  function Ir(t, e) {
    return (
      !!t.composing ||
      (!!(Ce.safari && Math.abs(e.timeStamp - t.compositionEndedAt) < 500) &&
        ((t.compositionEndedAt = -2e8), !0))
    );
  }
  (Ar.prototype.done = function () {
    ...
    (Ar.prototype.up = function (t) {
      if (
        ...
        this.view.state.doc != this.startDoc &&
          (e = this.view.posAtCoords(Mr(t))),
          this.allowDefault || !e
            ? kr(this.view, 'pointer')
            : (function (t, e, n, r, o) {
                return (
                  Cr(t, 'handleClickOn', e, n, r) ||
                  ...
                  (o
                    ? (function (t, e) {
                        ...
                        return (
                          null != r &&
                          (Or(t, se.create(t.state.doc, r), 'pointer'), !0)
                        );
                      })(t, n)
                    : (function (t, e) {
                        if (-1 == e) return !1;
            ...
            ? t.preventDefault()
            : this.flushed ||
              (Ce.safari && this.mightDrag && !this.mightDrag.node.isAtom) ||
              (Ce.chrome &&
    ...
    (wr.touchdown = function (t) {
      Dr(t), kr(t, 'pointer');
    }),
    (wr.contextmenu = function (t) {
      return Dr(t);
    });
  var Rr = Ce.android ? 5e3 : -1;
  function zr(t, e) {
  ...
  var Vr = (Ce.ie && Ce.ie_version < 15) || (Ce.ios && Ce.webkit_version < 604);
  function $r(t, e, n, r) {
    var o = sr(t, e, n, t.shiftKey, t.state.selection.$from);
    if (
      t.someProp('handlePaste', function (e) {
        return e(t, r, o || h.empty);
      })
    )
      return !0;
    if (!o) return !1;
  ...
  (wr.copy = br.cut = function (t, e) {
    var n = t.state.selection,
      r = 'cut' == e.type;
    if (!n.empty) {
      var o = Vr ? null : e.clipboardData,
        i = ir(t, n.content()),
        s = i.dom,
        a = i.text;
      o
    ...
    (br.paste = function (t, e) {
      var n = Vr ? null : e.clipboardData;
      n && $r(t, n.getData('text/plain'), n.getData('text/html'), e)
        ? e.preventDefault()
        : (function (t, e) {
            if (t.dom.parentNode) {
              var n =
              ...
              n || (r.contentEditable = 'true'),
                ...
                setTimeout(function () {
                  t.focus(),
                    ...
                    n
                      ? $r(t, r.value, null, e)
                      : $r(t, r.textContent, r.innerHTML, e);
                }, 50);
            }
          })(t, e);
    });
  var qr = function (t, e) {
    ...
    Fr = Ce.mac ? 'altKey' : 'ctrlKey';
  for (var _r in ((wr.dragstart = function (t, e) {
    var n = t.mouseDown;
    if ((n && n.done(), e.dataTransfer)) {
      var r = t.state.selection,
        o = r.empty ? null : t.posAtCoords(Mr(e));
      ...
      e.dataTransfer.clearData(),
        e.dataTransfer.setData(Vr ? 'Text' : 'text/html', c.innerHTML),
        Vr || e.dataTransfer.setData('text/plain', l),
        (t.dragging = new qr(s, !e[Fr]));
    }
  }),
  (wr.dragend = function (t) {
    var e = t.dragging;
    window.setTimeout(function () {
      ...
      if (r) {
        ...
        if (o) {
          var i =
              ...
              sr(
                t,
                e.dataTransfer.getData(Vr ? 'Text' : 'text/plain'),
                Vr ? null : e.dataTransfer.getData('text/html'),
                !1,
                o,
              ),
            s = n && !e[Fr];
          if (
            t.someProp('handleDrop', function (n) {
              return n(t, e, i || h.empty, s);
            })
          )
            e.preventDefault();
          else if (i) {
            e.preventDefault();
            var a = i ? Ft(t.state.doc, o.pos, i) : o.pos;
            null == a && (a = o.pos);
            var c = t.state.tr;
            s && c.deleteSelection();
            var l = c.mapping.map(a),
              p =
                0 == i.openStart && 0 == i.openEnd && 1 == i.content.childCount,
              f = c.doc;
            if (
              (p
                ? c.replaceRangeWith(l, l, i.content.firstChild)
                : c.replaceRange(l, l, i),
              !c.doc.eq(f))
            ) {
              var u = c.doc.resolve(l);
              if (
                p &&
                ...
                c.mapping.maps[c.mapping.maps.length - 1].forEach(function (
                  ...
                  c.setSelection(Ln(t, u, c.doc.resolve(d)));
              }
  ...
  (wr.beforeinput = function (t, e) {
    if (Ce.chrome && Ce.android && 'deleteContentBackward' == e.inputType) {
      ...
      return (
        ...
        (t instanceof jr &&
          ((this.spec.key && this.spec.key == t.spec.key) ||
            (this.toDOM == t.toDOM && Lr(this.spec, t.spec))))
      );
    });
  var Jr = function (t, e) {
    (this.spec = e || Gr), (this.attrs = t);
  };
  (Jr.prototype.map = function (t, e, n, r) {
    var o = t.map(e.from + r, this.spec.inclusiveStart ? -1 : 1) - n,
      i = t.map(e.to + r, this.spec.inclusiveEnd ? 1 : -1) - n;
    return o >= i ? null : new Kr(o, i, this);
  }),
    ...
    (Jr.prototype.eq = function (t) {
      return (
        this == t ||
        (t instanceof Jr && Lr(this.attrs, t.attrs) && Lr(this.spec, t.spec))
      );
    }),
    (Jr.is = function (t) {
  ...
  (Wr.prototype.map = function (t, e, n, r) {
    var o = t.mapResult(e.from + r, 1);
    if (o.deleted) return null;
    var i = t.mapResult(e.to + r, -1);
    return i.deleted || i.pos <= o.pos
      ? null
      : new Kr(o.pos - n, i.pos - n, this);
  }),
    (Wr.prototype.valid = function (t, e) {
    ...
    (Wr.prototype.eq = function (t) {
      return (
        this == t ||
        (t instanceof Wr && Lr(this.attrs, t.attrs) && Lr(this.spec, t.spec))
      );
    });
  var Kr = function (t, e, n) {
      (this.from = t), (this.to = e), (this.type = n);
    },
    Hr = { spec: { configurable: !0 }, inline: { configurable: !0 } };
  (Kr.prototype.copy = function (t, e) {
    return new Kr(t, e, this.type);
  }),
    (Kr.prototype.eq = function (t, e) {
      return (
        void 0 === e && (e = 0),
        this.type.eq(t.type) && this.from + e == t.from && this.to + e == t.to
      );
    }),
    (Kr.prototype.map = function (t, e, n) {
    ...
    (Kr.inline = function (t, e, n, r) {
      return new Kr(t, e, new Jr(n, r));
    }),
    (Kr.node = function (t, e, n, r) {
      return new Kr(t, e, new Wr(n, r));
    }),
    (Hr.spec.get = function () {
      return this.type.spec;
    }),
    (Hr.inline.get = function () {
      return this.type instanceof Jr;
    }),
    Object.defineProperties(Kr.prototype, Hr);
  var Ur = [],
    Gr = {},
    Xr = function (t, e) {
      (this.local = t && t.length ? t : Ur),
        (this.children = e && e.length ? e : Ur);
    };
  (Xr.create = function (t, e) {
    return e.length ? no(e, t, 0, Gr) : Yr;
  }),
    (Xr.prototype.find = function (t, e, n) {
      var r = [];
      return this.findInner(null == t ? 0 : t, null == e ? 1e9 : e, r, 0, n), r;
    }),
    (Xr.prototype.findInner = function (t, e, n, r, o) {
    ...
    (Xr.prototype.map = function (t, e, n) {
      return this == Yr || 0 == t.maps.length
        ? this
        : this.mapInner(t, e, 0, 0, n || Gr);
    }),
    (Xr.prototype.mapInner = function (t, e, n, r, o) {
            ...
            for (var p = !1, h = 0; h < a.length; h += 3)
              if (-1 == a[h + 1]) {
                ...
                if (y && g == u && g + y.nodeSize == d) {
                  var w = a[h + 2].mapInner(n, y, f + 1, t[h] + i + 1, s);
                  w != Yr
                    ? ((a[h] = u), (a[h + 1] = d), (a[h + 2] = w))
                    : ((a[h + 1] = -2), (p = !0));
                } else p = !0;
              }
            if (p) {
              ...
              for (var x = 0, S = 0; x < b.children.length; x += 3) {
                for (var M = b.children[x]; S < a.length && a[S] < M; ) S += 3;
                a.splice(
                  S,
                  0,
                  b.children[x],
    ...
    (Xr.prototype.addInner = function (t, e, n) {
      var r,
        o = this,
        i = 0;
      t.forEach(function (t, s) {
        ...
        if ((a = to(e, t, c))) {
          ...
          r[i] == s
            ...
            : r.splice(i, 0, s, s + t.nodeSize, no(a, t, c + 1, Gr)),
            (i += 3);
        }
      });
      for (var s = Zr(i ? eo(e) : e, -n), a = 0; a < s.length; a++)
        s[a].type.valid(t, s[a]) || s.splice(a--, 1);
      return new Xr(
        s.length ? this.local.concat(s).sort(ro) : this.local,
        r || this.children,
      );
    }),
    (Xr.prototype.remove = function (t) {
      return 0 == t.length || this == Yr ? this : this.removeInner(t, 0);
    }),
    (Xr.prototype.removeInner = function (t, e) {
    ...
    (Xr.prototype.forChild = function (t, e) {
      if (this == Yr) return this;
      ...
      if (r) {
        var h = new Xr(r.sort(ro));
        return n ? new Qr([h, n]) : h;
      }
      return n || Yr;
    }),
    ...
    (Xr.prototype.locals = function (t) {
      return oo(this.localsInner(t));
    }),
    (Xr.prototype.localsInner = function (t) {
      if (this == Yr) return Ur;
  ...
  var Yr = new Xr();
  (Xr.empty = Yr), (Xr.removeOverlap = oo);
  var Qr = function (t) {
    this.members = t;
  };
  function Zr(t, e) {
    ...
    for (var n = [], r = 0; r < t.length; r++) {
      var o = t[r];
      n.push(new Kr(o.from + e, o.to + e, o.type));
    }
    return n;
  }
  function to(t, e, n) {
  ...
  function no(t, e, n, r) {
    ...
    e.forEach(function (e, s) {
      ...
      if (a) {
        i = !0;
        var c = no(a, e, n + s + 1, r);
        c != Yr && o.push(s, s + e.nodeSize, c);
      }
    });
    for (var s = Zr(i ? eo(t) : t, -n).sort(ro), a = 0; a < s.length; a++)
      s[a].type.valid(e, s[a]) ||
        (r.onRemove && r.onRemove(s[a].spec), s.splice(a--, 1));
    return s.length || o.length ? new Xr(s, o) : Yr;
  }
  function ro(t, e) {
        ...
        for (var o = n + 1; o < e.length; o++) {
          ...
          if (i.from != r.from) {
            i.from < r.to &&
              ...
              io(e, o, r.copy(i.from, r.to)));
            break;
          }
          i.to != r.to &&
            (e == t && (e = t.slice()),
            (e[o] = i.copy(i.from, r.to)),
            io(e, o + 1, i.copy(r.to, i.to)));
        }
    }
    return e;
  }
  function io(t, e, n) {
    for (; e < t.length && ro(n, t[e]) > 0; ) e++;
    t.splice(e, 0, n);
  }
  function so(t) {
    var e = [];
    return (
      ...
      t.cursorWrapper && e.push(Xr.create(t.state.doc, [t.cursorWrapper.deco])),
      Qr.from(e)
    );
  }
  (Qr.prototype.forChild = function (t, e) {
    if (e.isLeaf) return Xr.empty;
    for (var n = [], r = 0; r < this.members.length; r++) {
      var o = this.members[r].forChild(t, e);
      o != Yr && (o instanceof Qr ? (n = n.concat(o.members)) : n.push(o));
    }
    return Qr.from(n);
  }),
    (Qr.prototype.eq = function (t) {
      if (!(t instanceof Qr) || t.members.length != this.members.length)
        return !1;
      for (var e = 0; e < this.members.length; e++)
        if (!this.members[e].eq(t.members[e])) return !1;
      return !0;
    }),
    (Qr.prototype.locals = function (t) {
  ...
  var ao = function (t, e) {
      (this._props = e),
        ...
        (this.editable = ho(this)),
        (this.markCursor = null),
        (this.cursorWrapper = null),
        po(this),
        (this.nodeViews = fo(this)),
        (this.docView = gn(this.state.doc, lo(this), so(this), this.dom, this)),
        ...
        (function (t) {
          (t.shiftKey = !1),
            ...
            (t.domObserver = new gr(t, function (e, n, r, i) {
              return (function (t, e, n, r, i) {
                if (e < 0) {
                    ...
                    f = (function (t, e, n) {
                      ...
                      if (
                        (h &&
                          ...
                          ((p = [{ node: h, offset: l.anchorOffset }]),
                          Fe(l) ||
                            p.push({
                              node: l.focusNode,
                              offset: l.focusOffset,
                            })),
                        Ce.chrome && 8 === t.lastKeyCode)
                      )
                        for (var f = s; f > i; f--) {
                  ...
                  if (!w) {
                    ...
                    w = { start: h.from, endA: h.to, endB: h.to };
                  }
                  t.domChangeCount++,
                  ...
                  var k,
                    x = f.doc.resolveNoCache(w.start - f.from),
                    S = f.doc.resolveNoCache(w.endB - f.from),
                    M = x.sameParent(S) && x.parent.inlineContent;
                  if (
                    ((Ce.ios &&
                      t.lastIOSEnter > Date.now() - 225 &&
                      (!M ||
                      ...
                      (!M &&
                        x.pos < f.doc.content.size &&
                        (k = ee.findFrom(f.doc.resolve(x.pos + 1), 1, !0)) &&
                        k.head == S.pos)) &&
                    t.someProp('handleKeyDown', function (e) {
                      return e(t, _e(13, 'Enter'));
                    })
                      ...
                      if (x.pos == S.pos)
                        ...
                        (N = (function (t, e) {
                          ...
                          for (var h = 0; h < s.length; h++)
                            l = s[h].removeFromSet(l);
                          if (1 == c.length && 0 == l.length)
                            (r = c[0]),
                              (n = 'add'),
                              (i = function (t) {
                          ...
                          x.parent.content.cut(x.parentOffset, S.parentOffset),
                          T.parent.content.cut(
                            T.parentOffset,
                            w.endA - T.start(),
                          ),
                        ))
                        ...
                        (C = t.state.tr),
                          'add' == N.type
                            ? C.addMark(D, E, N.mark)
                            : C.removeMark(D, E, N.mark);
                      else if (
                        x.parent.child(x.index()).isText &&
                        x.index() == S.index() - (S.textOffset ? 0 : 1)
                      ) {
                        var A = x.parent.textBetween(
                          x.parentOffset,
                          S.parentOffset,
                        );
                        if (
                      ...
                      I &&
                        !(
                          (Ce.chrome &&
                            ...
                            t.composing &&
                            I.empty &&
                            (I.head == D || I.head == C.mapping.map(E) - 1)) ||
                          (Ce.ie && I.empty && I.head == D)
                        ) &&
                        C.setSelection(I);
                    }
    ...
    co = { props: { configurable: !0 }, root: { configurable: !0 } };
  function lo(t) {
    var e = Object.create(null);
    return (
      (e.class = 'ProseMirror'),
      ...
      [Kr.node(0, t.state.doc.content.size, e)]
    );
  }
  function po(t) {
    if (t.markCursor) {
      ...
      e.setAttribute('mark-placeholder', 'true'),
        (t.cursorWrapper = {
          dom: e,
          deco: Kr.widget(t.state.selection.head, e, {
            raw: !0,
            marks: t.markCursor,
          }),
        });
  ...
  (co.props.get = function () {
    ...
    (ao.prototype.update = function (t) {
      t.handleDOMEvents != this._props.handleDOMEvents && xr(this),
        (this._props = t),
        this.updateStateInner(t.state, !0);
    }),
    (ao.prototype.setProps = function (t) {
      var e = {};
      for (var n in this._props) e[n] = this._props[n];
      for (var r in ((e.state = this.state), t)) e[r] = t[r];
      this.update(e);
    }),
    (ao.prototype.updateState = function (t) {
      this.updateStateInner(t, this.state.plugins != t.plugins);
    }),
    (ao.prototype.updateStateInner = function (t, e) {
      var n = this,
        r = this.state,
        o = !1,
        i = !1;
      ...
      var h,
        ...
        k =
          ...
          (function (t) {
            ...
            return { refDOM: e, refTop: n, stack: Ke(t.dom) };
          })(this);
      if (i) {
        ...
        var x =
          ...
          (m = t.selection),
          (v = Math.min(
            d.$anchor.sharedDepth(d.head),
            m.$anchor.sharedDepth(m.head),
          )),
          d.$anchor.start(v) != m.$anchor.start(v));
        if (p) {
          var S = Ce.chrome
          ...
          (!o && this.docView.update(t.doc, c, a, this)) ||
            ...
            (this.docView = gn(t.doc, c, a, this.dom, this))),
        ...
        !(
          ...
          (u = h.root.getSelection()),
          Pe(f.node, f.offset, u.anchorNode, u.anchorOffset))
        )
          ? Pn(this, x)
          : (Fn(this, t.selection), this.domObserver.setCurSelection()),
      ...
      if ((this.updatePluginViews(r), 'reset' == l)) this.dom.scrollTop = 0;
        ...
        this.someProp('handleScrollToSelection', function (t) {
          ...
          (t.selection instanceof se
            ...
            : We(this, this.coordsAtPos(t.selection.head, 1), M));
      } else
        k &&
          ((y = (g = k).refDOM),
          (w = g.refTop),
          He(
            g.stack,
            0 == (b = y ? y.getBoundingClientRect().top : 0) ? 0 : b - w,
          ));
    }),
    (ao.prototype.destroyPluginViews = function () {
      for (var t; (t = this.pluginViews.pop()); ) t.destroy && t.destroy();
    }),
    (ao.prototype.updatePluginViews = function (t) {
    ...
    (ao.prototype.someProp = function (t, e) {
      var n,
    ...
    (ao.prototype.hasFocus = function () {
      return this.root.activeElement == this.dom;
    }),
    (ao.prototype.focus = function () {
      this.domObserver.stop(),
        this.editable &&
          (function (t) {
    ...
    (ao.prototype.posAtCoords = function (t) {
      return Qe(this, t);
    }),
    (ao.prototype.coordsAtPos = function (t, e) {
      return void 0 === e && (e = 1), en(this, t, e);
    }),
    (ao.prototype.domAtPos = function (t, e) {
      return void 0 === e && (e = 0), this.docView.domFromPos(t, e);
    }),
    (ao.prototype.nodeDOM = function (t) {
      var e = this.docView.descAt(t);
      return e ? e.nodeDOM : null;
    }),
    (ao.prototype.posAtDOM = function (t, e, n) {
      void 0 === n && (n = -1);
      var r = this.docView.posFromDOM(t, e, n);
      if (null == r) throw new RangeError('DOM position not inside the editor');
      return r;
    }),
    (ao.prototype.endOfTextblock = function (t, e) {
              ...
              'up' == n || 'down' == n
                ? (function (t, e, n) {
                    ...
                    return on(t, e, function () {
                      ...
                      for (
                        var i = en(t, o.pos, 1), s = e.firstChild;
                        s;
                        s = s.nextSibling
                      ) {
                        var a = void 0;
                ...
                : (function (t, e, n) {
                    ...
                    var o = r.parentOffset,
                      ...
                      a = getSelection();
                    return sn.test(r.parent.textContent) && a.modify
                      ? on(t, e, function () {
    ...
    (ao.prototype.destroy = function () {
      this.docView &&
        ...
        this.destroyPluginViews(),
        this.mounted
          ? (this.docView.update(this.state.doc, [], so(this), this),
            (this.dom.textContent = ''))
          : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom),
        this.docView.destroy(),
        (this.docView = null));
    }),
    (ao.prototype.dispatchEvent = function (t) {
      return (function (t, e) {
        Sr(t, e) ||
          !wr[e.type] ||
          (!t.editable && e.type in br) ||
  ...
  var uo = ['p', 0],
    ...
    Oo = {
      ...
      toDOM: function (t) {
        return 1 == t.attrs.order ? So : ['ol', { start: t.attrs.order }, 0];
      },
    },
    No = {
      parseDOM: [{ tag: 'ul' }],
    ...
    return function (n, r) {
      ...
      return (
        ...
        (r &&
          r(
            (function (t, e, n, r, i) {
              for (var s = o.empty, a = n.length - 1; a >= 0; a--)
                s = o.from(n[a].type.create(n[a].attrs, s));
              t.step(
                new Et(
                  e.start - (r ? 2 : 0),
                  e.end,
              ...
              for (
                ...
                !v && Bt(t.doc, f, p) && (t.split(f, p), (f += 2 * p)),
                  (f += u.child(d).nodeSize);
              return t;
            })(n.tr, c, u, l, t).scrollIntoView(),
          ),
        !0)
      );
    };
  ...
  for (
    var Ao = {
      ...
      Bo = 'undefined' != typeof navigator && /Mac/.test(navigator.platform),
      Vo =
        'undefined' != typeof navigator &&
        /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(
          navigator.userAgent,
        ),
      $o = (Ro && (Bo || +Ro[1] < 57)) || (Po && Bo),
      qo = 0;
    qo < 10;
    qo++
  )
    Ao[48 + qo] = Ao[96 + qo] = String(qo);
  for (qo = 1; qo <= 24; qo++) Ao[qo + 111] = 'F' + qo;
  for (qo = 65; qo <= 90; qo++)
    (Ao[qo] = String.fromCharCode(qo + 32)), (Io[qo] = String.fromCharCode(qo));
  for (var Fo in Ao) Io.hasOwnProperty(Fo) || (Io[Fo] = Ao[Fo]);
  var _o = 'undefined' != typeof navigator && /Mac/.test(navigator.platform);
  function Lo(t) {
    var e,
      n,
      r,
  ...
  function Jo(t) {
    return new ke({ props: { handleKeyDown: Wo(t) } });
  }
  function Wo(t) {
    var e = (function (t) {
      var e = Object.create(null);
      for (var n in t) e[Lo(n)] = t[n];
      return e;
    })(t);
    return function (t, n) {
      var r,
        o = (function (t) {
          var e =
            (!(
              ...
              ((zo || Vo) && t.shiftKey && t.key && 1 == t.key.length)
            ) &&
              t.key) ||
            (t.shiftKey ? Io : Ao)[t.keyCode] ||
            t.key ||
            'Unidentified';
          return (
            'Esc' == e && (e = 'Escape'),
  ...
  var Ko = 200,
    Ho = function () {};
  (Ho.prototype.append = function (t) {
    return t.length
      ? ((t = Ho.from(t)),
        (!this.length && t) ||
          (t.length < Ko && this.leafAppend(t)) ||
          (this.length < Ko && t.leafPrepend(this)) ||
          this.appendInner(t))
      : this;
  }),
    (Ho.prototype.prepend = function (t) {
      return t.length ? Ho.from(t).append(this) : this;
    }),
    (Ho.prototype.appendInner = function (t) {
      return new Go(this, t);
    }),
    (Ho.prototype.slice = function (t, e) {
      return (
        void 0 === t && (t = 0),
    ...
    (Ho.prototype.forEach = function (t, e, n) {
      void 0 === e && (e = 0),
    ...
    (Ho.from = function (t) {
      return t instanceof Ho ? t : t && t.length ? new Uo(t) : Ho.empty;
    });
  var Uo = (function (t) {
    function e(e) {
  ...
  (Yo.prototype.popEvent = function (t, e) {
    var n = this;
      ...
      this.items.forEach(
        function (t, e) {
          ...
          if (r) {
            p.push(new Qo(t.map));
            var h,
              f = t.step.map(r.slice(o));
            f &&
              c.maybeStep(f).doc &&
              ((h = c.mapping.maps[c.mapping.maps.length - 1]),
              l.push(new Qo(h, null, null, l.length + p.length))),
              o--,
              h && r.appendMap(h, o);
    ...
    (Yo.prototype.addTransform = function (t, e, n, r) {
      for (
        var o = [],
          i = this.eventCount,
          s = this.items,
        ...
        var l,
          p = t.steps[c].invert(t.docs[c]),
          h = new Qo(t.mapping.maps[c], p, e);
        (l = a && a.merge(h)) &&
      ...
      return (
        m > ti &&
          ((u = m),
          (f = s).forEach(function (t, e) {
            if (t.selection && 0 == u--) return (d = e), !1;
          }),
          (s = f.slice(d)),
          (i -= m)),
        new Yo(s.append(o), i)
    ...
    (Yo.prototype.remapping = function (t, e) {
      var n = new kt();
      return (
        this.items.forEach(
          function (e, r) {
    ...
    (Yo.prototype.addMaps = function (t) {
    ...
    (Yo.prototype.rebased = function (t, e) {
      ...
      this.items.forEach(function (e) {
        ...
        if (null != r) {
          ...
          if (e.step) {
            ...
            p && s++, n.push(new Qo(c, l, p));
          } else n.push(new Qo(c));
        }
      }, r);
      for (var c = [], l = e; l < i; l++) c.push(new Qo(o.maps[l]));
    ...
    (Yo.prototype.emptyItemCount = function () {
      var t = 0;
      return (
        this.items.forEach(function (e) {
          e.step || t++;
    ...
    (Yo.prototype.compress = function (t) {
      ...
      return (
          ...
          function (i, s) {
            if (s >= t) r.push(i), i.selection && o++;
              ...
              if ((n--, c && e.appendMap(c, n), a)) {
                ...
                l && o++;
                var p,
                  h = new Qo(c.invert(), a, l),
                  f = r.length - 1;
                (p = r.length && r[f].merge(h)) ? (r[f] = p) : r.push(h);
              }
            } else i.map && n--;
          },
          this.items.length,
        ...
        new Yo(Xo.from(r.reverse()), o)
      );
    }),
    (Yo.empty = new Yo(Xo.empty, 0));
  ...
  Qo.prototype.merge = function (t) {
    if (this.step && t.step && !t.selection) {
      var e = t.step.merge(this.step);
      if (e) return new Qo(e.getMap().invert(), e, this.selection);
    }
  };
  ...
  function ri(t, e, n, r) {
    var o = si(e),
      i = ai.get(e).spec.config,
      s = (r ? t.undone : t.done).popEvent(e, o);
    if (s) {
      var a = s.selection.resolve(s.transform.doc),
        c = (r ? t.done : t.undone).addTransform(
          s.transform,
          e.selection.getBookmark(),
          i,
          o,
        ),
        l = new Zo(r ? c : s.remaining, r ? s.remaining : c, null, 0);
      n(
        s.transform
          .setSelection(a)
          .setMeta(ai, { redo: r, historyState: l })
          .scrollIntoView(),
      );
    }
  }
  ...
  var ai = new Me('history'),
    ci = new Me('closeHistory');
  function li(t, e) {
    var n = ai.getState(t);
    return !(!n || 0 == n.done.eventCount || (e && ri(n, t, e, !1), 0));
  }
  function pi(t, e) {
    var n = ai.getState(t);
    return !(!n || 0 == n.undone.eventCount || (e && ri(n, t, e, !0), 0));
  }
  function hi(t, e) {
    return (
      !t.selection.empty &&
  ...
  function mi(t, e) {
    var n,
      ...
      o = r instanceof se;
    if (o) {
      if (r.node.isTextblock || !Vt(t.doc, r.from)) return !1;
      n = r.from;
    ...
    if (e) {
      ...
      o &&
        i.setSelection(
          se.create(i.doc, n - t.doc.resolve(n).nodeBefore.nodeSize),
        ),
        e(i.scrollIntoView());
    }
    return !0;
  ...
  function vi(t, e) {
    var n,
      r = t.selection;
    if (r instanceof se) {
      if (r.node.isTextblock || !Vt(t.doc, r.to)) return !1;
      n = r.to;
  ...
  function wi(t, e) {
    ...
    var i = r.node(-1),
      s = r.indexAfter(-1),
      a = yi(i.contentMatchAt(s));
    if (!i.canReplaceWith(s, s, a)) return !1;
    if (e) {
      var c = r.after(),
        l = t.tr.replaceWith(c, c, a.createAndFill());
      l.setSelection(ee.near(l.doc.resolve(c), 1)), e(l.scrollIntoView());
    }
    return !0;
  }
  function bi(t, e) {
    ...
    return (
      0 != s &&
      ((n = o.before(s)), e && e(t.tr.setSelection(se.create(t.doc, n))), !0)
    );
  }
  function ki(t, e, n) {
    var r,
    ...
    if (
      c &&
      (r = (i = s.contentMatchAt(s.childCount)).findWrapping(a.type)) &&
      i.matchType(r[0] || a.type).validEnd
    ) {
      if (n) {
        for (
          var l = e.pos + a.nodeSize, p = o.empty, f = r.length - 1;
          f >= 0;
          f--
        )
          p = o.from(r[f].create(null, p));
        p = o.from(s.copy(p));
        var u = t.tr.step(
            new Et(e.pos - 1, l, e.pos, l, new h(p, 1, 0), r.length, !0),
          ),
          d = l + 2 * r.length;
        Vt(u.doc, d) && u.join(d), n(u.scrollIntoView());
      }
      return !0;
    }
    var m = ee.findFrom(e, 1),
      v = m && m.$from.blockRange(m.$to),
      g = v && Rt(v);
    if (null != g && g >= e.depth)
      return n && n(t.tr.lift(v, g).scrollIntoView()), !0;
    if (c && a.isTextblock && fi(s, 'end')) {
      for (var y = s, w = []; w.push(y), !y.isTextblock; ) y = y.lastChild;
      if (y.canReplace(y.childCount, y.childCount, a.content)) {
        if (n) {
          for (var b = o.empty, k = w.length - 1; k >= 0; k--)
            b = o.from(w[k].copy(b));
          n(
            t.tr
              .step(
  ...
  var Oi = Ci(
      ...
      function (t, e, n) {
        ...
        var a = o.nodeBefore;
        if (!a.type.spec.isolating && ki(t, o, e)) return !0;
        if (
          0 == r.parent.content.size &&
          (fi(a, 'end') || se.isSelectable(a))
        ) {
          if (e) {
            var c = t.tr.deleteRange(r.before(), r.after());
            c.setSelection(
              fi(a, 'end')
                ? ee.findFrom(c.doc.resolve(c.mapping.map(o.pos, -1)), -1)
                : se.create(c.doc, o.pos - a.nodeSize),
            ),
              e(c.scrollIntoView());
          }
          return !0;
      ...
      function (t, e, n) {
        ...
        return !(
          ...
          (e &&
            e(
              t.tr
                .setSelection(se.create(t.doc, i.pos - s.nodeSize))
                .scrollIntoView(),
            ),
          0)
        );
    ...
    Ni = Ci(
      ...
      function (t, e, n) {
        ...
        if (!o) return !1;
        var i = o.nodeAfter;
        if (ki(t, o, e)) return !0;
        if (
          0 == r.parent.content.size &&
          (fi(i, 'start') || se.isSelectable(i))
        ) {
          if (e) {
            var s = t.tr.deleteRange(r.before(), r.after());
            s.setSelection(
              fi(i, 'start')
                ? ee.findFrom(s.doc.resolve(s.mapping.map(o.pos)), 1)
                : se.create(s.doc, s.mapping.map(o.pos)),
            ),
              e(s.scrollIntoView());
          }
          return !0;
      ...
      function (t, e, n) {
        ...
        return !(
          !s ||
          !se.isSelectable(s) ||
          (e && e(t.tr.setSelection(se.create(t.doc, i.pos)).scrollIntoView()),
          0)
        );
      },
    ),
    Ti = {
      Enter: Ci(
        ...
        function (t, e) {
          ...
          if (
            ...
            return !1;
          var i = yi(o.parent.contentMatchAt(o.indexAfter()));
          if (!i || !i.isTextblock) return !1;
          if (e) {
            var s = (!r.parentOffset && o.index() < o.parent.childCount ? r : o)
                .pos,
              a = t.tr.insert(s, i.createAndFill());
            a.setSelection(oe.create(a.doc, s + 1)), e(a.scrollIntoView());
          }
          return !0;
        },
        function (t, e) {
        ...
        function (t, e) {
          ...
          if (e) {
            var s = i.parentOffset == i.parent.content.size,
              a = t.tr;
            (t.selection instanceof oe || t.selection instanceof ce) &&
              a.deleteSelection();
            var c =
                0 == r.depth
                  ? null
                  : yi(r.node(-1).contentMatchAt(r.indexAfter(-1))),
              l = s && c ? [{ type: c }] : null,
              p = Bt(a.doc, a.mapping.map(r.pos), 1, l);
            l ||
              p ||
              !Bt(a.doc, a.mapping.map(r.pos), 1, c && [{ type: c }]) ||
              ((l = [{ type: c }]), (p = !0)),
              p &&
                (a.split(a.mapping.map(r.pos), 1, l),
                s ||
                  r.parentOffset ||
                  r.parent.type == c ||
                  !r
                    ...
                    .canReplace(
                      r.index(-1),
                      r.indexAfter(-1),
                      o.from([c.create(), r.parent]),
                    ) ||
                  a.setNodeMarkup(a.mapping.map(r.before()), c)),
              e(a.scrollIntoView());
          }
          return !0;
        },
      ...
      'Mod-Delete': Ni,
      'Mod-a': function (t, e) {
        return e && e(t.tr.setSelection(new ce(t.doc))), !0;
      },
    },
    Di = {
      'Ctrl-h': Ti.Backspace,
      'Alt-Backspace': Ti['Mod-Backspace'],
      'Ctrl-d': Ti.Delete,
      'Ctrl-Alt-Backspace': Ti['Mod-Delete'],
      'Alt-Delete': Ti['Mod-Delete'],
      'Alt-d': Ti['Mod-Delete'],
    };
  for (var Ei in Ti) Di[Ei] = Ti[Ei];
  var Ai = (
    'undefined' != typeof navigator
      ? /Mac/.test(navigator.platform)
      : 'undefined' != typeof os && 'darwin' == os.platform()
  )
    ? Di
    : Ti;
  var Ii = function (t, e) {
  ...
  (Ii.prototype.destroy = function () {
    ...
    (Ii.prototype.setCursor = function (t) {
      t != this.cursorPos &&
        ((this.cursorPos = t),
        null == t
    ...
    (Ii.prototype.updateOverlay = function () {
      var t,
      ...
      var a,
        c,
        l = this.editorView.dom.offsetParent;
      if (
        (this.element ||
          ...
          (this.element.style.cssText =
            ...
            this.color)),
        !l || (l == document.body && 'static' == getComputedStyle(l).position))
      )
    ...
    (Ii.prototype.scheduleRemoval = function (t) {
      var e = this;
    ...
    (Ii.prototype.dragover = function (t) {
    ...
    (Ii.prototype.dragend = function () {
      this.scheduleRemoval(20);
    }),
    (Ii.prototype.drop = function () {
      this.scheduleRemoval(20);
    }),
    (Ii.prototype.dragleave = function (t) {
  ...
  (Ri.prototype.visible = !1), ee.jsonID('gapcursor', Ri);
  var zi = function (t) {
    this.pos = t;
  };
  (zi.prototype.map = function (t) {
    return new zi(t.map(this.pos));
  }),
    (zi.prototype.resolve = function (t) {
      var e = t.resolve(this.pos);
      return Ri.valid(e) ? new Ri(e) : ee.near(e);
    });
  var Pi = Wo({
  ...
  function Bi(t, e) {
    ...
    return function (t, r, o) {
      ...
      var c = Ri.findFrom(s, e, a);
      return !!c && (r && r(t.tr.setSelection(new Ri(c))), !0);
    };
  }
  function Vi() {
    var t = arguments[0];
    ...
    if (n && 'object' == typeof n && null == n.nodeType && !Array.isArray(n)) {
      for (var r in n)
        if (Object.prototype.hasOwnProperty.call(n, r)) {
          var o = n[r];
          'string' == typeof o ? t.setAttribute(r, o) : null != o && (t[r] = o);
        }
      e++;
    }
    for (; e < arguments.length; e++) $i(t, arguments[e]);
    return t;
  }
  function $i(t, e) {
  ...
  Li.prototype.render = function (t) {
        ...
        ? (function (t) {
            ...
            if (((e.className = Fi), t.path)) {
              ...
              document.getElementById(n) ||
                (function (t, e) {
                  var n = document.getElementById(Fi + '-collection');
                  n ||
                    (((n = document.createElementNS(qi, 'svg')).id =
                      Fi + '-collection'),
                    (n.style.display = 'none'),
                    document.body.insertBefore(n, document.body.firstChild));
                  var r = document.createElementNS(qi, 'symbol');
                  (r.id = t),
                    r.setAttribute(
                      'viewBox',
                    ...
                    r
                      .appendChild(document.createElementNS(qi, 'path'))
                      .setAttribute('d', e.path),
                    n.appendChild(r);
                })(n, t);
              var r = e.appendChild(document.createElementNS(qi, 'svg'));
              (r.style.width = t.width / t.height + 'em'),
                r
                  .appendChild(document.createElementNS(qi, 'use'))
                  .setAttributeNS(
                    'http://www.w3.org/1999/xlink',
                    'href',
                    /([^#]*)/.exec(document.location)[1] + '#' + n,
                  );
            } else
              t.dom
                ? e.appendChild(t.dom.cloneNode(!0))
    ...
    return (
      ...
      n.addEventListener('mousedown', function (r) {
        r.preventDefault(),
          n.classList.contains(_i + '-disabled') ||
      ...
      }),
      {
        ...
        update: function (t) {
          ...
          var o = !0;
          if (
            (e.enable && ((o = e.enable(t) || !1), is(n, _i + '-disabled', !o)),
            e.active)
          ) {
  ...
  var Ji = { time: 0, node: null };
  function Wi(t) {
    (Ji.time = Date.now()), (Ji.node = t.target);
  }
  function Ki(t) {
    return Date.now() - 100 < Ji.time && Ji.node && t.contains(Ji.node);
  }
  var Hi = function (t, e) {
  ...
  function Ui(t, e) {
    for (var n = [], r = [], o = 0; o < t.length; o++) {
      var i = t[o].render(e),
        s = i.dom,
        a = i.update;
      n.push(Vi('div', { class: _i + '-dropdown-item' }, s)), r.push(a);
    }
    return { dom: n, update: Gi(r, n) };
  }
  function Gi(t, e) {
    return function (n) {
  ...
  (Hi.prototype.render = function (t) {
    var e = this,
      ...
      r = Vi(
        'div',
        {
          class: _i + '-dropdown ' + (this.options.class || ''),
          style: this.options.css,
        },
        ji(t, this.options.label),
      );
    this.options.title && r.setAttribute('title', ji(t, this.options.title));
    var o = Vi('div', { class: _i + '-dropdown-wrap' }, r),
      i = null,
      s = null,
      a = function () {
        i &&
    ...
    (Hi.prototype.expand = function (t, e) {
      var n = Vi(
          'div',
          { class: _i + '-dropdown-menu ' + (this.options.class || '') },
          e,
        ),
        r = !1;
      return (
  ...
  Xi.prototype.render = function (t) {
    var e = Ui(this.content, t),
      n = Vi(
        'div',
        { class: _i + '-submenu-label' },
        ji(t, this.options.label),
      ),
      r = Vi(
        'div',
        { class: _i + '-submenu-wrap' },
        n,
        Vi('div', { class: _i + '-submenu' }, e.dom),
      ),
      o = null;
    return (
      n.addEventListener('mousedown', function (t) {
        t.preventDefault(),
          Wi(t),
          is(r, _i + '-submenu-wrap-active'),
          o ||
            window.addEventListener(
              'mousedown',
              (o = function () {
                Ki(r) ||
                  (r.classList.remove(_i + '-submenu-wrap-active'),
  ...
  var ss = 'ProseMirror-menubar',
    as = function (t, e) {
      var n = this;
      (this.editorView = t),
        (this.options = e),
        (this.wrapper = Vi('div', { class: ss + '-wrapper' })),
        (this.menu = this.wrapper.appendChild(Vi('div', { class: ss }))),
        (this.menu.className = ss),
        (this.spacer = null),
      ...
      var r = (function (t, e) {
          for (
            ...
            for (var s = e[i], a = [], c = [], l = 0; l < s.length; l++) {
              var p = s[l].render(t),
                h = p.dom,
                f = p.update,
                u = Vi('span', { class: _i + 'item' }, h);
              n.appendChild(u), c.push(u), a.push(f);
            }
            a.length &&
              (r.push(Gi(a, c)),
              i < e.length - 1 &&
                o.push(n.appendChild(Vi('span', { class: _i + 'separator' }))));
          }
          return {
            dom: n,
            update: function (t) {
        ...
        })(this.editorView, this.options.content),
        o = r.dom,
        i = r.update;
      if (
        ...
        (this.scrollFunc = function (t) {
          ...
          (e.body || e).contains(n.wrapper)
            ? n.updateFloat(t.target.getBoundingClientRect && t.target)
  ...
  (as.prototype.update = function () {
    ...
    (as.prototype.updateScrollCursor = function () {
    ...
    (as.prototype.updateFloat = function (t) {
      var e = this.wrapper,
  ...
  function ds(t, e, n, r) {
    return new cs(t, function (t, o, i, s) {
  ...
  function ms(t, e, n) {
    return new cs(t, function (t, r, o, i) {
  ...
  function gs(t) {
    ...
    (s.type = 'submit'), (s.className = vs + '-submit'), (s.textContent = 'OK');
    var a = document.createElement('button');
    (a.type = 'button'),
      (a.className = vs + '-cancel'),
  ...
  (ws.prototype.read = function (t) {
    ...
    (ws.prototype.validateType = function (t) {}),
    (ws.prototype.validate = function (t) {
      return !t && this.options.required
        ? 'Required field'
        : this.validateType(t) ||
            (this.options.validate && this.options.validate(t));
    }),
    (ws.prototype.clean = function (t) {
  ...
  function Cs(t, e) {
    return xs(Eo(t, e.attrs), e);
  }
  var Os = 'undefined' != typeof navigator && /Mac/.test(navigator.platform);
  const Ns = new et({
    nodes:
      ((Ts = xo.spec.nodes),
      (Ds = 'block'),
      Ts.append({
        ordered_list: Do(Oo, { content: 'list_item+', group: Ds }),
        bullet_list: Do(No, { content: 'list_item+', group: Ds }),
        list_item: Do(To, { content: 'paragraph block*' }),
      })),
    marks: xo.spec.marks,
  });
  var Ts, Ds, Es, As, Is;
  window.view = new ao(document.querySelector('#editor'), {
    state: ge.create({
      doc: rt.fromSchema(Ns).parse(document.querySelector('#content')),
      plugins:
        ((Es = { schema: Ns }),
        (As = [
          (function (t) {
            var e,
              n = us.concat(fs, hs);
            return (
              (e = t.nodes.blockquote) && n.push(ds(/^\s*>\s$/, e)),
              ...
              (e = t.nodes.heading) &&
                n.push(
                  (function (t, e) {
                    return ms(new RegExp('^(#{1,6})\\s$'), t, function (t) {
                  ...
                  n = new ke({
                    state: {
                      ...
                      apply: function (t, e) {
                        return (
                          t.getMeta(this) ||
                          (t.selectionSet || t.docChanged ? null : e)
                        );
                      },
                    },
                    props: {
                      handleTextInput: function (t, r, o, i) {
                        return ls(t, r, o, i, e, n);
                      },
                      handleDOMEvents: {
                        compositionend: function (t) {
                          setTimeout(function () {
                            var r = t.state.selection.$cursor;
                            r && ls(t, r.pos, r.pos, '', e, n);
                          });
                        },
                      },
                    },
          ...
          Jo(
            (function (t, e) {
              ...
              if (
                ...
                s('Alt-ArrowUp', mi),
                s('Alt-ArrowDown', vi),
                s('Mod-BracketLeft', gi),
                s('Escape', bi),
                (n = t.marks.strong) && (s('Mod-b', Mi(n)), s('Mod-B', Mi(n))),
                (n = t.marks.em) && (s('Mod-i', Mi(n)), s('Mod-I', Mi(n))),
                (n = t.marks.code) && s('Mod-`', Mi(n)),
                (n = t.nodes.bullet_list) && s('Shift-Ctrl-8', Eo(n)),
                (n = t.nodes.ordered_list) && s('Shift-Ctrl-9', Eo(n)),
                (n = t.nodes.blockquote) && s('Ctrl->', xi(n)),
                (n = t.nodes.hard_break))
              ) {
                var a = n,
                  c = Ci(wi, function (t, e) {
                    return (
                      e(t.tr.replaceSelectionWith(a.create()).scrollIntoView()),
                      !0
                    );
                  });
                s('Mod-Enter', c),
              ...
              if (
                  ...
                  (s(
                    ...
                    function (t, e) {
                      var n = t.selection,
                        ...
                        s = n.$to,
                        a = n.node;
                      if ((a && a.isBlock) || i.depth < 2 || !i.sameParent(s))
                        return !1;
                      var c = i.node(-1);
                      ...
                      if (
                        ...
                        if (e) {
                          for (
                            ...
                            l = o.from(i.node(f).copy(l));
                          l = l.append(o.from(r.createAndFill()));
                          var u = t.tr.replace(
                            i.before(p ? null : -1),
                            i.after(-3),
                            new h(l, p ? 3 : 2, 2),
                          ...
                          u.setSelection(
                            t.selection.constructor.near(
                              u.doc.resolve(i.pos + (p ? 3 : 2)),
                            ),
                          ),
                            e(u.scrollIntoView());
                        }
                      ...
                      var d =
                          s.pos == i.end()
                            ? c.contentMatchAt(0).defaultType
                            : null,
                        m = t.tr.delete(i.pos, s.pos),
                        v = d && [null, { type: d }];
                      return (
                        !!Bt(m.doc, i.pos, 2, v) &&
                        (e && e(m.split(i.pos, 2, v).scrollIntoView()), !0)
                      );
                    }),
                  ),
                  s(
                            ...
                            (i.node(a.depth - 1).type == t
                              ? (function (t, e, n, r) {
                                  ...
                                  return (
                                    ...
                                    e(i.lift(r, Rt(r)).scrollIntoView()),
                                    !0
                                  );
                                })(e, n, t, a)
                              : (function (t, e, n) {
                                  ...
                                  if (
                                    !d.canReplace(
                                      m + (f ? 0 : 1),
                                      m + 1,
                                      p.content.append(u ? o.empty : o.from(i)),
                                    )
                                  )
                                    return !1;
                                  var v = l.pos,
                  ...
                  s(
                    ...
                    (function (t) {
                      return function (e, n) {
                        ...
                        if (n) {
                          var f = p.lastChild && p.lastChild.type == l.type,
                            u = o.from(f ? t.create() : null),
                            d = new h(
                              o.from(
                                t.create(null, o.from(l.type.create(null, u))),
                              ),
                              f ? 3 : 1,
                              0,
                            ),
                          ...
                          n(
                            e.tr
                              .step(new Et(m - (f ? 3 : 1), v, m, v, d, 1, !0))
                              .scrollIntoView(),
                          );
                        }
                        return !0;
                ...
                (n = t.nodes.paragraph) && s('Shift-Ctrl-0', Si(n)),
                (n = t.nodes.code_block) && s('Shift-Ctrl-\\', Si(n)),
                (n = t.nodes.heading))
              )
                for (var l = 1; l <= 6; l++)
                  s('Shift-Ctrl-' + l, Si(n, { level: l }));
              if ((n = t.nodes.horizontal_rule)) {
                var p = n;
                s('Mod-_', function (t, e) {
                  return (
                    e(t.tr.replaceSelectionWith(p.create()).scrollIntoView()),
                    !0
                  );
                });
              }
              return i;
            })(Es.schema, Es.mapKeys),
          ),
          Jo(Ai),
          (function (t) {
            return (
          ...
          new ke({
            props: {
              decorations: function (t) {
                if (!(t.selection instanceof Ri)) return null;
                var e = document.createElement('div');
                return (
                  (e.className = 'ProseMirror-gapcursor'),
                  Xr.create(t.doc, [
                    Kr.widget(t.selection.head, e, { key: 'gapcursor' }),
                  ])
                );
              },
              createSelectionBetween: function (t, e, n) {
                if (e.pos == n.pos && Ri.valid(n)) return new Ri(n);
              },
              handleClick: function (t, e, n) {
                if (!t.editable) return !1;
                var r = t.state.doc.resolve(e);
                if (!Ri.valid(r)) return !1;
                var o = t.posAtCoords({ left: n.clientX, top: n.clientY })
                  .inside;
                return !(
                  (o > -1 && se.isSelectable(t.state.doc.nodeAt(o))) ||
                  (t.dispatch(t.state.tr.setSelection(new Ri(r))), 0)
                );
              },
              handleKeyDown: Pi,
            },
              ...
              content:
                ...
                (function (t) {
                  ...
                  if (
                          ...
                          run: function (t, e, r) {
                            ...
                            gs({
                              ...
                              fields: {
                                ...
                                title: new bs({ label: 'Title' }),
                              },
                              callback: function (t) {
                                Mi(n, t)(r.state, r.dispatch), r.focus();
                              },
                            });
                          },
                        }))),
                    ...
                    (e = t.nodes.bullet_list) &&
                      (o.wrapBulletList = Cs(e, {
                        title: 'Wrap in bullet list',
                        icon: Yi.bulletList,
                      })),
                    (e = t.nodes.ordered_list) &&
                      (o.wrapOrderedList = Cs(e, {
                        title: 'Wrap in ordered list',
                        icon: Yi.orderedList,
                      })),
                    (e = t.nodes.blockquote) &&
                      (o.wrapBlockQuote = (function (t, e) {
                        var n = {
                          run: function (n, r) {
                            return xi(t, e.attrs)(n, r);
                          },
                          select: function (n) {
                            return xi(
                              t,
                              e.attrs instanceof Function ? null : e.attrs,
                            )(n);
                          },
                        };
                        for (var r in e) n[r] = e[r];
                    ...
                    (e = t.nodes.paragraph) &&
                      (o.makeParagraph = rs(e, {
                        title: 'Change to paragraph',
                        label: 'Plain',
                      })),
                    (e = t.nodes.code_block) &&
                      (o.makeCodeBlock = rs(e, {
                  ...
                  if ((e = t.nodes.horizontal_rule)) {
                    ...
                    o.insertHorizontalRule = new Li({
                      ...
                      run: function (t, e) {
                        e(t.tr.replaceSelectionWith(s.create()));
                      },
                    });
                  }
                  var a = function (t) {
        ...
        !1 !== Es.history &&
          As.push(
            ((Is = {
              depth: (Is && Is.depth) || 100,
              newGroupDelay: (Is && Is.newGroupDelay) || 500,
            }),
            new ke({
              key: ai,
              state: {
                init: function () {
                  return new Zo(Yo.empty, Yo.empty, null, 0);
                },
                apply: function (t, e, n) {
                  return (function (t, e, n, r) {
                    ...
                    n.getMeta(ci) && (t = new Zo(t.done, t.undone, null, 0));
                    var s = n.getMeta('appendedTransaction');
                    if (0 == n.steps.length) return t;
                    if (s && s.getMeta(ai))
                      return s.getMeta(ai).redo
                        ? new Zo(
                            t.done.addTransform(n, null, r, si(e)),
                            t.undone,
                            ei(n.mapping.maps[n.steps.length - 1]),
                            t.prevTime,
                          )
                        : new Zo(
                            t.done,
                            t.undone.addTransform(n, null, r, si(e)),
                            null,
                            t.prevTime,
                          );
                    if (
                    ...
                    return new Zo(
                      t.done.addTransform(
                        n,
                        a ? e.selection.getBookmark() : null,
                        r,
                        si(e),
                      ),
                      Yo.empty,
