(() => {
  ...
  (R.nodeSize.get = function () {
    ...
    (I.prototype.check = function () {
      ...
      for (var t = l.none, e = 0; e < this.marks.length; e++)
  ...
  (pt.top.get = function () {
    ...
    (lt.prototype.ignoreFallback = function (t) {
      'BR' != t.nodeName ||
    ...
    for (var s = 1; s <= (0 == n.openStart && n.size ? 2 : 1); s++)
      for (var a = r.depth; a >= 0; a--) {
        ...
        if (1 == s) h = p.canReplace(l, l, o);
          ...
          var f = p.contentMatchAt(l).findWrapping(o.firstChild.type);
          h = f && p.canReplaceWith(l, l, f[0]);
        }
  ...
  function Qe(t, e) {
    ...
    if (Ce.safari)
      for (var f = p; o && f; f = Ie(f)) f.draggable && (o = i = null);
    if (
      ((p = (function (t, e) {
        var n = t.parentNode;
        return n &&
  ...
  (pn.prototype.matchesWidget = function () {
    ...
    (pn.prototype.setSelection = function (t, e, n, r) {
      ...
      if (
        ...
        var g = f.focusNode.childNodes[f.focusOffset];
      ...
      if (
        ...
        if ((f.extend || t == e) && !u) {
          ...
          try {
            t != e && f.extend(h.node, h.offset), (y = !0);
          } catch (t) {
  ...
  (gr.prototype.flushSoon = function () {
    ...
    (gr.prototype.registerMutation = function (t, e) {
      ...
      if ('childList' == t.type) {
        ...
        var p = o && o.parentNode == t.target ? Ae(o) + 1 : 0,
          h = n.localPosFromDOM(t.target, p, -1),
          f =
            i && i.parentNode == t.target ? Ae(i) : t.target.childNodes.length;
        return { from: h, to: n.localPosFromDOM(t.target, f, 1) };
      }
  ...
  var Ar = function (t, e, n, r) {
    ...
    ((o.type.spec.draggable && !1 !== o.type.spec.selectable) ||
      (p instanceof se && p.from <= i && p.to > i)) &&
      (this.mightDrag = {
        node: o,
        pos: i,
                ...
                if (e < 0) {
                  ...
                  if (!w) {
                    if (
                      ...
                      if (
                        ((Ce.ios && t.lastIOSEnter > Date.now() - 225) ||
                          Ce.android) &&
                        i.some(function (t) {
    ...
    (ao.prototype.updateStateInner = function (t, e) {
      ...
      if (i) {
        ...
        var w =
          ...
          h.$anchor.start(u) != f.$anchor.start(u));
        if (p) {
          var b = Ce.chrome
      ...
      if ((this.updatePluginViews(r), 'reset' == l)) this.dom.scrollTop = 0;
        ...
        this.someProp('handleScrollToSelection', function (t) {
          ...
          (t.selection instanceof se
            ...
            : We(this, this.coordsAtPos(t.selection.head, 1), k));
      } else
        y &&
          ((m = (d = y).refDOM),
          (v = d.refTop),
        ...
        function (t, e) {
          ...
          if (e) {
            ...
            if (
              (c ||
                l ||
                !Bt(s.doc, s.mapping.map(r.pos), 1, a && [{ type: a }]) ||
                ((c = [{ type: a }]), (l = !0)),
              l &&
              ...
              var p = s.mapping.map(r.before()),
                h = s.doc.resolve(p);
              r.parent.canReplaceWith(h.index(), h.index() + 1, a) &&
  ...
  window.view = new ao(document.querySelector('#editor'), {
    ...
    dispatchTransaction(t) {
      console.log('tr.selectionSet', t.selectionSet),
        console.log('tr.storedMarks', t.storedMarks),
        console.log('tr.storedMarksSet', t.storedMarksSet),
        console.log('tr.meta', t.meta);
      const e = view.state.apply(t);
      window.view.updateState(e);
    },
  });
})();
