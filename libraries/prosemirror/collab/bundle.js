(() => {
    ...
    (so.prototype.updateStateInner = function (t, e) {
      ...
      if (i) {
        ...
        !(
          ...
          ((l = this),
          (f = l.docView.domFromPos(l.state.selection.anchor, 0)),
          (u = l.root.getSelection()),
  ...
  const fo = 'prosemirror-collab-sample',
    uo = 'init',
    mo = 'sync-doc',
    vo = 'edit-step',
    go = 'sync-steps';
  function yo(t) {
    return wo(rt.fromSchema(Mt).parse(t));
  }
  function wo(t) {
    return ge.create({ schema: Mt, doc: t });
  }
  class bo {
    constructor(t) {
      (this.doc = t), (this.steps = []), (this.stepClientIDs = []);
    }
    get version() {
              ...
              (function (n) {
                if (n.type === mo) {
                  const e = (function (t) {
                    ...
                    return (e.innerHTML = t), yo(e);
                  })(n.serializedDoc);
                  o.updateState(e), (t = n.version);
                }
                if (n.type === go) {
                  const i = e
                    .map(function (t) {
                  ...
                  i.forEach(function (t) {
                    ...
                    n.steps
                      .map(function (t) {
                        return Bt.fromJSON(Mt, t);
                      })
                      .forEach(function (t) {
                        s = t.apply(s).doc;
                      });
                  const a = wo(s);
                  o.updateState(a), (t = n.version);
                }
              })(n.data.data);
          });
        let t = 0,
          e = [];
        const n = yo(document.querySelector('#content'));
        let r = n.doc;
        const o = new so(document.querySelector('#editor'), {
          state: n,
          dispatchTransaction(s) {
            r = o.state.doc;
            const a = o.state.apply(s);
            o.updateState(a),
              s.steps.length &&
                ((e = s.steps),
                (r = n.doc),
                i({
                  type: vo,
                  version: t,
                  steps: e.map((t) => t.toJSON()),
                  clientID: window.name,
                }));
          },
        });
        function i(t) {
          window.opener.postMessage({ type: fo, data: t }, location.origin);
        }
        i({ type: uo });
      })()
    : (function () {
        let t = 0;
        const e = [],
          n = document.querySelector('#open-a-new-editor');
        n.removeAttribute('hidden'),
          n.addEventListener('click', function () {
            const n = window.open(location.href, 'replica-' + t++);
            e.push(n);
          }),
          window.addEventListener('message', function (t) {
            t.data.type === fo &&
              (function ({ type: t, version: e, steps: n, clientID: r }) {
                if (t === uo) {
                  const t = dt.fromSchema(Mt).serializeFragment(i.doc),
                    e = document.createElement('div');
                  e.appendChild(t),
                    s({
                      type: mo,
                      serializedDoc: e.innerHTML,
                      version: i.version,
                    });
                }
                if (t === vo) {
                  const t = n.map((t) => Bt.fromJSON(Mt, t));
                  if (i.receiveSteps(e, t, r)) {
                    const t = wo(i.doc);
                    o.updateState(t),
                      s({ type: go, steps: n, version: i.version });
                  }
                }
              })(t.data.data);
          });
        const r = yo(document.querySelector('#content')),
          o = new so(document.querySelector('#editor'), {
            state: r,
            editable: function () {
              return !1;
            },
          }),
          i = new bo(o.state.doc);
        function s(t) {
          e.forEach(function (e) {
            e.postMessage({ type: fo, data: t }, location.origin);
          });
        }
      })();
})();
