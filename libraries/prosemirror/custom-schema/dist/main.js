(() => {
      ...
      for (var g = n.openStart; g >= 0; g--) {
        ...
        if (w)
          for (var b = 0; b < i.length; b++) {
            ...
            var S = r.node(k - 1),
              O = r.index(k - 1);
            if (S.canReplaceWith(O, O, w.type, w.marks))
              return this.replace(
                r.before(k),
                x ? o.after(k) : e,
  ...
  (Se.prototype.get = function (t) {
    ...
    (Se.prototype.getState = function (t) {
      return t[this.key];
    });
  var Oe = {};
  ...
  function Sn(t, e, n) {
    ...
    for (var r = n ? xn[0] : new kn(), o = [r], i = 0; i < t.length; i++) {
  ...
  function Cn(t, e, n) {
    return On(t, t, xn, Sn(e, n, 1 != t.nodeType));
  }
  function Nn(t, e) {
    if (t.length != e.length) return !1;
  ...
  (vr.prototype.flushSoon = function () {
    ...
    (vr.prototype.registerMutation = function (t, e) {
      ...
      if ('childList' == t.type) {
        ...
        for (
          var h = r && r.parentNode == t.target ? Ee(r) + 1 : 0,
            p = n.localPosFromDOM(t.target, h, -1),
            l =
        ...
        return { from: p, to: n.localPosFromDOM(t.target, l, 1) };
      }
  ...
  for (var $r in ((yr.dragstart = function (t, e) {
    ...
    if ((n && n.done(), e.dataTransfer)) {
      var r = t.state.selection,
        o = r.empty ? null : t.posAtCoords(Sr(e));
              ...
              return (function (t, e, n, r, i) {
                if (e < 0) {
                  ...
                  var k,
                    ...
                    O = x.sameParent(S) && x.parent.inlineContent;
                  if (
                    ((Oe.ios &&
                      t.lastIOSEnter > Date.now() - 225 &&
                      (!O ||
