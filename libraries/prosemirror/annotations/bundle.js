(() => {
  ...
  var Vt = (function (t) {
    ...
    return (
      ...
      (e.prototype.apply = function (t) {
        return this.structure && _t(t, this.from, this.to)
  ...
  var $t = (function (t) {
    ...
    return (
      ...
      (e.prototype.apply = function (t) {
        if (
          this.structure &&
          (_t(t, this.from, this.gapFrom) || _t(t, this.gapTo, this.to))
        )
  ...
  function Lt(t, e, n) {
    for (var r = [], i = 0; i < t.childCount; i++) {
      var s = t.child(i);
      s.content.size && (s = s.copy(Lt(s.content, e, s))),
        s.isInline && (s = e(s, n, i)),
        r.push(s);
    }
    return o.fromArray(r);
  }
  Bt.jsonID('replaceAround', $t),
    (Rt.prototype.lift = function (t, e) {
      ...
      for (var m = o.empty, v = 0, g = i, y = !1; g > e; g--)
        y || r.after(g + 1) < r.end(g)
          ...
          : h++;
      return this.step(
        new $t(c, h, s, a, new l(p.append(m), f, v), p.size - f, !0),
      );
    }),
    (Rt.prototype.wrap = function (t, e) {
      ...
      var i = t.start,
        s = t.end;
      return this.step(new $t(i, s, i, s, new l(n, 0, 0), e.length, !0));
    }),
  ...
  (Kt.depth.get = function () {
    ...
    (Wt.prototype.fit = function () {
      ...
      var c = new l(i, s, a);
      return e > -1
        ? new $t(r.pos, e, this.$to.pos, this.$to.end(), c, n)
  ...
  function le(t, e, n) {
    ...
    if (!(r < e)) {
      var o,
        i = t.steps[r];
      (i instanceof Vt || i instanceof $t) &&
  ...
  var ke = function (t) {
    (this.props = {}),
      ...
      (this.spec = t),
      (this.key = t.key ? t.key.key : xe('plugin'));
  };
  ...
  function xe(t) {
    return t in Se ? t + '$' + ++Se[t] : ((Se[t] = 0), t + '$');
  }
  var Oe = function (t) {
    void 0 === t && (t = 'key'), (this.key = xe(t));
  };
  ...
  if ('undefined' != typeof navigator && 'undefined' != typeof document) {
    var Ce = /Edge\/(\d+)/.exec(navigator.userAgent),
      Ne = /MSIE \d/.test(navigator.userAgent),
      De = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
    Me.mac = /Mac/.test(navigator.platform);
    var Te = (Me.ie = !!(Ne || De || Ce));
    (Me.ie_version = Ne
      ...
      ? +Ce[1]
      : null),
      (Me.gecko = !Te && /gecko\/(\d+)/i.test(navigator.userAgent)),
      (Me.gecko_version =
        Me.gecko && +(/Firefox\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1]);
    var Ee = !Te && /Chrome\/(\d+)/.exec(navigator.userAgent);
    (Me.chrome = !!Ee),
      (Me.chrome_version = Ee && +Ee[1]),
      (Me.safari = !Te && /Apple Computer/.test(navigator.vendor)),
      (Me.ios =
        Me.safari &&
        (/Mobile\/\w+/.test(navigator.userAgent) ||
          navigator.maxTouchPoints > 2)),
      (Me.android = /Android \d/.test(navigator.userAgent)),
      (Me.webkit = 'webkitFontSmoothing' in document.documentElement.style),
      (Me.webkit_version =
        Me.webkit &&
  ...
  var Ae = function (t) {
    ...
    ze = null,
    Pe = function (t, e, n) {
      var r = ze || (ze = document.createRange());
      return (
    ...
    Ie = function (t, e, n, r) {
      return n && (Fe(t, e, n, r, -1) || Fe(t, e, n, r, 1));
    },
  ...
  var _e = function (t) {
    var e = t.isCollapsed;
    return (
      e && Me.chrome && t.rangeCount && !t.getRangeAt(0).collapsed && (e = !1),
      e
    );
  };
  function Le(t, e) {
  ...
  function Qe(t, e) {
    ...
    if (!p || !t.dom.contains(1 != p.nodeType ? p.parentNode : p)) {
      ...
      if (!Xe(e, l)) return null;
      if (!(p = Ye(t.dom, e, l))) return null;
    }
    if (
      (Me.safari && p.draggable && (o = i = null),
      (p = (function (t, e) {
        var n = t.parentNode;
        return n &&
  ...
  function en(t, e, n) {
    ...
    if (3 == o.nodeType) {
      ...
      if (
        ...
        var l = Ze(Pe(o, i - 1, i - 1), -1);
        if (l.top == p.top) {
          var f = Ze(Pe(o, i, i + 1), -1);
          if (f.top != p.top) return nn(f, f.left < l.left);
        }
      }
      return p;
    }
    ...
    if (i < Ve(o)) {
      var g = o.childNodes[i],
        y = 3 == g.nodeType ? Pe(g, 0, s ? 0 : 1) : 1 == g.nodeType ? g : null;
      if (y) return nn(Ze(y, -1), !0);
    }
    return nn(Ze(3 == o.nodeType ? Pe(o) : o, -n), n >= 0);
  }
  function nn(t, e) {
  ...
  (pn.prototype.matchesWidget = function () {
    ...
    (ln.beforePosition.get = function () {
      return !1;
    }),
    ...
    (ln.posBefore.get = function () {
      return this.parent.posBeforeChild(this);
    }),
    (ln.posAtStart.get = function () {
      return this.parent ? this.parent.posBeforeChild(this) + this.border : 0;
    }),
    (ln.posAfter.get = function () {
      return this.posBefore + this.size;
    }),
    (ln.posAtEnd.get = function () {
    ...
    (pn.prototype.setSelection = function (t, e, n, r) {
      ...
      if ((Me.gecko || Me.safari) && t == e) {
        ...
        if (3 == d.nodeType)
          (u = m && '\n' == d.nodeValue[m - 1]) &&
            ...
            (p = l = { node: d.parentNode, offset: Ae(d) + 1 });
        else {
      ...
      if (
        r ||
        (u && Me.safari) ||
        !Ie(p.node, p.offset, f.anchorNode, f.anchorOffset) ||
        !Ie(l.node, l.offset, f.focusNode, f.focusOffset)
      ) {
        var g = !1;
        if ((f.extend || t == e) && !u) {
    ...
    (ln.domAtom.get = function () {
      return !1;
    }),
    Object.defineProperties(pn.prototype, ln);
  var fn = [],
    un = (function (t) {
      function e(e, n, r, o) {
        var i,
      ...
      return (
        ...
        (e.prototype.slice = function (t, n, r) {
          var o = e.create(this.parent, this.mark, !0, r),
            i = this.children,
            s = this.size;
          n < s && (i = Rn(i, n, s, r)), t > 0 && (i = Rn(i, 0, t, r));
      ...
      return (
        (e.create = function (t, n, r, o, i, s) {
          ...
          return (
            (l = Nn(l, r, n)),
            p
              ? (c = new bn(t, n, r, o, l, f, u, p, i, s + 1))
              : n.isText
              ? new yn(t, n, r, o, l, u, i)
        ...
        (e.prototype.protectLocalComposition = function (t, e) {
          ...
          if (!this.getDesc(n)) {
            ...
            t.compositionNodes.push(s),
              (this.children = Rn(this.children, r, r + o.length, t, s));
          }
        }),
        ...
        (e.prototype.updateOuterDeco = function (t) {
          if (!Dn(t, this.outerDeco)) {
            var e = 1 != this.nodeDOM.nodeType,
              n = this.dom;
            (this.dom = Mn(
              this.dom,
              this.nodeDOM,
              On(this.outerDeco, this.node, e),
              On(t, this.node, e),
            )),
              this.dom != n &&
  ...
  var xn = [new Sn()];
  function On(t, e, n) {
    if (0 == t.length) return xn;
    for (var r = n ? xn[0] : new Sn(), o = [r], i = 0; i < t.length; i++) {
      var s = t[i].type.attrs;
      if (s)
        for (var a in (s.nodeName && o.push((r = new Sn(s.nodeName))), s)) {
          var c = s[a];
          null != c &&
            (n &&
              1 == o.length &&
              o.push((r = new Sn(e.isInline ? 'span' : 'div'))),
            'class' == a
  ...
  function Nn(t, e, n) {
    return Mn(t, t, xn, On(e, n, 1 != t.nodeType));
  }
  function Dn(t, e) {
    if (t.length != e.length) return !1;
  ...
  function In(t, e) {
    ...
    if ((_n(t, n), Pn(t))) {
      if ((t.domObserver.disconnectSelection(), t.cursorWrapper))
        ...
        !Bn ||
          n instanceof oe ||
          (n.$from.parent.inlineContent || (r = Fn(t, n.from)),
          n.empty || n.$from.parent.inlineContent || (o = Fn(t, n.to))),
                  ...
                  e.addEventListener(
                    ...
                    (t.hideSelectionGuard = function () {
                      (n.anchorNode == r && n.anchorOffset == o) ||
                        ...
                        setTimeout(function () {
                          (Pn(t) && !t.state.selection.visible) ||
                            t.dom.classList.remove('ProseMirror-hideselection');
                        }, 20));
                    }),
                  );
  ...
  var Bn = Me.safari || (Me.chrome && Me.chrome_version < 63);
  function Fn(t, e) {
    ...
    if (Me.safari && i && 'false' == i.contentEditable) return Vn(i);
    if (
      !(
  ...
  function Vn(t) {
    return (
      ...
      Me.safari && t.draggable && ((t.draggable = !1), (t.wasDraggable = !0)),
      t
    );
  }
  function $n(t) {
  ...
  function _n(t, e) {
    if (e instanceof se) {
      ...
      n != t.lastSelectedViewDesc &&
        (Ln(t), n && n.selectNode(), (t.lastSelectedViewDesc = n));
    } else Ln(t);
  }
  function Ln(t) {
    ...
    if (!(Me.mac && n.indexOf('m') > -1)) {
      ...
      return (
        ...
        (se.isSelectable(c)
          ...
          : !!Me.webkit &&
            Wn(t, new oe(t.state.doc.resolve(e < 0 ? h : h + c.nodeSize))))
      );
    }
  }
  function Hn(t) {
  ...
  function Zn(t, e, n) {
    ...
    if (Me.mac && n.indexOf('m') > -1) return !1;
    var o = r.$from,
      i = r.$to;
  ...
  function nr(t) {
    ...
    if ('BR' == t.nodeName && t.parentNode) {
      if (Me.safari && /^(ul|ol)$/i.test(t.parentNode.nodeName)) {
        var n = document.createElement('div');
        return n.appendChild(document.createElement('li')), { skip: n };
      }
      if (
        t.parentNode.lastChild == t ||
        (Me.safari && /^(tr|table)$/i.test(t.parentNode.nodeName))
      )
        return { ignore: !0 };
  ...
  function ir(t, e) {
    ...
    for (
      ...
      l && 1 == l.nodeType && (p = lr[l.nodeName.toLowerCase()]);
                      ...
                      (t.forEach(function (t) {
                        if (s) {
                          ...
                          if (
                            ...
                            s.length &&
                              (s[s.length - 1] = hr(s[s.length - 1], i.length));
                            var o = ar(t, n);
                            s.push(o),
  ...
  function hr(t, e) {
    if (0 == e) return t;
    var n = t.content.replaceChild(t.childCount - 1, hr(t.lastChild, e - 1)),
  ...
  (gr.prototype.flushSoon = function () {
    ...
    (gr.prototype.onSelectionChange = function () {
      if (
        ...
        if (Me.ie && Me.ie_version <= 11 && !this.view.state.selection.empty) {
          var t = this.view.root.getSelection();
          if (
            t.focusNode &&
            Ie(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset)
          )
      ...
      if (this.view.docView && !(this.flushingSoon > -1)) {
        ...
        (r > -1 || n) &&
          ...
          this.view.docView.dirty
            ...
            : this.currentSelection.eq(e) || In(this.view),
    ...
    (gr.prototype.registerMutation = function (t, e) {
      ...
      if ('childList' == t.type) {
        ...
        var o = t.previousSibling,
          i = t.nextSibling;
        if (Me.ie && Me.ie_version <= 11 && t.addedNodes.length)
  ...
  function Nr(t, e, n, r) {
    return (
      Mr(t, 'handleDoubleClickOn', e, n, r) ||
  ...
  function Dr(t, e, n, r) {
    return (
      Mr(t, 'handleTripleClickOn', e, n, r) ||
      ...
      (function (t, e) {
        ...
        if (-1 == e)
          return (
            !!n.inlineContent &&
            (Cr(t, oe.create(n, 0, n.content.size), 'pointer'), !0)
          );
        for (var r = n.resolve(e), o = r.depth + 1; o > 0; o--) {
          var i = o > r.depth ? r.nodeAfter : r.node(o),
            s = r.before(o);
          if (i.inlineContent)
            Cr(t, oe.create(n, s + 1, s + 1 + i.content.size), 'pointer');
          else {
            if (!se.isSelectable(i)) continue;
            Cr(t, se.create(n, s), 'pointer');
          }
          return !0;
        }
      })(t, n)
  ...
  (br.keydown = function (t, e) {
    if (((t.shiftKey = 16 == e.keyCode || e.shiftKey), !Rr(t, e)))
      if (
        (t.domObserver.forceFlush(),
        (t.lastKeyCode = e.keyCode),
        (t.lastKeyCodeTime = Date.now()),
        !Me.ios || 13 != e.keyCode || e.ctrlKey || e.altKey || e.metaKey)
      )
        ...
        (function (t, e) {
          ...
          return 8 == n || (Me.mac && 72 == n && 'c' == r)
            ? tr(t, -1) || Gn(t)
            : 46 == n || (Me.mac && 68 == n && 'c' == r)
            ? tr(t, 1) || Xn(t)
            : 13 == n ||
              27 == n ||
              (37 == n
  ...
  wr.mousedown = function (t, e) {
    ...
    var i = t.posAtCoords(Or(e));
    i &&
      ('singleClick' == o
        ? (t.mouseDown && t.mouseDown.done(),
          (t.mouseDown = new Ar(t, i, e, n)))
        : ('doubleClick' == o ? Nr : Dr)(t, i.pos, i.inside, e)
        ? e.preventDefault()
        : kr(t, 'pointer'));
  };
  ...
  function Rr(t, e) {
    return (
      !!t.composing ||
      (!!(Me.safari && Math.abs(e.timeStamp - t.compositionEndedAt) < 500) &&
    ...
    (Ar.prototype.up = function (t) {
      if (
        ...
        this.view.state.doc != this.startDoc &&
          (e = this.view.posAtCoords(Or(t))),
          this.allowDefault || !e
            ? kr(this.view, 'pointer')
            : (function (t, e, n, r, o) {
                return (
                  Mr(t, 'handleClickOn', e, n, r) ||
                  ...
                  (o
                    ? (function (t, e) {
                        ...
                        return (
                          null != r &&
                          (Cr(t, se.create(t.state.doc, r), 'pointer'), !0)
                        );
                      })(t, n)
                    : (function (t, e) {
                        if (-1 == e) return !1;
            ...
            ? t.preventDefault()
            : this.flushed ||
              (Me.safari && this.mightDrag && !this.mightDrag.node.isAtom) ||
              (Me.chrome &&
  ...
  function Br(t, e) {
    if ((t.domObserver.forceFlush(), Ir(t), e || t.docView.dirty)) {
      var n = zn(t);
      return (
  ...
  (br.compositionstart = br.compositionupdate = function (t) {
    ...
    (br.compositionend = function (t, e) {
      t.composing &&
        ((t.composing = !1), (t.compositionEndedAt = e.timeStamp), Pr(t, 20));
    });
  var Fr = (Me.ie && Me.ie_version < 15) || (Me.ios && Me.webkit_version < 604);
  function Vr(t, e, n, r) {
  ...
  (wr.copy = br.cut = function (t, e) {
    ...
    (br.paste = function (t, e) {
      var n = Fr ? null : e.clipboardData;
      n && Vr(t, n.getData('text/plain'), n.getData('text/html'), e)
        ? e.preventDefault()
        : (function (t, e) {
            if (t.dom.parentNode) {
              var n =
              ...
              n || (r.contentEditable = 'true'),
                ...
                setTimeout(function () {
                  t.focus(),
                    ...
                    n
                      ? Vr(t, r.value, null, e)
                      : Vr(t, r.textContent, r.innerHTML, e);
                }, 50);
            }
          })(t, e);
    });
  var $r = function (t, e) {
    ...
    _r = Me.mac ? 'altKey' : 'ctrlKey';
  for (var Lr in ((wr.dragstart = function (t, e) {
    var n = t.mouseDown;
    if ((n && n.done(), e.dataTransfer)) {
      var r = t.state.selection,
        o = r.empty ? null : t.posAtCoords(Or(e));
      ...
      e.dataTransfer.clearData(),
        e.dataTransfer.setData(Fr ? 'Text' : 'text/html', c.innerHTML),
        (e.dataTransfer.effectAllowed = 'copyMove'),
        Fr || e.dataTransfer.setData('text/plain', h),
        (t.dragging = new $r(s, !e[_r]));
    }
  }),
      ...
      if (r) {
        ...
        if (o) {
          var i =
              ...
              sr(
                t,
                e.dataTransfer.getData(Fr ? 'Text' : 'text/plain'),
  ...
  (wr.beforeinput = function (t, e) {
    if (Me.chrome && Me.android && 'deleteContentBackward' == e.inputType) {
  ...
  (Xr.create = function (t, e) {
    ...
    (Xr.prototype.forChild = function (t, e) {
      ...
      for (
        ...
        var c = this.local[a];
        if (c.from < s && c.to > i && c.type instanceof qr) {
      ...
      if (r) {
        var l = new Xr(r.sort(ro));
        return n ? new Qr([l, n]) : l;
      }
      return n || Yr;
    }),
    ...
    (Xr.prototype.localsInner = function (t) {
      ...
      for (var e = [], n = 0; n < this.local.length; n++)
        this.local[n].type instanceof qr || e.push(this.local[n]);
      return e;
    });
  var Yr = new Xr();
  ...
  var ao = function (t, e) {
      (this._props = e),
        ...
        (this.docView = gn(this.state.doc, ho(this), so(this), this.dom, this)),
                ...
                if (e < 0) {
                  ...
                  if (!w) {
                    if (
                      ...
                      if (
                        ((Me.ios && t.lastIOSEnter > Date.now() - 225) ||
                          Me.android) &&
                        i.some(function (t) {
  ...
  (co.props.get = function () {
    ...
    (ao.prototype.updateStateInner = function (t, e) {
      var n = this,
        ...
        i = !1;
      if (
        (t.storedMarks && this.composing && (Ir(this), (i = !0)),
        (this.state = t),
        e)
      ) {
        var s = fo(this);
      ...
      if (i) {
        ...
        !(
          ...
          (function (t) {
            ...
            return Ie(e.node, e.offset, n.anchorNode, n.anchorOffset);
          })(this)
        )
          ? In(this, w)
                    ...
                    return on(t, e, function () {
                      ...
                      for (
                        ...
                        if (1 == s.nodeType) a = s.getClientRects();
                          ...
                          a = Pe(s, 0, s.nodeValue.length).getClientRects();
                        }
  ...
  function yo(t, e, n) {
    return Kr.inline(
      t,
      e,
      { class: 'annotation-highlight', 'data-id': n.id },
      { annotation: n },
    );
  }
  class wo {
    ...
    annotationsAt(t) {
      return this.decorationSet.find(t + 1, t - 1).map(function (t) {
        return t.spec.annotation;
      });
    }
    findAnnotation(t) {
      const e = this.decorationSet.find();
      for (let n = 0; n < e.length; n++)
        if (e[n].spec.annotation.id === t) return e[n];
    }
    apply(t) {
      const e = t.getMeta(bo),
        n = e?.type;
      if (!e && !t.docChanged) return this;
      let r = this.decorationSet.map(t.mapping, t.doc);
      return (
        n === mo
          ? (r = r.add(t.doc, [yo(e.from, e.to, e.annotation)]))
          : n === vo && (r = r.remove([this.findAnnotation(e.annotation.id)])),
        new wo(r)
      );
    }
  }
  ...
  function ko(t, e, n) {
    ...
    r.classList.add('annotation-tooltip');
    const o = document.createElement('ul');
    return (
      o.classList.add('annotation-tooltip-list'),
      t.forEach(function (t) {
        const r = (function (t, e, n) {
          const r = document.createElement('li');
          r.classList.add('annotation-tooltip-item');
          const o = document.createElement('span');
          o.textContent = t.text;
          const i = document.createElement('button');
          return (
            i.classList.add('annotation-delete-button'),
            (i.title = 'Delete annotation'),
            (i.textContent = 'x'),
            i.addEventListener('click', function () {
              e(n.tr.setMeta(bo, { type: vo, annotation: t }));
            }),
            r.appendChild(i),
            r.appendChild(o),
            r
  ...
  function So(t, e) {
    ...
    n.classList.add('annotation-handle');
    const r = document.createElement('button');
    return (
      r.classList.add('annotation-add-button'),
      (r.textContent = 'Add annotation'),
      r.addEventListener('click', function () {
        const n = prompt('Add annotation');
        if (n) {
          const { selection: r, tr: o } = e;
          (r.annotationAdded = !0),
            o.setSelection(new oe(r.$from)),
            t(
              o.setMeta(bo, {
                type: mo,
                annotation: new go(
                  `0000-${Date.now()}-${Math.floor(
      ...
      new ke({
        props: {
          decorations(t) {
            const e = t.selection;
            if (e.empty) {
              const n = bo.getState(t).annotationsAt(e.from);
              return n.length
                ? Xr.create(t.doc, [Kr.widget(e.from, ko(n, Oo, t))])
                : null;
            }
            if (!e.annotationAdded)
              return Xr.create(t.doc, [Kr.widget(e.from, So(Oo, t))]);
          },
        },
      })),
    ],
    annotations: [{ id: 0, text: '1234567890', from: 111, to: 117 }],
  });
  var Oo;
  const Mo = new ao(document.querySelector('#editor'), { state: xo });
  document
