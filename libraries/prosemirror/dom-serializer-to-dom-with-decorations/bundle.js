(() => {
  ...
  Bt.jsonID('removeMark', Lt),
    ...
    (Rt.prototype.removeMark = function (t, e, n) {
      ...
      return (
        ...
        o.forEach(function (t) {
          return r.step(new Lt(t.from, t.to, t.style));
        }),
        this
      );
    }),
        ...
        if (p) {
          ...
          for (var f = 0; f < c.marks.length; f++)
            e.allowsMarkType(c.marks[f].type) ||
              this.step(new Lt(s, h, c.marks[f]));
  ...
  function $n(t, e) {
    if (e instanceof se) {
      ...
      n != t.lastSelectedViewDesc &&
        (jn(t), n && n.selectNode(), (t.lastSelectedViewDesc = n));
    } else jn(t);
  }
  function jn(t) {
  ...
  var _r = function (t, e) {
    ...
    $r = Me.mac ? 'altKey' : 'ctrlKey';
  for (var jr in ((wr.dragstart = function (t, e) {
    var n = t.mouseDown;
    ...
    (ao.prototype.updateStateInner = function (t, e) {
      ...
      if (i) {
        ...
        !(
          ...
          Ie(w.node, w.offset, b.anchorNode, b.anchorOffset))
        )
          ? In(this, S)
          : ($n(this, t.selection), this.domObserver.setCurSelection()),
      ...
      if ((this.updatePluginViews(r), 'reset' == h)) this.dom.scrollTop = 0;
        ...
        this.someProp('handleScrollToSelection', function (t) {
          ...
          (t.selection instanceof se
            ...
            : We(this, this.coordsAtPos(t.selection.head, 1), O));
      } else
        k &&
          ((m = (d = k).refDOM),
          (v = d.refTop),
    ...
    state: {
      init(t, { doc: e }) {
        const [n, r] = (function (t, e) {
          if (0 >= t.content.content.length)
            throw RangeError('unexpected index');
          let n = 0;
          for (let e = 0; e < 0; e++) n += t.content.content[e].nodeSize;
          return [n, n + t.content.content[0].nodeSize];
        })(e);
        return Xr.create(e, [
          Kr.inline(n + 2, r - 2, { style: 'background: rgb(100, 255, 255)' }),
        ]);
      },
    },
    props: {
  ...
  new ao(document.querySelector('#editor'), { state: mo }),
    setTimeout(function () {
      const t = dt.fromSchema(Mt).serializeFragment(mo.doc);
      console.log('fragment without decorations', t);
      const e = mo.doc.toJSON();
      console.log('json without decorations', e);
    }, 100);
})();
