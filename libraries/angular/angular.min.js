...
(function(W, X, t) {
      ...
      if (P(b))
        for (d in b)
          'prototype' == d ||
            ...
            a.call(c, b[d], d);
      else if (J(b) || Pa(b)) for (d = 0; d < b.length; d++) a.call(c, b[d], d);
  ...
  function bc(b, a) {
    return D(new (D(function() {}, { prototype: b }))(), a);
  }
    ...
    return !P(a) || a instanceof RegExp
      ...
      ? function() {
          return arguments.length
            ? a.apply(b, c.concat(Ba.call(arguments, 0)))
            : a.apply(b, c);
        }
      : function() {
  ...
  function sc(b) {
    ...
    'function' === typeof b
      ? (a = b.$inject) ||
        ...
        (b.$inject = a))
      : J(b)
      ? ((c = b.length - 1), Wa(b[c], 'fn'), (a = b.slice(0, c)))
      : Wa(b, 'fn', !0);
    return a;
  }
      ...
      r(a, function(a) {
        if (!h.get(a)) {
          ...
          try {
            ...
            l.message &&
              (l.stack && -1 == l.stack.indexOf(l.message)) &&
              (l = l.message + '\n' + l.stack),
          ...
          return (
            ...
            d.history
              ? c
                ...
                : (l.pushState(null, '', a), R.attr('href', R.attr('href')))
    ...
    k.cookies = function(a, b) {
      ...
      if (a)
        b === t
          ...
          : v(b) &&
            ((d =
              (m.cookie = escape(a) + '=' + escape(b) + ';path=' + B).length +
              1),
            4096 < d &&
              c.warn(
                "Cookie '" +
    ...
    this.$get = [
      ...
      function(a, b, l, n, p, q, s, F, u, A, N, R) {
                ...
                c
                  ? (c.scope
                    ...
                    (s = c.transcludeOnThisElement
                      ...
                      : null),
                    c(f, l, h, d, s))
                  : f && f(a, h.childNodes, t, e);
          }

          for (var m = [], h, l, q, n, p = 0; p < a.length; p++)
            (h = new Ob()),
              (l = da(a[p], [], h, 0 === p ? d : t, e)),
              (f = l.length ? H(l, a[p], h, b, c, null, [], [], f) : null) &&
                f.scope &&
                ca(h.$$element, 'ng-scope'),
              (h =
        ...
        function da(a, b, c, d, g) {
          ...
          switch (a.nodeType) {
            case 1:
              ...
              for (
                var l, q, n, p = a.attributes, s = 0, F = p && p.length;
                s < F;
                s++
              ) {
                var A = !1,
        ...
        function H(a, c, d, e, f, g, m, n, p) {
          function F(a, b, c, d) {
            if (a) {
              ...
              a.require = G.require;
              a.directiveName = C;
              if (L === G || G.$$isolateScope) a = tc(a, { isolateScope: !0 });
              m.push(a);
            }
            if (b) {
              c && (b = I(b, c, d));
          ...
          function N(a, e, f, g, p) {
            ...
            if (L) {
              var Na = /^\s*([@=&])(\??)\s*(\w*)\s*$/;
              B = e.$new(!0);
              !H || (H !== L && H !== L.$$originalDirective)
                ? M.data('$isolateScopeNoTemplate', B)
                : M.data('$isolateScope', B);
              ...
              try {
                (O = m[g]),
                  O(
                    ...
                    M,
                    u,
                    O.require && A(O.directiveName, O.require, M, da),
                    rb,
                  );
              } catch (G) {
                l(G, ia(M));
          ...
          for (
            var u = -Number.MAX_VALUE,
              ...
              H = p.templateDirective,
              fa = p.nonTlbTranscludeDirective,
              x = !1,
              D = !1,
              K = p.hasElementTranscludeDirective,
              Z = (d.$$element = w(c)),
              G,
              C,
              V,
            ...
            if ((V = G.scope))
              (O = O || G),
                G.templateUrl ||
                  (db('new/isolated scope', L, G, Z), T(V) && (L = G));
            C = G.name;
            !G.templateUrl &&
              G.controller &&
              ((V = G.controller),
              (R = R || {}),
              db("'" + C + "' controller", R[C], G, Z),
              (R[C] = G));
            if ((V = G.transclude))
              (x = !0),
                G.$$tlb || (db('transclusion', fa, G, Z), (fa = G)),
                'element' == V
                  ? ((K = !0),
                    (u = G.priority),
                    (V = Z),
                    (Z = d.$$element = w(
                      X.createComment(' ' + C + ': ' + d[C] + ' '),
                    )),
                    (c = Z[0]),
                    Na(f, Ba.call(V, 0), c),
                    (S = z(V, e, u, g && g.name, {
            ...
            if (G.templateUrl)
              (D = !0),
                ...
                (H = G),
                G.replace && (g = G),
                (N = ue(a.splice(Fa, a.length - Fa), Z, d, f, x && S, m, n, {
              ...
              try {
                (Q = G.compile(Z, d, S)),
                  P(Q) ? F(null, Q, U, Y) : Q && F(Q.pre, Q.post, U, Y);
              } catch (ve) {
                l(ve, ia(Z));
              }
          ...
          if (c.hasOwnProperty(e)) {
            ...
            for (var s = 0, u = e.length; s < u; s++)
              try {
                (p = e[s]),
                  (g === t || g > p.priority) &&
                    -1 != p.restrict.indexOf(f) &&
                    (q && (p = bc(p, { $$start: q, $$end: n })),
                    b.push(p),
                    (h = p));
              } catch (F) {
                l(F);
        ...
        function ue(a, b, c, d, e, f, g, h) {
          ...
          b.empty();
          n.get(A.getTrustedResourceUrl(N), { cache: p })
            .success(function(n) {
              var p, A;
              n = W(n);
              if (u.replace) {
              ...
              for (q = L(b[0].childNodes, e); m.length; ) {
                ...
                if (A !== s) {
                  var B = A.className;
                  (h.hasElementTranscludeDirective && u.replace) || (z = Kb(p));
                  Na(R, w(A), z);
                  ca(w(z), B);
                }
          ...
          return function(a, b, c, d, e) {
            a = e;
            m
              ? (m.push(b), m.push(c), m.push(d), m.push(a))
              : (l.transcludeOnThisElement && (a = O(b, l.transclude, e)),
                l(q, b, c, d, a));
          };
        }
        ...
        Ob.prototype = {
          ...
          $updateClass: function(a, b) {
            var c = uc(a, b),
              d = uc(b, a);
            0 === c.length
              ? N.removeClass(this.$$element, d)
              : 0 === d.length
              ? N.addClass(this.$$element, c)
              : N.setClass(this.$$element, c, d);
          },
        ...
        return function(e, f) {
          ...
          v(e) &&
            ...
            (e = b.hasOwnProperty(k)
              ? b[k]
              : hc(f.$scope, k, !0) || hc(d, k, !0)),
            Wa(e, k, !0));
          g = c.instantiate(e, f);
          if (m) {
            if (!f || 'object' !== typeof f.$scope)
              throw C('$controller')('noscp', k || e.name, m);
            f.$scope[m] = g;
          }
          return g;
        };
    ...
    var b = /^\s*(\[|\{[^\{])/,
      ...
      e = (this.defaults = {
        transformResponse: [
          function(d) {
            v(d) &&
              ((d = d.replace(c, '')), b.test(d) && a.test(d) && (d = cc(d)));
            return d;
          },
        ],
        transformRequest: [
          function(a) {
            return T(a) &&
              '[object File]' !== za.call(a) &&
              '[object Blob]' !== za.call(a)
              ? na(a)
              : a;
          },
        ],
    ...
    this.$get = [
      ...
      function(a, b, c, d, n, p) {
        ...
        function s(c, f, g) {
          function h(a, b, c, e) {
            I &&
              (200 <= a && 300 > a ? I.put(w, [a, b, vc(c), e]) : I.remove(w));
            p(b, a, c, e);
            d.$$phase || d.$apply();
          }
          ...
          r.then(s, s);
          (!c.cache && !e.cache) ||
            (!1 === c.cache || ('GET' !== c.method && 'JSONP' !== c.method)) ||
            (I = T(c.cache) ? c.cache : T(e.cache) ? e.cache : u);
          if (I)
            if (((H = I.get(w)), y(H))) {
          ...
          x(H) &&
            ((H = Pb(c.url)
              ...
              : t) && (g[c.xsrfHeaderName || e.xsrfHeaderName] = H),
            a(
              c.method,
              w,
              f,
  ...
  function ye(b, a, c, d, e) {
    ...
    return function(e, m, h, l, n, p, q, s) {
      ...
      if ('jsonp' == K(e)) {
        ...
        var R = f(
          m.replace('JSON_CALLBACK', 'angular.callbacks.' + N),
          N,
          function(a, b) {
            u(l, a, d[N].data, '', b);
            d[N] = E;
      ...
      function(c, d, e) {
        function f(f, h, l) {
          for (var n, p, q = 0, s = [], F = f.length, u = !1, A = []; q < F; )
            -1 != (n = f.indexOf(b, q)) && -1 != (p = f.indexOf(a, n + g))
              ? (q != n && s.push(f.substring(q, n)),
                s.push((q = c((u = f.substring(n + g, p))))),
                (q.exp = u),
                (q = p + k),
                (u = !0))
              : (q != F && s.push(f.substring(q)), (q = F));
      ...
      function(b, a, c) {
        function d(d, g, k, m) {
          ...
          p.$$intervalId = h(function() {
            ...
            0 < k &&
              q >= k &&
              (n.resolve(q), l(p.$$intervalId), delete e[p.$$intervalId]);
            s || b.$apply();
          }, g);
          e[p.$$intervalId] = n;
          return p;
                ...
                if (h && 0 > h.indexOf('://'))
                  if (((g = '#' + b), '/' == h[0])) g = n + g + h;
                    ...
                    for (var q = 0; q < h.length; q++)
                      '.' != h[q] &&
                        ('..' == h[q] ? l.pop() : h[q].length && l.push(h[q]));
                    g = n + g + l.join('/');
                  }
              }
              l = k.$$rewrite(g);
          ...
          $destroy: function() {
            if (!this.$$destroyed) {
              ...
              this !== p &&
                ...
                (this.$destroy = this.$digest = this.$apply = E),
          ...
          $broadcast: function(a, b) {
            for (
              var c = this,
                ...
                g = [f].concat(Ba.call(arguments, 1)),
                k,
                h;
              (c = d);
  ...
  function ce() {
    this.$get = [
      ...
      function(b, a) {
        var c = {},
          d = U(
            (/android (\d+)/.exec(K((b.navigator || {}).userAgent)) || [])[1],
          ),
        ...
        if (h) {
          ...
          !d ||
            (l && n) ||
            ((l = v(f.body.style.webkitTransition)),
            (n = v(f.body.style.webkitAnimation)));
        }
        return {
  ...
  function Jc(b) {
    ...
    return function(c, e) {
      ...
      for (; e; )
        (m = Ie.exec(e))
          ? ((g = g.concat(Ba.call(m, 1))), (e = g.pop()))
          : (g.push(e), (e = null));
      r(g, function(a) {
        k = Je[a];
        f += k
    ...
    return function(a, c, d) {
      ...
      function f(a, b) {
        var c = typeof a,
          d = typeof b;
        return c == d
          ? (ta(a) && ta(b) && ((a = a.valueOf()), (b = b.valueOf())),
    ...
    var n = function(e) {
      if (!l) {
        ...
        if (Q && 'input' === (e || m).type && a[0].placeholder !== k)
          ...
          ('password' !== h && Ua(c.ngTrim || 'T') && (f = aa(f)),
  ...
  isNaN(Q) &&
    (Q = U((/trident\/.*; rv:(\d+)/.exec(K(navigator.userAgent)) || [])[1]));
  E.$inject = [];
  Qa.$inject = [];
  var J = (function() {
  ...
  var ab = (S.cache = {}),
    ...
    $a = W.document.removeEventListener
      ? function(b, a, c) {
  ...
  r(
    {
      ...
      isolateScope: function(b) {
        return (
          w.data(b, '$isolateScope') || w.data(b, '$isolateScopeNoTemplate')
        );
      },
      controller: oc,
      injector: function(b) {
  ...
  Wb.prototype = {
    ...
    readIdent: function() {
      for (
        var a = this, c = '', d = this.index, e, f, g, k;
    ...
    objectIndex: function(a) {
      ...
      return D(
        function(e, f) {
          ...
          if (!g) return t;
          (g = va(g[k], c.text)) &&
            (g.then && c.options.unwrapPromises) &&
            ((m = g),
            '$$v' in g ||
              ((m.$$v = t),
              m.then(function(a) {
  ...
  var dd = ba({
      ...
      compile: function(a, c) {
        ...
        if (!c.href && !c.xlinkHref && !c.name)
          return function(a, c) {
            var f =
              '[object SVGAnimatedString]' === za.call(c.prop('href'))
                ? 'xlink:href'
                : 'href';
      ...
      return {
        ...
        link: function(d, e, f) {
          var g = a,
            k = a;
          'href' === a &&
            '[object SVGAnimatedString]' === za.call(e.prop('href')) &&
            ((k = 'xlinkHref'), (f.$attr[k] = 'xlink:href'), (g = null));
          f.$observe(c, function(c) {
            c
              ? (f.$set(k, c), Q && g && e.prop(g, f[k]))
              : 'href' === a && f.$set(k, null);
          });
        },
      };
      ...
      function(a, c, d, e, f, g) {
        ...
        this.$setValidity = function(a, c) {
          p[a] !== !c &&
            (c
              ? (p[a] && n--,
                n || (k(!0), (this.$valid = !0), (this.$invalid = !1)))
              : (k(!1), (this.$invalid = !0), (this.$valid = !1), n++),
            (p[a] = !c),
            k(c, a),
      ...
      function(a, c) {
        ...
        return {
          ...
          link: function(e, f, g) {
            ...
            r(g, function(a, c) {
              s.test(c) &&
                (l[K(c.replace('when', '').replace('Minus', '-'))] = f.attr(
                  g.$attr[c],
                ));
            });
            r(l, function(a, e) {
          ...
          link: function(e, g, k, m) {
            ...
            function n(e, f, g) {
              function k() {
                ...
                for (B = 0; (I = E.length), B < I; B++) {
                  ...
                  q
                    ? (d = y(v.remove(x ? x(e, M) : u(e, M))))
                    : (x
                        ? ((d = {}), (d[m] = s), (d = x(e, d) === x(e, M)))
                        : (d = s === u(e, M)),
                      (v = v || d));
                  D = l(e, M);
                  D = y(D) ? D : '';
                ...
                for (E = c.length; M < E; M++) {
                  ...
                  for (I = h.length; B < I; B++)
                    (d = h[B]),
                      (v = t[B + 1])
                        ? ((D = v.element),
                          v.label !== d.label && D.text((v.label = d.label)),
                          v.id !== d.id && D.val((v.id = d.id)),
                          D[0].selected !== d.selected &&
                            (D.prop('selected', (v.selected = d.selected)),
                            Q && D.prop('selected', v.selected)))
                        : ('' === d.id && F
                            ? (K = F)
                            : (K = A.clone())
                                .val(d.id)
                          ...
                          p.addOption(d.label, K),
                          D ? D.after(K) : s.element.append(K),
                          (D = K));
                  for (B++; t.length > B; )
            ...
            if (m[1]) {
              ...
              var q = k.multiple,
                ...
                v = A.clone();
              k = 0;
              for (var z = g.children(), E = z.length; k < E; k++)
                if ('' === z[k].value) {
                  u = F = z.eq(k);
                  break;
                }
