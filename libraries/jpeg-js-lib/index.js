...
const imageDataToBinary1 = async () => {
  ...
  await fse.writeFile('imageDataToBinary1.jpg', jpegImageData.data, {
    encoding: 'binary',
  });
};
...
const imageDataToBinary2 = async () => {
  ...
  console.log(jpegImageData);
  await fse.writeFile('imageDataToBinary2.jpg', jpegImageData.data, {
    encoding: 'binary',
  });
};
...
const imageDataToBinary3 = async () => {
  ...
  console.log(jpegImageData);
  await fse.writeFile('imageDataToBinary3.jpg', jpegImageData.data, {
    encoding: 'binary',
  });
};
...
const imageDataToBinary4 = async () => {
  ...
  console.log(jpegImageData);
  await fse.writeFile('imageDataToBinary4.jpg', jpegImageData.data, {
    encoding: 'binary',
  });
};
...
const imageDataToBase64 = async () => {
  ...
  const jpegDataUri =
    ...
    Base64.btoa(String.fromCharCode.apply(null, jpegImageData.data));
