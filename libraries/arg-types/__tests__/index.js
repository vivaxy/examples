...
const argTypes = {
  ...
  oneOfType: ArgTypes.oneOfType([ArgTypes.string, ArgTypes.number]),
  requiredOneOfType: ArgTypes.oneOfType([ArgTypes.string, ArgTypes.number])
    .isRequired,
...
test('throws on required shape, nested type, required number, string type', (t) => {
  t.throws(() => {
    ArgTypes.check(argTypes, {
      ...object,
      requiredShape: { requiredNumber: '1' },
    });
  }, Error);
});
