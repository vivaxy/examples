...
class Input extends EventEmitter {
    ...
    _getHammer() {
        ...
        hammer.on('panstart', e => {
            this.emit('drag-start', this._getCoordinates(e.center), this._getDistance({
                x: e.deltaX,
                y: e.deltaY
            }));
        });
        ...
        hammer.on('panmove', e => {
            this.emit('drag-move', this._getCoordinates(e.center), this._getDistance({
                x: e.deltaX,
                y: e.deltaY
            }));
        });
        ...
        hammer.on('panend', e => {
            this.emit('drag-end', this._getCoordinates(e.center), this._getDistance({
                x: e.deltaX,
                y: e.deltaY
            }));
        });
