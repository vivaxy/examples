    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      AFRAME.registerComponent('teleport-controls', {
        ...
        init: function () {
          ...
          teleportEntity = this.teleportEntity = document.createElement(
            'a-entity',
          );
        ...
        update: function (oldData) {
          ...
          if (
            !this.line ||
            'curveLineWidth' in diff ||
            'curveNumberPoints' in diff ||
            'type' in diff
          ) {
          ...
          if (data.hitEntity) {
            ...
            !this.hitEntity ||
            'hitCylinderColor' in diff ||
            'hitCylinderHeight' in diff ||
        ...
        tick: (function () {
          ...
          return function (time, delta) {
            ...
            if (this.data.type === 'parabolic') {
              ...
              next = last.add(
                direction.clone().multiplyScalar(this.data.maxLength),
              );
        ...
        queryCollisionEntities: function () {
          ...
          collisionEntities = [].slice.call(
            el.sceneEl.querySelectorAll(data.collisionEntities),
          );
        ...
        onButtonUp: function (evt) {
          ...
          var camPosition = new THREE.Vector3().copy(
            cameraEl.getAttribute('position'),
          );

          var newCamPositionY =
            camPosition.y + this.hitPoint.y - this.prevHeightDiff;
