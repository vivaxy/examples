!(function (t) {
  ...
  function (t, e, n) {
    ...
    function l(t) {
      return (
        t.isRawProperty || t.property.startsWith(E) || t.property.startsWith(w)
      );
    }
    var c = n(1);
    ...
    AFRAME.registerComponent('animation', {
      ...
      init: function () {
        ...
        (this.eventDetail = { name: this.attrName }),
          ...
          (this.targets = {}),
          (this.targetsArray = []),
          (this.updateConfigForDefault = this.updateConfigForDefault.bind(
            this,
          )),
      ...
      updateConfigForDefault: function () {
        ...
        this.waitComponentInitRawProperty(this.updateConfigForDefault) ||
          ...
          (e = 'true' === r || 'false' === r),
          e && ((t = 'true' === a.from ? 1 : 0), (r = 'true' === a.to ? 1 : 0)),
      ...
      waitComponentInitRawProperty: function (t) {
        ...
        return (
          ...
          ((e = f(n.property)[1]),
          !r.components[e] &&
            (r.addEventListener('componentinitialized', function n(i) {
              i.detail.name === e &&
                (t(), r.removeEventListener('componentinitialized', n));
            }),
            !0))
        );
      },
        ...
        function T(t) {
          ...
          function i(t) {
            for (var n = 0, r = {}, i = d.animations, a = i.length; n < a; ) {
              ...
              V[o.type](s.target, o.property, m, r, s.id),
                (o.currentValue = m),
                n++;
            }
          ...
          function s(t) {
            ...
            if (d.children.length) {
              var v = d.children,
                b = v.length;
              if (y >= d.currentTime) for (var A = 0; A < b; A++) v[A].seek(y);
            ...
            return function (e, n, r, i) {
              if (0 <= e && 1 >= e && 0 <= r && 1 >= r) {
                ...
                return function (o) {
                  ...
                  if (0 === o) return 0;
                  if (1 === o) return 1;
                  for (var s = 0, u = 1; 10 !== u && a[u] <= o; ++u) s += 0.1;
                  --u;
        ...
        return (
          ...
          (T.remove = function (t) {
            ...
            for (var e = W.length; e--; )
              for (var n = W[e], r = n.animations, a = r.length; a--; )
