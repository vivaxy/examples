...
function nullFunc_iiiiddd(x) {
  err(
    "Invalid function pointer called with signature 'iiiiddd'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)",
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
function nullFunc_viiiddd(x) {
  err(
    "Invalid function pointer called with signature 'viiiddd'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)",
  );
  err('Build with ASSERTIONS=2 for more info.');
  abort(x);
}
...
var real___GLOBAL__sub_I_mandelbrot_cpp = asm['__GLOBAL__sub_I_mandelbrot_cpp'];
asm['__GLOBAL__sub_I_mandelbrot_cpp'] = function () {
  assert(
    runtimeInitialized,
    'you need to wait for the runtime to be ready (e.g. wait for main() to be called)',
  );
...
var __GLOBAL__sub_I_mandelbrot_cpp = (Module[
  '__GLOBAL__sub_I_mandelbrot_cpp'
] = function () {
  assert(
    runtimeInitialized,
