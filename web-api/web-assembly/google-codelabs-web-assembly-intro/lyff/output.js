...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'output.wast';
  var wasmBinaryFile = 'output.wasm';
  var asmjsCodeFile = 'output.temp.asm.js';
...
var real__board_init = asm['_board_init'];
asm['_board_init'] = function () {
  assert(
    runtimeInitialized,
...
var real__board_ref = asm['_board_ref'];
asm['_board_ref'] = function () {
  assert(
    runtimeInitialized,
    'you need to wait for the runtime to be ready (e.g. wait for main() to be called)',
  );
...
var real__board_step = asm['_board_step'];
asm['_board_step'] = function () {
  assert(
    runtimeInitialized,
    'you need to wait for the runtime to be ready (e.g. wait for main() to be called)',
  );
