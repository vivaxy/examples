...
sign.addEventListener('click', function() {
    ...
    if (!this.hasAttribute('disabled')) {
        ...
        location.href = urlParts.origin + '/app/checkin/loadSign?uuid=' + urlParts.uuid + '&longitude=' + getValue('longitude') + '&latitude=' + getValue('latitude');
    }
});
...
check.addEventListener('click', function() {
    if (!this.hasAttribute('disabled')) {
        this.setAttribute('disabled', '');
        var urlParts = getURLPartFromText(textarea);
        location.href = urlParts.origin + '/app/checkin.html#/search?uuid_token=' + urlParts.uuid;
    }
});
